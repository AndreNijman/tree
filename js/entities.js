...
var ENT_DEF = {
  ...
  [E.HOPPINJACK]: { w:24, h:18, hp:175, dmg:80, def:20, color:'#d8e05e', kbResist:0.5, speed:2.6, name:'Hopping Jack', exp:2 },
  [E.ZOMBIE]: { w:20, h:34, hp:45, dmg:14, def:6, color:'#6a9a5c', kbResist:0.5, speed:1.1, name:'Zombie', exp:2 },
  [E.HARDZOMBIE]: { w:22, h:34, hp:45, dmg:14, def:6, color:'#8f7f6f', kbResist:0.5, speed:1.5, name:'Armored Zombie', exp:8 },
  [E.WRATH]: { w:28, h:32, hp:160, dmg:65, def:16, color:'#b8c4ff', kbResist:0.3, speed:2.4, fly:true, ghost:true, name:'Wraith', exp:10 },
  [E.EATEROFSOULS]: { w:20, h:18, hp:40, dmg:22, def:8, color:'#5a4d7a', kbResist:0.5, speed:2.2, fly:true, name:'Eater of Souls', exp:4 },
  [E.CORRUPTOR]: { w:26, h:22, hp:230, dmg:60, def:32, color:'#7a3d5c', kbResist:0.45, speed:1.8, fly:true, name:'Corruptor', exp:8 },
  [E.DEVOURER]: { w:28, h:18, hp:100, dmg:31, def:2, color:'#6a507f', kbResist:1.0, speed:2.5, fly:true, name:'Devourer', exp:6 },
  [E.PIXIE]: { w:20, h:20, hp:150, dmg:55, def:20, color:'#ffe9a8', kbResist:0.4, speed:2.6, fly:true, name:'Pixie', exp:8 },
  [E.UNICORN]: { w:36, h:30, hp:400, dmg:65, def:30, color:'#fff0d0', kbResist:0.7, speed:5.0, name:'Unicorn', exp:12 },
  [E.CHAOSELEMENTAL]: { w:22, h:26, hp:370, dmg:40, def:30, color:'#e0d8ff', kbResist:0.6, speed:3.0, fly:true, name:'Chaos Elemental', exp:12 },
  [E.GASTROPOD]: { w:30, h:24, hp:220, dmg:60, def:22, color:'#ffd0a8', kbResist:0.2, speed:2.0, fly:true, name:'Gastropod', exp:16 },
  [E.GUIDE]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#c8b090', kbResist:0.5, speed:0, name:'Guide', exp:0 },
  [E.WYVERN]: { w:34, h:24, hp:4000, dmg:80, def:10, color:'#ffd0a0', kbResist:1.0, speed:4.0, fly:true, name:'Wyvern', exp:30 },
  [E.JUNGLEBAT]: { w:22, h:16, hp:34, dmg:20, def:4, color:'#7a4d3d', kbResist:0.2, speed:3.2, fly:true, name:'Jungle Bat', exp:5 },
  [E.JUNGLESLIME]: { w:22, h:16, hp:60, dmg:18, def:6, color:'#4d8a3d', kbResist:0.0, speed:1.8, name:'Jungle Slime', exp:5 },
  [E.HORNET]: { w:26, h:22, hp:48, dmg:26, def:12, color:'#d8a030', kbResist:0.5, speed:2.2, fly:true, name:'Hornet', exp:8 },
  [E.LIHZARD]: { w:24, h:34, hp:400, dmg:38, def:20, color:'#8a5a3a', kbResist:0.6, speed:1.6, name:'Lihzahrd', exp:16 },
  [E.FLYINGSNAKE]: { w:28, h:20, hp:260, dmg:85, def:28, color:'#5a9a5c', kbResist:0.35, speed:2.6, fly:true, name:'Flying Snake', exp:14 },
  [E.FRANKENSTEIN]: { w:24, h:36, hp:350, dmg:65, def:18, color:'#7a9a5c', kbResist:0.7, speed:1.7, name:'Frankenstein', exp:20 },
  [E.REAPER]: { w:30, h:34, hp:700, dmg:80, def:22, color:'#3a3a4a', kbResist:0.4, speed:2.8, fly:true, ghost:true, name:'Reaper', exp:25 },
  [E.VAMPIRE]: { w:22, h:24, hp:750, dmg:80, def:24, color:'#6a3a4a', kbResist:0.6, speed:2.6, fly:true, name:'Vampire', exp:22 },
  [E.CORITE]: { w:26, h:20, hp:600, dmg:70, def:26, color:'#ff9a3d', kbResist:0.8, speed:5.5, fly:true, name:'Corite', exp:26 },
  [E.LUNARFLAME]: { w:22, h:22, hp:480, dmg:58, def:10, color:'#c85cff', speed:3.4, fly:true, name:'Nebula Blaze', exp:26 },
  [E.MUMMY]: { w:22, h:34, hp:130, dmg:50, def:16, color:'#d8c8a0', kbResist:0.4, speed:1.4, name:'Mummy', exp:8 },
  [E.LIGHTMUMMY]: { w:22, h:34, hp:200, dmg:55, def:18, color:'#ffe0a8', kbResist:0.45, speed:2.0, name:'Light Mummy', exp:9 },
  [E.DARKMUMMY]: { w:22, h:34, hp:180, dmg:60, def:18, color:'#7a6a9a', kbResist:0.5, speed:1.8, name:'Dark Mummy', exp:10 },
  [E.BLOODMUMMY]: { w:22, h:34, hp:180, dmg:60, def:18, color:'#b04a4a', kbResist:0.5, speed:1.8, name:'Blood Mummy', exp:10 },
  [E.SKELETONARCHER]: { w:22, h:32, hp:210, dmg:45, def:14, color:'#c8c8d8', kbResist:0.45, speed:1.6, name:'Skeleton Archer', exp:8 },
  [E.ARMOREDBONES]: { w:24, h:34, hp:500, dmg:45, def:50, color:'#a0a0b0', kbResist:0.85, speed:1.2, name:'Armored Bones', exp:10 },
  [E.UNDEADMINER]: { w:22, h:32, hp:70, dmg:22, def:9, color:'#b0a090', kbResist:0.5, speed:1.3, name:'Undead Miner', exp:8 },
  [E.GIANTBAT]: { w:24, h:16, hp:100, dmg:45, def:16, color:'#8a6a9a', kbResist:0.25, speed:3.6, fly:true, name:'Giant Bat', exp:5 },
  [E.TOXICSLUDGE]: { w:22, h:16, hp:150, dmg:50, def:18, color:'#8ac84a', kbResist:0.2, speed:1.9, name:'Toxic Sludge', exp:8 },
  [E.PIGRON]: { w:24, h:20, hp:210, dmg:70, def:16, color:'#ffb0c8', kbResist:0.5, speed:2.2, fly:true, name:'Pigron', exp:7 },
  [E.ICEGOLEM]: { w:26, h:38, hp:4000, dmg:60, def:32, color:'#a8d8f0', kbResist:0.95, speed:1.4, name:'Ice Golem', exp:16 },
  [E.ICETORTOISE]: { w:30, h:20, hp:400, dmg:55, def:28, color:'#8ab0c8', kbResist:0.7, speed:1.6, name:'Ice Tortoise', exp:18 },
  [E.SNOWFLINX]: { w:28, h:26, hp:70, dmg:26, def:12, color:'#f0f0f8', speed:3.0, name:'Snow Flinx', exp:8 },
  [E.ICEBAT]: { w:22, h:14, hp:30, dmg:18, def:6, color:'#b8d8f0', kbResist:0.2, speed:3.6, fly:true, name:'Ice Bat', exp:5 },
  [E.ANGLERFISH]: { w:26, h:16, hp:90, dmg:80, def:22, color:'#c89068', kbResist:0.0, speed:2.6, fly:true, name:'Angler Fish', exp:8 },
  [E.ARAPAIMA]: { w:34, h:20, hp:200, dmg:75, def:30, color:'#d88870', kbResist:0.0, speed:2.4, fly:true, name:'Arapaima', exp:14 },
  [E.DERPLING]: { w:24, h:22, hp:300, dmg:80, def:26, color:'#b0a0d8', kbResist:0.5, speed:2.0, fly:true, name:'Derpling', exp:12 },
  [E.MOSSHORNET]: { w:26, h:22, hp:220, dmg:70, def:22, color:'#8ad850', kbResist:0.5, speed:2.4, fly:true, name:'Moss Hornet', exp:9 },
  [E.GIANTTORTOSE]: { w:32, h:20, hp:470, dmg:80, def:30, color:'#6a8a5a', kbResist:0.7, speed:2.2, name:'Giant Tortoise', exp:16 },
  [E.CRIMSONAXE]: { w:26, h:22, hp:200, dmg:80, def:18, color:'#c04848', kbResist:0.6, speed:2.8, fly:true, name:'Crimson Axe', exp:8 },
  [E.ICHORSTICKER]: { w:20, h:24, hp:340, dmg:55, def:20, color:'#d0d050', kbResist:0.4, speed:1.6, name:'Ichor Sticker', exp:8 },
  [E.CLINGER]: { w:18, h:30, hp:320, dmg:70, def:30, color:'#d04040', kbResist:0.8, speed:0, name:'Clinger', exp:9 },
  [E.CURSEDHAMMER]: { w:24, h:24, hp:200, dmg:80, def:18, color:'#a0a8b8', kbResist:0.6, speed:2.6, fly:true, name:'Cursed Hammer', exp:10 },
  [E.MIMIC]: { w:28, h:28, hp:500, dmg:80, def:30, color:'#c89030', kbResist:0.7, speed:1.8, name:'Mimic', exp:20 },
  [E.HALLOWEDMIMIC]: { w:34, h:32, hp:3500, dmg:90, def:34, color:'#ffd8a0', kbResist:0.9, speed:2.6, name:'Hallowed Mimic', exp:50 },
  [E.CORRUPTMIMIC]: { w:34, h:32, hp:3500, dmg:90, def:34, color:'#5a4d7a', kbResist:0.9, speed:2.6, name:'Corrupt Mimic', exp:50 },
  [E.CRIMSONMIMIC]: { w:34, h:32, hp:3500, dmg:90, def:34, color:'#b04a4a', kbResist:0.9, speed:2.6, name:'Crimson Mimic', exp:50 },
  [E.WOLF]: { w:30, h:24, hp:300, dmg:65, def:30, color:'#8a8a90', kbResist:0.7, speed:4.5, name:'Wolf', exp:8 },
  [E.VORTEXIAN]: { w:26, h:30, hp:700, dmg:90, def:34, color:'#60d8c8', kbResist:0.4, speed:2.2, name:'Vortexian', exp:16 },
  [E.ALIENHORNET]: { w:26, h:22, hp:500, dmg:75, def:20, color:'#70c870', kbResist:0.5, speed:3.0, fly:true, name:'Alien Hornet', exp:16 },
  [E.NEBULAFLOATER]: { w:26, h:22, hp:1300, dmg:75, def:20, color:'#c870e0', kbResist:0.5, speed:2.2, fly:true, name:'Nebula Floater', exp:16 },
  [E.STARDJUSTCELL]: { w:24, h:24, hp:300, dmg:120, def:50, color:'#c0c0ff', speed:2.0, fly:true, name:'Stardust Cell', exp:16 },
  [E.MERCHANT]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#c8a878', kbResist:0.5, speed:0, name:'Merchant', exp:0 },
  [E.NURSE]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#f0d0e0', kbResist:0.5, speed:0, name:'Nurse', exp:0 },
  [E.WIZARD]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#a880d8', kbResist:0.5, speed:0, name:'Wizard', exp:0 },
  [E.STEAMPUNKER]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#d0a860', kbResist:0.5, speed:0, name:'Steampunker', exp:0 },
  [E.CYBORG]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#a0b0c0', kbResist:0.75, speed:0, name:'Cyborg', exp:0 },
  [E.TRUFFLE]: { w:16, h:26, hp:9999, dmg:0, def:99, color:'#c0b090', kbResist:0.5, speed:0, name:'Truffle', exp:0 },
  [E.PIRATE]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#e0c090', kbResist:0.5, speed:0, name:'Pirate', exp:0 },
  [E.WITCHDOCTOR]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#40a060', kbResist:0.5, speed:0, name:'Witch Doctor', exp:0 },
  [E.DEMOLITIONIST]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#c85050', kbResist:0.5, speed:0, name:'Demolitionist', exp:0 },
  [E.DYETRADER]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#5a8a3d', kbResist:0.5, speed:0, name:'Dye Trader', exp:0 },
  [E.ANGLER]: { w:16, h:22, hp:9999, dmg:0, def:99, color:'#e0a858', kbResist:0.5, speed:0, name:'Angler', exp:0 },
  [E.ZOOLOGIST]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#c8a058', kbResist:0.5, speed:0, name:'Zoologist', exp:0 },
  [E.DRYAD]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#3f9a4d', kbResist:0.5, speed:0, name:'Dryad', exp:0 },
  [E.PAINTER]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#8a5c9a', kbResist:0.5, speed:0, name:'Painter', exp:0 },
  [E.GOLFER]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#4a7a8a', kbResist:0.5, speed:0, name:'Golfer', exp:0 },
  [E.ARMSDEALER]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#4a4a5a', kbResist:0.5, speed:0, name:'Arms Dealer', exp:0 },
  [E.TAVERNKEEP]: { w:22, h:34, hp:9999, dmg:0, def:99, color:'#8a6b3d', kbResist:0.5, speed:0, name:'Tavernkeep', exp:0 },
  [E.STYLIST]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#ff9de0', kbResist:0.5, speed:0, name:'Stylist', exp:0 },
  [E.GOBLINTINKERER]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#5a7a3d', kbResist:0.5, speed:0, name:'Goblin Tinkerer', exp:0 },
  [E.CLOTHIER]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#7a6b8a', kbResist:0.5, speed:0, name:'Clothier', exp:0 },
  [E.MECHANIC]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#c8d050', kbResist:0.5, speed:0, name:'Mechanic', exp:0 },
  [E.TAXCOLLECTOR]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#a8a048', kbResist:0.5, speed:0, name:'Tax Collector', exp:0 },
  [E.PARTYGIRL]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#ff9de0', kbResist:0.5, speed:0, name:'Party Girl', exp:0 },
  [E.SANTA]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#d04040', speed:0, name:'Santa Claus', exp:0 },
  [E.PRINCESS]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#ffb8d8', kbResist:0.5, speed:0, name:'Princess', exp:0 },
  [E.PUMPKINSCARECROW]: { w:24, h:34, hp:500, dmg:60, def:18, color:'#ff9a3d', kbResist:0.6, speed:1.6, name:'Scarecrow', exp:14 },
  [E.SPLINTERLING]: { w:22, h:26, hp:1200, dmg:100, def:32, color:'#d8a030', kbResist:0.8, speed:2.0, name:'Splinterling', exp:10 },
  [E.FROSTZOMBIE]: { w:20, h:34, hp:50, dmg:16, def:8, color:'#b8d8f0', kbResist:0.55, speed:1.4, name:'Frost Zombie', exp:12 },
  [E.GINGERBREAD]: { w:20, h:24, hp:750, dmg:90, def:26, color:'#c89068', kbResist:0.8, speed:2.4, name:'Gingerbread Man', exp:12 },
  [E.MARTIANPROBE]: { w:26, h:20, hp:500, dmg:5, def:5, color:'#3dff9d', kbResist:1.0, speed:3.4, fly:true, name:'Martian Probe', exp:50 },
  [E.MARTIANGRUNT]: { w:22, h:30, hp:700, dmg:65, def:18, color:'#5aa89a', speed:1.8, name:'Martian Grunt', exp:20 },
  [E.RAYGUNNER]: { w:22, h:30, hp:350, dmg:50, def:25, color:'#60d8c8', kbResist:0.65, speed:1.6, name:'Ray Gunner', exp:20 },
  [E.MOURNINGWOOD]: { w:56, h:56, hp:14000, dmg:120, def:34, color:'#7a4d3d', kbResist:1.0, speed:2.6, name:'Mourning Wood', exp:80 },
  [E.PUMPKING]: { w:60, h:60, hp:26000, dmg:50, def:40, color:'#ff8a3d', kbResist:1.0, speed:3.0, name:'Pumpking', exp:120 },
  [E.EVERSCREAM]: { w:56, h:56, hp:13000, dmg:110, def:38, color:'#8ac84a', kbResist:1.0, speed:2.6, name:'Everscream', exp:80 },
  [E.SANTANK]: { w:52, h:56, hp:18000, dmg:120, def:56, color:'#d04040', kbResist:1.0, speed:2.8, name:'Santa-NK1', exp:100 },
  [E.ICEQUEEN]: { w:58, h:58, hp:34000, dmg:120, def:38, color:'#a8d8f0', kbResist:1.0, speed:3.2, name:'Ice Queen', exp:120 },
  [E.MARTIANSAUCER]: { w:80, h:48, hp:40000, dmg:70, def:26, color:'#3dff9d', kbResist:1.0, speed:2.2, name:'Martian Saucer', exp:150 },
  [E.HARPY]: { w:30, h:34, hp:100, dmg:25, def:8, color:'#e8e0d0', kbResist:0.4, speed:2.8, fly:true, name:'Harpy', exp:14 },
  [E.LAVASLIME]: { w:24, h:18, hp:50, dmg:15, def:10, color:'#ff6a2a', kbResist:0.0, speed:1.6, name:'Lava Slime', exp:8 },
  [E.HELLBAT]: { w:22, h:16, hp:46, dmg:35, def:8, color:'#c85028', kbResist:0.2, speed:3.4, fly:true, name:'Hellbat', exp:6 },
  [E.DEMON]: { w:30, h:34, hp:120, dmg:32, def:8, color:'#8a4a3d', kbResist:0.2, speed:2.4, fly:true, name:'Demon', exp:20 },
  [E.VOODOODEMON]: { w:30, h:34, hp:140, dmg:32, def:8, color:'#6a3a32', kbResist:0.2, speed:2.4, fly:true, name:'Voodoo Demon', exp:22 },
  [E.FIREIMP]: { w:22, h:26, hp:70, dmg:30, def:16, color:'#e05828', kbResist:0.5, speed:1.8, name:'Fire Imp', exp:8 },
  [E.BONESERPENT]: { w:30, h:22, hp:300, dmg:36, def:12, color:'#d8c8a8', kbResist:1.0, speed:3.0, fly:true, name:'Bone Serpent', exp:25 },
  [E.CRIMERA]: { w:20, h:18, hp:40, dmg:22, def:8, color:'#e04848', kbResist:0.5, speed:2.4, fly:true, name:'Crimera', exp:6 },
  [E.FACEMONSTER]: { w:20, h:30, hp:70, dmg:25, def:10, color:'#c85050', kbResist:0.6, speed:1.6, name:'Face Monster', exp:10 },
  [E.HERPLING]: { w:22, h:26, hp:220, dmg:65, def:26, color:'#e07878', kbResist:0.7, speed:2.0, name:'Herpling', exp:8 },
  [E.BLOODCRAWLER]: { w:26, h:18, hp:60, dmg:30, def:8, color:'#c03030', kbResist:0.5, speed:3.0, name:'Blood Crawler', exp:9 },
  [E.BLACKRECLUSE]: { w:26, h:18, hp:350, dmg:90, def:40, color:'#3a2a3a', kbResist:0.75, speed:3.0, name:'Black Recluse', exp:12 },
  [E.GRANITEGOLEM]: { w:30, h:40, hp:110, dmg:30, def:18, color:'#7a7a8a', kbResist:0.65, speed:1.4, name:'Granite Golem', exp:18 },
  [E.MARBLEGOLEM]: { w:30, h:40, hp:600, dmg:58, def:16, color:'#e8e8f0', speed:1.4, name:'Marble Golem', exp:16 },
  [E.DEMONEYE]: { w:24, h:20, hp:60, dmg:18, def:2, color:'#c03030', kbResist:0.2, speed:3.2, fly:true, name:'Demon Eye', exp:5 },
  [E.CAVEBAT]: { w:20, h:14, hp:16, dmg:13, def:2, color:'#6a5c3d', kbResist:0.2, speed:3.4, fly:true, name:'Cave Bat', exp:3 },
  [E.GOBLIN]: { w:20, h:30, hp:60, dmg:12, def:4, color:'#7a8a3d', kbResist:0.2, speed:2.2, name:'Goblin', exp:4 },
  [E.CORRUPTCRIMSONFLYER]: { w:22, h:16, hp:100, dmg:18, def:2, color:'#5a4d7a', speed:2.8, fly:true, name:'Vile Flyer', exp:4 },
  [E.CURSEDSKULL]: { w:22, h:22, hp:40, dmg:35, def:6, color:'#9a8ab0', kbResist:0.8, speed:2.2, fly:true, name:'Cursed Skull', exp:10, shoot:true },
  [E.ANGRYBONES]: { w:22, h:34, hp:80, dmg:26, def:8, color:'#d8d0c0', kbResist:0.2, speed:1.8, name:'Angry Bones', exp:8 },
  [E.DARKCASTER]: { w:22, h:32, hp:50, dmg:20, def:2, color:'#7a5a9a', kbResist:0.4, speed:1.4, name:'Dark Caster', exp:10, shoot:true },
  [E.DUNGEONSLIME]: { w:24, h:18, hp:150, dmg:30, def:7, color:'#8a7ab0', kbResist:0.4, speed:1.8, name:'Dungeon Slime', exp:6 },
  [E.ANTLION]: { w:28, h:20, hp:45, dmg:10, def:6, color:'#c8a058', kbResist:1.0, speed:2.2, name:'Antlion', exp:9 },
  [E.ANTLIONCHARGER]: { w:30, h:22, hp:80, dmg:25, def:10, color:'#b08848', kbResist:0.5, speed:4.6, name:'Antlion Charger', exp:11 },
  [E.ICESLIME]: { w:24, h:18, hp:30, dmg:8, def:4, color:'#b8d8f0', kbResist:0.0, speed:1.8, name:'Ice Slime', exp:6 },
  ...
  [E.GOBLINTHIEF]: { w:20, h:30, hp:80, dmg:20, def:6, color:'#5a8a3d', kbResist:0.3, speed:2.8, name:'Goblin Thief', exp:5 },
  [E.GOBLINARCHER]: { w:20, h:30, hp:80, dmg:20, def:6, color:'#6a7a3d', kbResist:0.3, speed:2.0, name:'Goblin Archer', exp:5, shoot:true },
  [E.GOBLINWARRIOR]: { w:22, h:32, hp:110, dmg:25, def:8, color:'#4a6a3d', kbResist:0.5, speed:1.8, name:'Goblin Warrior', exp:8 },
  [E.GOBLINWARLOCK]: { w:24, h:34, hp:2000, dmg:80, def:26, color:'#7a3d8a', kbResist:0.85, speed:1.6, name:'Goblin Warlock', exp:30, shoot:true },
  [E.PIRATEDECKHAND]: { w:22, h:32, hp:300, dmg:35, def:17, color:'#8a5c3d', kbResist:0.6, speed:1.8, name:'Pirate Deckhand', exp:16 },
  [E.PIRATECORSAIR]: { w:24, h:34, hp:450, dmg:50, def:22, color:'#6a4a3d', kbResist:0.8, speed:2.2, name:'Pirate Corsair', exp:20 },
  [E.PIRATESHARK]: { w:30, h:20, hp:420, dmg:50, def:10, color:'#5a5a6a', speed:3.6, fly:true, name:'Pirate Shark', exp:18 },
  [E.PIRATECAPTAIN]: { w:26, h:38, hp:3000, dmg:70, def:30, color:'#a83d3d', kbResist:1.0, speed:2.0, name:'Pirate Captain', exp:60, shoot:true },
  [E.SWAMPTHING]: { w:28, h:38, hp:450, dmg:70, def:26, color:'#3d7a4d', kbResist:0.8, speed:1.9, name:'Swamp Thing', exp:26 },
  [E.WEREWOLF]: { w:26, h:34, hp:350, dmg:70, def:38, color:'#7a5c4d', kbResist:0.6, speed:3.4, name:'Werewolf', exp:24 },
  [E.EYEBALL]: { w:24, h:20, hp:1000, dmg:50, def:30, color:'#e04848', kbResist:0.7, speed:4.0, fly:true, name:'Eyezor', exp:22 },
  [E.MOTHRON]: { w:40, h:26, hp:6000, dmg:80, def:30, color:'#8a8ab8', kbResist:0.8, speed:4.0, fly:true, name:'Mothron', exp:120 },
  // ---- Post-Plantera Dungeon + Cultist ritual ----
  [E.PALADIN]: { w:30, h:42, hp:5000, dmg:100, def:50, color:'#d8c878', kbResist:1.0, speed:1.2, name:'Paladin', exp:55 },
  [E.TACTICALSKELETON]: { w:22, h:34, hp:400, dmg:60, def:28, color:'#788078', kbResist:0.6, speed:1.5, name:'Tactical Skeleton', exp:26, shoot:true },
  [E.SKELETONSNIPER]: { w:22, h:34, hp:400, dmg:60, def:28, color:'#657078', kbResist:0.6, speed:1.2, name:'Skeleton Sniper', exp:30, shoot:true },
  [E.SKELETONCOMMANDO]: { w:24, h:36, hp:400, dmg:60, def:28, color:'#69735f', kbResist:0.6, speed:1.4, name:'Skeleton Commando', exp:32, shoot:true },
  [E.RAGGEDCASTER]: { w:22, h:34, hp:400, dmg:40, def:20, color:'#9a8aaa', kbResist:0.4, speed:1.2, name:'Ragged Caster', exp:28, shoot:true },
  [E.NECROMANCER]: { w:22, h:34, hp:300, dmg:50, def:18, color:'#765a98', kbResist:0.45, speed:1.2, name:'Necromancer', exp:30, shoot:true },
  [E.DIABOLIST]: { w:22, h:34, hp:200, dmg:50, def:12, color:'#b84a36', kbResist:0.3, speed:1.1, name:'Diabolist', exp:32, shoot:true },
  [E.BONELEE]: { w:22, h:34, hp:1000, dmg:90, def:42, color:'#34343c', kbResist:0.7, speed:4.8, name:'Bone Lee', exp:38 },
  [E.GIANTCURSEDSKULL]: { w:38, h:38, hp:400, dmg:60, def:20, color:'#8c78a8', kbResist:0.8, speed:2.8, fly:true, ghost:true, name:'Giant Cursed Skull', exp:42, shoot:true },
  [E.DUNGEONSPIRIT]: { w:22, h:24, hp:200, dmg:70, def:30, color:'#6bc8ff', kbResist:0.8, speed:3.2, fly:true, ghost:true, name:'Dungeon Spirit', exp:20 },
  [E.CULTISTDEVOTEE]: { w:22, h:34, hp:400, dmg:0, def:0, color:'#445b8f', kbResist:1.0, speed:0.8, name:'Lunatic Devotee', exp:15, shoot:true },
  [E.CULTISTARCHER]: { w:22, h:34, hp:210, dmg:45, def:14, color:'#687b9f', kbResist:0.45, speed:1.2, name:'Cultist Archer', exp:15, shoot:true },
  [E.FLYINGDUTCHMAN]: { w:100, h:54, hp:18000, dmg:70, def:24, color:'#6a4a32', kbResist:1.0, speed:2.0, fly:true, name:'Flying Dutchman', exp:120 },
  [E.CREATUREFROMDEEP]: { w:24, h:34, hp:400, dmg:60, def:22, color:'#397878', kbResist:0.6, speed:2.4, name:'Creature from the Deep', exp:24 },
  [E.FRITZ]: { w:22, h:34, hp:270, dmg:70, def:14, color:'#77704f', kbResist:0.3, speed:3.2, name:'Fritz', exp:22 },
  [E.POSSESSED]: { w:22, h:34, hp:600, dmg:68, def:28, color:'#72527c', kbResist:0.55, speed:2.8, name:'The Possessed', exp:26 },
  [E.BUTCHER]: { w:26, h:38, hp:700, dmg:70, def:30, color:'#a84a42', kbResist:0.75, speed:2.5, name:'Butcher', exp:32 },
  [E.DEADLYSPHERE]: { w:26, h:26, hp:350, dmg:100, def:80, color:'#d84a4a', kbResist:0.3, speed:3.6, fly:true, name:'Deadly Sphere', exp:30 },
  [E.DRMANFLY]: { w:24, h:36, hp:500, dmg:65, def:24, color:'#6aa84f', kbResist:0.4, speed:2.0, name:'Dr. Man Fly', exp:28, shoot:true },
  [E.NAILHEAD]: { w:30, h:40, hp:4000, dmg:100, def:34, color:'#788088', kbResist:0.9, speed:1.8, name:'Nailhead', exp:36, shoot:true },
  [E.PSYCHO]: { w:22, h:34, hp:550, dmg:70, def:40, color:'#505058', kbResist:0.5, speed:4.2, name:'Psycho', exp:32 },
  [E.BABYMOTHRON]: { w:26, h:18, hp:700, dmg:50, def:14, color:'#9a9ac8', kbResist:0.7, speed:4.2, fly:true, name:'Baby Mothron', exp:22 },
  [E.BLOODZOMBIE]: { w:22, h:34, hp:75, dmg:20, def:8, color:'#9a3038', kbResist:0.6, speed:1.7, name:'Blood Zombie', exp:5 },
  [E.DRIPPLER]: { w:26, h:24, hp:50, dmg:28, def:14, color:'#c83a48', kbResist:0.4, speed:3.0, fly:true, name:'Drippler', exp:7 },
  [E.WANDERINGEYEFISH]: { w:28, h:20, hp:300, dmg:35, def:18, color:'#b84858', kbResist:1.0, speed:3.4, fly:true, name:'Wandering Eye Fish', exp:9 },
  [E.ZOMBIEMERMAN]: { w:24, h:36, hp:400, dmg:40, def:20, color:'#4f7f78', kbResist:1.0, speed:2.4, name:'Zombie Merman', exp:12 },
  [E.DREADNAUTILUS]: { w:44, h:38, hp:7000, dmg:55, def:24, color:'#a82f48', kbResist:1.0, speed:3.0, fly:true, ghost:true, name:'Dreadnautilus', exp:35, shoot:true },
  [E.SNOWMANGANGSTA]: { w:22, h:32, hp:200, dmg:50, def:20, color:'#d8e8f0', kbResist:0.4, speed:1.8, name:'Snowman Gangsta', exp:12, shoot:true },
  [E.MISTERSTABBY]: { w:22, h:34, hp:240, dmg:65, def:26, color:'#e8f0f8', kbResist:0.4, speed:3.0, name:'Mister Stabby', exp:14 },
  [E.SNOWBALLA]: { w:24, h:34, hp:220, dmg:55, def:22, color:'#c8dce8', kbResist:0.4, speed:1.6, name:'Snow Balla', exp:13, shoot:true },
  [E.PIRATECROSSBOWER]: { w:22, h:34, hp:350, dmg:35, def:20, color:'#704a32', kbResist:0.65, speed:1.7, name:'Pirate Crossbower', exp:20, shoot:true },
  [E.PARROT]: { w:24, h:20, hp:100, dmg:80, def:12, color:'#d84a3a', kbResist:0.3, speed:4.0, fly:true, name:'Parrot', exp:16 },
  [E.MARTIANWALKER]: { w:34, h:42, hp:2000, dmg:60, def:40, color:'#568f83', kbResist:1.0, speed:1.4, name:'Martian Walker', exp:32, shoot:true },
  [E.MARTIANDRONE]: { w:28, h:22, hp:300, dmg:60, def:16, color:'#68c8bc', kbResist:0.6, speed:3.8, fly:true, name:'Martian Drone', exp:24, shoot:true },
  [E.TESLATURRET]: { w:26, h:32, hp:200, dmg:10, def:40, color:'#5aa8b8', kbResist:1.0, speed:0, name:'Tesla Turret', exp:28, shoot:true },
  [E.HELLHOUND]: { w:34, h:24, hp:650, dmg:68, def:16, color:'#5b352c', kbResist:0.7, speed:4.6, name:'Hellhound', exp:24 },
  [E.POLTERGEIST]: { w:28, h:30, hp:1250, dmg:90, def:44, color:'#9a80b8', kbResist:0.6, speed:3.0, fly:true, ghost:true, name:'Poltergeist', exp:26 },
  [E.HEADLESSHORSEMAN]: { w:34, h:42, hp:1300, dmg:82, def:24, color:'#412c24', kbResist:1.0, speed:4.0, name:'Headless Horseman', exp:36 },
  [E.ZOMBIEELF]: { w:22, h:32, hp:600, dmg:65, def:18, color:'#4f8a58', kbResist:0.6, speed:2.2, name:'Zombie Elf', exp:16 },
  [E.ELFARCHER]: { w:22, h:32, hp:900, dmg:70, def:30, color:'#609a68', kbResist:0.55, speed:1.8, name:'Elf Archer', exp:17, shoot:true },
  [E.KRAMPUS]: { w:30, h:42, hp:2500, dmg:100, def:40, color:'#5b4038', kbResist:0.9, speed:2.8, name:'Krampus', exp:32 },
  [E.ELFCOPTER]: { w:34, h:24, hp:1200, dmg:60, def:28, color:'#b83f3f', kbResist:0.6, speed:3.5, fly:true, name:'Elf Copter', exp:28, shoot:true },
  [E.SELENIAN]: { w:26, h:34, hp:800, dmg:90, def:30, color:'#e87938', kbResist:0.6, speed:4.0, name:'Selenian', exp:28 },
  [E.STORMDIVER]: { w:26, h:34, hp:800, dmg:100, def:40, color:'#38b8a0', kbResist:0.6, speed:2.4, name:'Storm Diver', exp:27, shoot:true },
  [E.PREDICTOR]: { w:24, h:32, hp:700, dmg:80, def:30, color:'#b05ac8', kbResist:0.4, speed:2.0, name:'Predictor', exp:26, shoot:true },
  [E.STARGAZER]: { w:26, h:28, hp:700, dmg:80, def:34, color:'#6f8fe8', kbResist:0.6, speed:2.5, fly:true, name:'Stargazer', exp:27, shoot:true },
  [E.FLYINGFISH]: { w:28, h:18, hp:20, dmg:9, def:4, color:'#5f9fc8', kbResist:0.2, speed:3.4, fly:true, name:'Flying Fish', exp:5 },
  [E.ANGRYNIMBUS]: { w:36, h:22, hp:300, dmg:50, def:24, color:'#8290a0', kbResist:0.7, speed:2.0, fly:true, ghost:true, name:'Angry Nimbus', exp:18, shoot:true },
  [E.ANGRYTUMBLER]: { w:28, h:28, hp:50, dmg:30, def:6, color:'#c8a85f', kbResist:0.2, speed:3.6, name:'Angry Tumbler', exp:9 },
  [E.SANDELEMENTAL]: { w:30, h:38, hp:5000, dmg:40, def:30, color:'#d8bd78', kbResist:0.95, speed:2.4, fly:true, ghost:true, name:'Sand Elemental', exp:32, shoot:true },
  [E.GOBLINSCOUT]: { w:20, h:30, hp:80, dmg:20, def:6, color:'#839449', kbResist:0.3, speed:3.0, name:'Goblin Scout', exp:4 },
  [E.GOBLINPEON]: { w:20, h:30, hp:60, dmg:12, def:4, color:'#789144', kbResist:0.2, speed:2.3, name:'Goblin Peon', exp:4 },
  [E.GOBLINSORCERER]: { w:20, h:32, hp:40, dmg:20, def:2, color:'#596f3c', kbResist:0.4, speed:1.5, name:'Goblin Sorcerer', exp:6, shoot:true },
  ...
  [E.PIRATEDEADEYE]: { w:22, h:34, hp:225, dmg:30, def:14, color:'#594431', kbResist:0.7, speed:1.5, name:'Pirate Deadeye', exp:22, shoot:true },
  [E.NUTCRACKER]: { w:24, h:38, hp:1800, dmg:80, def:26, color:'#b83f3f', kbResist:0.6, speed:2.4, name:'Nutcracker', exp:26 },
  [E.FLOCKO]: { w:26, h:26, hp:450, dmg:75, def:8, color:'#d8f0ff', kbResist:0.6, speed:3.5, fly:true, ghost:true, name:'Flocko', exp:24 },
  [E.YETI]: { w:34, h:44, hp:3500, dmg:140, def:50, color:'#e0e8ec', kbResist:1.0, speed:3.2, name:'Yeti', exp:38 },
  [E.PRESENTMIMIC]: { w:36, h:30, hp:900, dmg:100, def:32, color:'#d83f4f', kbResist:0.75, speed:4.0, name:'Present Mimic', exp:42 },
  [E.BRIDE]: { w:22, h:34, hp:200, dmg:14, def:8, color:'#e8d8d8', kbResist:0.5, speed:1.8, name:'The Bride', exp:7 },
  [E.GROOM]: { w:22, h:34, hp:200, dmg:14, def:8, color:'#303038', kbResist:0.5, speed:1.8, name:'The Groom', exp:7 },
  [E.CLOWN]: { w:26, h:38, hp:800, dmg:60, def:25, color:'#d84a68', kbResist:0.8, speed:2.0, name:'Clown', exp:30, shoot:true },
  [E.BLOODEEL]: { w:28, h:22, hp:6000, dmg:90, def:0, color:'#a82038', kbResist:1.0, speed:4.2, fly:true, name:'Blood Eel', exp:38 },
  [E.HEMOGOBLINSHARK]: { w:42, h:24, hp:5000, dmg:70, def:30, color:'#7f2638', kbResist:1.0, speed:4.4, fly:true, name:'Hemogoblin Shark', exp:42 },
  [E.MARTIANOFFICER]: { w:24, h:34, hp:300, dmg:75, def:50, color:'#477f72', kbResist:0.75, speed:2.3, name:'Martian Officer', exp:27 },
  [E.MARTIANENGINEER]: { w:22, h:32, hp:400, dmg:40, def:34, color:'#68b8a8', kbResist:0.6, speed:1.5, name:'Martian Engineer', exp:28, shoot:true },
  [E.GIGAZAPPER]: { w:28, h:38, hp:600, dmg:75, def:38, color:'#459e91', kbResist:0.7, speed:1.4, name:'Gigazapper', exp:34, shoot:true },
  [E.BRAINSCRAMBLER]: { w:30, h:28, hp:350, dmg:50, def:25, color:'#9a68b8', kbResist:0.65, speed:3.0, fly:true, ghost:true, name:'Brain Scrambler', exp:32, shoot:true },
  [E.SCUTLIXGUNNER]: { w:44, h:38, hp:350, dmg:65, def:30, color:'#4f8f82', kbResist:0.0, speed:3.0, name:'Scutlix Gunner', exp:40, shoot:true },
  [E.CRAWLTIPEDE]: { w:30, h:24, hp:10000, dmg:120, def:1000, color:'#f07838', kbResist:1.0, speed:5.2, fly:true, name:'Crawltipede', exp:42 },
  [E.ALIENQUEEN]: { w:40, h:34, hp:1000, dmg:100, def:44, color:'#38bfa8', kbResist:0.7, speed:3.2, fly:true, name:'Alien Queen', exp:40, shoot:true },
  [E.EVOLUTIONBEAST]: { w:34, h:42, hp:850, dmg:90, def:46, color:'#a84fc0', kbResist:0.8, speed:2.2, name:'Evolution Beast', exp:44, shoot:true },
  [E.FLOWINVADER]: { w:36, h:32, hp:1500, dmg:70, def:38, color:'#708fe8', kbResist:0.97, speed:3.4, fly:true, ghost:true, name:'Flow Invader', exp:42, shoot:true },
  [E.ANGRYDANDELION]: { w:24, h:32, hp:50, dmg:15, def:0, color:'#e8df72', kbResist:1.0, speed:0, name:'Angry Dandelion', exp:3 },
  [E.WINDYBALLOON]: { w:24, h:18, hp:1, dmg:0, def:0, color:'#5cbf6c', kbResist:0.7, speed:1.6, fly:true, name:'Windy Balloon Slime', exp:3 },
  [E.LADYBUG]: { w:12, h:10, hp:5, dmg:0, def:0, color:'#e85040', kbResist:0.0, speed:1.8, fly:true, name:'Ladybug', exp:0 },
  [E.GHOST]: { w:20, h:30, hp:50, dmg:15, def:4, color:'#d8d8e0', kbResist:0.5, speed:1.7, fly:true, ghost:true, name:'Ghost', exp:4 },
  [E.SANDSLIME]: { w:20, h:14, hp:50, dmg:15, def:5, color:'#e8d878', kbResist:0.3, speed:1.5, name:'Sand Slime', exp:2 },
  [E.GIANTWORM]: { w:26, h:18, hp:30, dmg:8, def:0, color:'#c8b090', kbResist:1.0, speed:3.2, fly:true, name:'Giant Worm', exp:8 },
  [E.NYMPH]: { w:20, h:32, hp:300, dmg:35, def:16, color:'#e8d0b0', kbResist:0.6, speed:2.6, name:'Nymph', exp:12 },
  [E.DIGGER]: { w:28, h:18, hp:200, dmg:45, def:10, color:'#e0c878', kbResist:1.0, speed:3.4, fly:true, name:'Digger', exp:10 },
  [E.CRIMSLIME]: { w:30, h:22, hp:200, dmg:60, def:26, color:'#d84848', kbResist:0.0, speed:2.0, name:'Crimslime', exp:10 },
  [E.SLIMELING]: { w:14, h:10, hp:90, dmg:45, def:10, color:'#e86060', speed:2.4, name:'Slimeling', exp:2 },
  [E.MOTH]: { w:26, h:18, hp:1000, dmg:70, def:28, color:'#c8a860', kbResist:0.6, speed:4.6, fly:true, name:'Moth', exp:8 },
  [E.CORRUPTSLIME]: { w:20, h:14, hp:170, dmg:55, def:20, color:'#8a5fb8', kbResist:0.0, speed:1.5, name:'Corrupt Slime', exp:3 },
  [E.SPIKEDJUNGLESLIME]: { w:22, h:16, hp:65, dmg:28, def:8, color:'#5cc04c', kbResist:0.0, speed:1.7, name:'Spiked Jungle Slime', exp:4 },
  [E.SPIKEDICESLIME]: { w:22, h:16, hp:60, dmg:12, def:8, color:'#9adff2', kbResist:0.0, speed:1.6, name:'Spiked Ice Slime', exp:4 },
  [E.UMBRELLASLIME]: { w:22, h:20, hp:35, dmg:10, def:5, color:'#5aa8e0', kbResist:0.25, speed:1.8, fly:true, name:'Umbrella Slime', exp:12 },
  [E.DUNESPLICER]: { w:30, h:20, hp:500, dmg:58, def:18, color:'#d8a878', kbResist:1.0, speed:3.6, fly:true, name:'Dune Splicer', exp:26 },
  [E.ANTLIONSWARMER]: { w:22, h:16, hp:60, dmg:29, def:8, color:'#d0a060', kbResist:0.5, speed:4.0, fly:true, name:'Antlion Swarmer', exp:5 },
  [E.SPOREZOMBIE]: { w:20, h:34, hp:180, dmg:40, def:10, color:'#7aa84a', kbResist:0.6, speed:1.0, name:'Spore Zombie', exp:6 },
  [E.ICEELEMENTAL]: { w:22, h:30, hp:200, dmg:55, def:20, color:'#9adcff', kbResist:0.4, speed:1.6, name:'Ice Elemental', exp:16 },
  [E.SQUID]: { w:22, h:26, hp:30, dmg:20, def:2, color:'#c8708a', kbResist:0.0, speed:2.6, fly:true, name:'Squid', exp:5 },
  [E.BUNNY]: { w:16, h:14, hp:5, dmg:0, def:0, color:'#d8c8b0', kbResist:0.0, speed:2.6, name:'Bunny', exp:0 },
  [E.BIRD]: { w:14, h:12, hp:5, dmg:0, def:0, color:'#7a8fc8', kbResist:0.2, speed:3.2, fly:true, name:'Bird', exp:0 },
  [E.SQUIRREL]: { w:14, h:12, hp:5, dmg:0, def:0, color:'#b8835a', kbResist:0.0, speed:2.8, name:'Squirrel', exp:0 },
  [E.FROG]: { w:14, h:10, hp:5, dmg:0, def:0, color:'#4aa84a', kbResist:0.0, speed:2.4, name:'Frog', exp:0 },
  [E.GOLDFISH]: { w:14, h:10, hp:5, dmg:0, def:0, color:'#e89030', kbResist:0.5, speed:2.2, name:'Goldfish', exp:0 },
  [E.TURTLE]: { w:22, h:14, hp:5, dmg:0, def:0, color:'#5c9a4a', kbResist:0.5, speed:1.2, name:'Turtle', exp:0 },
  [E.SKELETON]: { w:20, h:34, hp:60, dmg:20, def:8, color:'#e8e8e8', kbResist:0.5, speed:1.3, name:'Skeleton', exp:3 },
  [E.PINKY]: { w:26, h:20, hp:150, dmg:5, def:5, color:'#ff9ad8', speed:1.9, name:'Pinky', exp:4 },
  [E.MOTHERSLIME]: { w:40, h:30, hp:90, dmg:20, def:7, color:'#6ac46c', kbResist:0.4, speed:1.2, name:'Mother Slime', exp:6 },
  [E.BLUESLIME]: { w:22, h:16, hp:25, dmg:7, def:2, color:'#5aa0e6', kbResist:0.0, speed:1.7, name:'Blue Slime', exp:1 },
  [E.MANEATER]: { w:26, h:28, hp:110, dmg:34, def:10, color:'#3a8a3a', kbResist:1.0, speed:0, name:'Man Eater', exp:5 },
  [E.MEDUSA]: { w:22, h:32, hp:400, dmg:30, def:20, color:'#9ad0d8', kbResist:0.85, speed:2.2, fly:true, name:'Medusa', exp:8 },
  [E.UNDEADVIKING]: { w:24, h:34, hp:70, dmg:24, def:10, color:'#c8d0d8', kbResist:0.5, speed:1.4, name:'Undead Viking', exp:8 },
  [E.WALLWARRIOR]: { w:24, h:34, hp:420, dmg:46, def:14, color:'#b0b0c0', speed:1.2, name:'Wall Warrior', exp:10 },
  [E.SPIKEBALL]: { w:22, h:22, hp:100, dmg:32, def:100, color:'#9a9aa8', kbResist:1.0, speed:2.4, fly:true, name:'Spike Ball', exp:6 },
  [E.GRANITEELEMENTAL]: { w:24, h:26, hp:40, dmg:24, def:8, color:'#c8b0d8', kbResist:0.4, speed:2.8, fly:true, name:'Granite Elemental', exp:12 },
  [E.BASILISK]: { w:34, h:22, hp:270, dmg:65, def:34, color:'#d8c888', kbResist:0.7, speed:4.2, name:'Basilisk', exp:12 },
  [E.PINKJELLYFISH]: { w:26, h:18, hp:70, dmg:30, def:6, color:'#ff9ad8', kbResist:0.0, speed:2.6, swim:true, glow:true, name:'Pink Jellyfish', exp:3 },
  [E.CRAWDAD]: { w:26, h:16, hp:50, dmg:28, def:6, color:'#d8a878', kbResist:0.0, speed:2.4, name:'Crawdad', exp:3 },
  [E.JUNGLECREEPER]: { w:30, h:18, hp:400, dmg:100, def:28, color:'#4d8a3d', kbResist:0.75, speed:2.6, name:'Jungle Creeper', exp:5 },
  [E.DRBONES]: { w:22, h:36, hp:500, dmg:20, def:10, color:'#e8e0d0', kbResist:0.5, speed:2.0, name:'Doctor Bones', exp:10, shoot:true },
  [E.CRAB]: { w:22, h:16, hp:40, dmg:20, def:10, color:'#c86a4a', kbResist:0.0, speed:3.0, name:'Crab', exp:2 },
  [E.SEASNAIL]: { w:20, h:15, hp:40, dmg:20, def:10, color:'#e0c070', kbResist:0.0, speed:0.7, name:'Sea Snail', exp:1 },
  [E.PIRANHA]: { w:20, h:14, hp:30, dmg:25, def:2, color:'#78b0d8', kbResist:0.0, speed:2.6, swim:true, name:'Piranha', exp:3, fly:true },
  [E.LAVABAT]: { w:18, h:14, hp:160, dmg:50, def:16, color:'#e05c3a', kbResist:0.4, speed:2.8, name:'Lava Bat', exp:4, fly:true },
  [E.WALLCREEPER]: { w:20, h:16, hp:80, dmg:30, def:10, color:'#82624a', kbResist:0.75, speed:2.2, name:'Wall Creeper', exp:2 },
  [E.SALAMANDER]: { w:30, h:15, hp:65, dmg:18, def:10, color:'#b87848', kbResist:0.55, speed:2.3, name:'Salamander', exp:3 },
  [E.BLUEJELLYFISH]: { w:20, h:16, hp:34, dmg:25, def:4, color:'#6aa8e8', kbResist:0.0, speed:1.9, swim:true, glow:true, name:'Blue Jellyfish', exp:3 },
  [E.GREENJELLYFISH]: { w:20, h:16, hp:120, dmg:80, def:30, color:'#5ce87a', kbResist:0.0, speed:1.9, swim:true, glow:true, name:'Green Jellyfish', exp:3 },
  [E.VULTURE]: { w:22, h:14, hp:40, dmg:15, def:4, color:'#8a6a4a', kbResist:0.2, speed:2.6, fly:true, name:'Vulture', exp:4 },
  [E.SHARK]: { w:34, h:16, hp:300, dmg:40, def:2, color:'#5a7a9a', kbResist:0.3, speed:3.0, swim:true, name:'Shark', exp:8 },
  [E.ORCA]: { w:44, h:20, hp:400, dmg:50, def:20, color:'#20242c', kbResist:0.3, speed:3.6, swim:true, name:'Orca', exp:14 },
  [E.SNATCHER]: { w:16, h:34, hp:60, dmg:25, def:10, color:'#4a7a3a', kbResist:1.0, speed:0, name:'Snatcher', exp:6 },
  [E.METEORHEAD]: { w:16, h:16, hp:26, dmg:40, def:6, color:'#e05a2a', kbResist:0.6, speed:2.9, fly:true, glow:true, name:'Meteor Head', exp:7 },
  [E.REDDEVIL]: { w:30, h:40, hp:600, dmg:50, def:40, color:'#c02020', kbResist:0.5, speed:3.0, fly:true, glow:true, name:'Red Devil', exp:40 },
  [E.PENGUIN]: { w:14, h:16, hp:5, dmg:0, def:0, color:'#28303c', kbResist:0.0, speed:0.8, name:'Penguin', exp:0 },
...
function hitEntity(e, dmg, kbx, kby, game) {
  ...
  e.hp -= reduced;
  e.flash = 0.1;
  var kbMul = 1 - (e.kbResist || 0);
  e.kbVx = (e.kbVx || 0) + kbx * kbMul;
  e.kbVy = (e.kbVy || 0) + kby * kbMul;
...
function killEntity(e, game) {
  ...
  var eName = e.type >= 0 && ENT_DEF[e.type] ? ENT_DEF[e.type].name : null;
  var b83 = eName && typeof B83_ENEMY_DROPS !== 'undefined' ? B83_ENEMY_DROPS[eName] : null;
  if (b83) {
    var dmB = diffScale();
    for (var bi = 0; bi < b83.length; bi++) {
      if (Math.random() < b83[bi].rate) drops.push({ id: b83[bi].id, count: 1 });
    }
  }
  var dm = diffScale();
...
// ---------- Batch 83 canonical item drops ----------
var B83_ENEMY_DROPS = {};
B83_ENEMY_DROPS['Zombie'] = [{ id:I.ASH_WOOD_SWORD, rate:0.01 }, { id:I.BAT_BAT, rate:0.01 }, { id:I.BLADED_GLOVE, rate:0.01 }, { id:I.BOREAL_WOOD_SWORD, rate:0.01 }, { id:I.BRAND_OF_THE_INFERNO, rate:0.01 }, { id:I.BREATHING_REED, rate:0.01 }, { id:I.CACTUS_SWORD, rate:0.01 }, { id:I.CLASSY_CANE, rate:0.01 }, { id:I.EBONWOOD_SWORD, rate:0.01 }, { id:I.EXOTIC_SCIMITAR, rate:0.01 }, { id:I.FLYMEAL, rate:0.01 }, { id:I.GOLD_BROADSWORD, rate:0.01 }, { id:I.HAM_BAT, rate:0.01 }, { id:I.ICE_BLADE, rate:0.01 }, { id:I.LEAD_BROADSWORD, rate:0.01 }, { id:I.MANDIBLE_BLADE, rate:0.01 }, { id:I.ORANGE_PHASEBLADE, rate:0.01 }, { id:I.PALM_WOOD_SWORD, rate:0.01 }, { id:I.PEARLWOOD_SWORD, rate:0.01 }, { id:I.PINK_PHASEBLADE, rate:0.01 }, { id:I.PLATINUM_BROADSWORD, rate:0.01 }, { id:I.PURPLE_CLUBBERFISH, rate:0.01 }, { id:I.RAINBOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASEBLADE, rate:0.01 }, { id:I.RICH_MAHOGANY_SWORD, rate:0.01 }, { id:I.SHADEWOOD_SWORD, rate:0.01 }, { id:I.SHIELD_OF_CTHULHU, rate:0.01 }, { id:I.SICKLE, rate:0.01 }, { id:I.SILVER_BROADSWORD, rate:0.01 }, { id:I.STYLISH_SCISSORS, rate:0.01 }, { id:I.TRAGIC_UMBRELLA, rate:0.01 }, { id:I.TUNGSTEN_BROADSWORD, rate:0.01 }, { id:I.WAFFLES_IRON, rate:0.01 }, { id:I.WHITE_PHASEBLADE, rate:0.01 }, { id:I.YELLOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASESABER, rate:0.01 }, { id:I.WHITE_PHASESABER, rate:0.01 }, { id:I.YELLOW_PHASESABER, rate:0.01 }, { id:I.ORANGE_PHASESABER, rate:0.01 }, { id:I.PINK_PHASESABER, rate:0.01 }, { id:I.RAINBOW_PHASESABER, rate:0.01 }, { id:I.BONE_PICKAXE, rate:0.01 }, { id:I.CACTUS_PICKAXE, rate:0.01 }, { id:I.CANDY_CANE_PICKAXE, rate:0.01 }, { id:I.FOSSIL_PICKAXE, rate:0.01 }, { id:I.ORICHALCUM_PICKAXE, rate:0.01 }, { id:I.REAVER_SHARK, rate:0.01 }, { id:I.ASH_WOOD_HAMMER, rate:0.01 }, { id:I.BOREAL_WOOD_HAMMER, rate:0.01 }, { id:I.EBONWOOD_HAMMER, rate:0.01 }, { id:I.FLESH_GRINDER, rate:0.01 }, { id:I.GOLD_HAMMER, rate:0.01 }, { id:I.LEAD_HAMMER, rate:0.01 }, { id:I.PALM_WOOD_HAMMER, rate:0.01 }, { id:I.PEARLWOOD_HAMMER, rate:0.01 }, { id:I.PLATINUM_HAMMER, rate:0.01 }, { id:I.RICH_MAHOGANY_HAMMER, rate:0.01 }, { id:I.SHADEWOOD_HAMMER, rate:0.01 }, { id:I.SILVER_HAMMER, rate:0.01 }, { id:I.TUNGSTEN_HAMMER, rate:0.01 }, { id:I.WOODEN_HAMMER, rate:0.01 }, { id:I.ADAMANTITE_WARAXE, rate:0.01 }, { id:I.AXE_OF_REGROWTH, rate:0.01 }, { id:I.BLOOD_LUST_CLUSTER, rate:0.01 }, { id:I.COBALT_WARAXE, rate:0.01 }, { id:I.GOLD_AXE, rate:0.01 }, { id:I.LEAD_AXE, rate:0.01 }, { id:I.METEOR_HAMAXE, rate:0.01 }, { id:I.MOLTEN_HAMAXE, rate:0.01 }, { id:I.MYTHRIL_WARAXE, rate:0.01 }, { id:I.ORICHALCUM_WARAXE, rate:0.01 }, { id:I.PLATINUM_AXE, rate:0.01 }, { id:I.SILVER_AXE, rate:0.01 }, { id:I.TITANIUM_WARAXE, rate:0.01 }, { id:I.TUNGSTEN_AXE, rate:0.01 }, { id:I.WAR_AXE_OF_THE_NIGHT, rate:0.01 }, { id:I.ADAMANTITE_REPEATER, rate:0.01 }, { id:I.ASH_WOOD_BOW, rate:0.01 }, { id:I.BLOOD_RAIN_BOW, rate:0.01 }, { id:I.BLOWGUN, rate:0.01 }, { id:I.BLOWPIPE, rate:0.01 }, { id:I.BOREAL_WOOD_BOW, rate:0.01 }, { id:I.COBALT_REPEATER, rate:0.01 }, { id:I.DEMON_BOW, rate:0.01 }, { id:I.EBONWOOD_BOW, rate:0.01 }, { id:I.LEAD_BOW, rate:0.01 }, { id:I.MYTHRIL_REPEATER, rate:0.01 }, { id:I.ORICHALCUM_REPEATER, rate:0.01 }, { id:I.PALM_WOOD_BOW, rate:0.01 }, { id:I.PEARLWOOD_BOW, rate:0.01 }, { id:I.PLATINUM_BOW, rate:0.01 }, { id:I.RICH_MAHOGANY_BOW, rate:0.01 }, { id:I.SHADEWOOD_BOW, rate:0.01 }, { id:I.SKULL_BOW, rate:0.01 }, { id:I.TENDON_BOW, rate:0.01 }, { id:I.TITANIUM_REPEATER, rate:0.01 }, { id:I.TUNGSTEN_BOW, rate:0.01 }, { id:I.WOODEN_BOW, rate:0.01 }, { id:I.ALE_TOSSER, rate:0.01 }, { id:I.BEENADE, rate:0.01 }, { id:I.BLUE_FLARE, rate:0.01 }, { id:I.BOUNCY_GRENADE, rate:0.01 }, { id:I.CANDY_CORN, rate:0.01 }, { id:I.CHLOROPHYTE_ARROW, rate:0.01 }, { id:I.CLUSTER_ROCKET_I, rate:0.01 }, { id:I.CLUSTER_ROCKET_I_I, rate:0.01 }, { id:I.CURSED_ARROW, rate:0.01 }, { id:I.CURSED_FLARE, rate:0.01 }, { id:I.DRY_ROCKET, rate:0.01 }, { id:I.EXPLOSIVE_JACK_O_LANTERN, rate:0.01 }, { id:I.FLAMING_ARROW, rate:0.01 }, { id:I.FLARE, rate:0.01 }, { id:I.HAPPY_GRENADE, rate:0.01 }, { id:I.HONEY_ROCKET, rate:0.01 }, { id:I.ICHOR_ARROW, rate:0.01 }, { id:I.LAVA_ROCKET, rate:0.01 }, { id:I.LUMINITE_ARROW, rate:0.01 }, { id:I.MOLOTOV_COCKTAIL, rate:0.01 }, { id:I.NAIL, rate:0.01 }, { id:I.POISON_DART, rate:0.01 }, { id:I.RAINBOW_FLARE, rate:0.01 }, { id:I.ROTTEN_EGG, rate:0.01 }, { id:I.SEED, rate:0.01 }, { id:I.SHIMMER_ARROW, rate:0.01 }, { id:I.SHIMMER_FLARE, rate:0.01 }, { id:I.SNOWBALL, rate:0.01 }, { id:I.SNOWBALL_CANNON, rate:0.01 }, { id:I.SPELUNKER_FLARE, rate:0.01 }, { id:I.STAKE, rate:0.01 }, { id:I.STAR_ANISE, rate:0.01 }, { id:I.STICKY_GRENADE, rate:0.01 }, { id:I.VENOM_ARROW, rate:0.01 }, { id:I.WET_ROCKET, rate:0.01 }, { id:I.AMETHYST_STAFF, rate:0.01 }, { id:I.ARC_SURGE, rate:0.01 }, { id:I.BEJEWELED_STAFF, rate:0.01 }, { id:I.BOOK_OF_SKULLS, rate:0.01 }, { id:I.DAYBLOOM_STAFF, rate:0.01 }, { id:I.DIAMOND_STAFF, rate:0.01 }, { id:I.EMERALD_STAFF, rate:0.01 }, { id:I.GLACIER_FANG, rate:0.01 }, { id:I.GRAY_ZAPINATOR, rate:0.01 }, { id:I.LIGHTNING_STRIKE, rate:0.01 }, { id:I.MAGIC_MISSILE, rate:0.01 }, { id:I.METEOR_STAFF, rate:0.01 }, { id:I.MYSTIC_BLOOM, rate:0.01 }, { id:I.RUBY_STAFF, rate:0.01 }, { id:I.SAPPHIRE_STAFF, rate:0.01 }, { id:I.THUNDER_ZAPPER, rate:0.01 }, { id:I.TOME_OF_INFINITE_WISDOM, rate:0.01 }, { id:I.TOPAZ_STAFF, rate:0.01 }, { id:I.WAND_OF_SPARKING, rate:0.01 }, { id:I.BALLISTA_ROD, rate:0.01 }, { id:I.CATTIVA, rate:0.01 }, { id:I.CLAY_BUD_STAFF, rate:0.01 }, { id:I.COBWHIP, rate:0.01 }, { id:I.EXPLOSIVE_TRAP_ROD, rate:0.01 }, { id:I.FINCH_STAFF, rate:0.01 }, { id:I.FLAMEBURST_ROD, rate:0.01 }, { id:I.FOXPARKS, rate:0.01 }, { id:I.HOUNDIUS_SHOOTIUS, rate:0.01 }, { id:I.LIGHTNING_AURA_ROD, rate:0.01 }, { id:I.MUSHROOM_STAFF, rate:0.01 }, { id:I.RUINOUS_STAFF, rate:0.01 }, { id:I.SLIME_STAFF, rate:0.01 }, { id:I.SLIME_WHIP, rate:0.01 }, { id:I.SOULSCOURGE, rate:0.01 }, { id:I.SPINAL_TAP, rate:0.01 }, { id:I.STARCRASH, rate:0.01 }, { id:I.TRUSTY_CATTIVA, rate:0.01 }, { id:I.TRUSTY_FOXPARKS, rate:0.01 }, { id:I.VAMPIRE_FROG_STAFF, rate:0.01 }, { id:I.VASCULASH, rate:0.01 }, { id:I.TENTACLE_SPIKE, rate:0.01 }];
B83_ENEMY_DROPS['Skeleton'] = [{ id:I.ASH_WOOD_SWORD, rate:0.01 }, { id:I.BAT_BAT, rate:0.01 }, { id:I.BLADED_GLOVE, rate:0.01 }, { id:I.BOREAL_WOOD_SWORD, rate:0.01 }, { id:I.BRAND_OF_THE_INFERNO, rate:0.01 }, { id:I.BREATHING_REED, rate:0.01 }, { id:I.CACTUS_SWORD, rate:0.01 }, { id:I.CLASSY_CANE, rate:0.01 }, { id:I.EBONWOOD_SWORD, rate:0.01 }, { id:I.EXOTIC_SCIMITAR, rate:0.01 }, { id:I.FLYMEAL, rate:0.01 }, { id:I.GOLD_BROADSWORD, rate:0.01 }, { id:I.HAM_BAT, rate:0.01 }, { id:I.ICE_BLADE, rate:0.01 }, { id:I.LEAD_BROADSWORD, rate:0.01 }, { id:I.MANDIBLE_BLADE, rate:0.01 }, { id:I.ORANGE_PHASEBLADE, rate:0.01 }, { id:I.PALM_WOOD_SWORD, rate:0.01 }, { id:I.PEARLWOOD_SWORD, rate:0.01 }, { id:I.PINK_PHASEBLADE, rate:0.01 }, { id:I.PLATINUM_BROADSWORD, rate:0.01 }, { id:I.PURPLE_CLUBBERFISH, rate:0.01 }, { id:I.RAINBOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASEBLADE, rate:0.01 }, { id:I.RICH_MAHOGANY_SWORD, rate:0.01 }, { id:I.SHADEWOOD_SWORD, rate:0.01 }, { id:I.SHIELD_OF_CTHULHU, rate:0.01 }, { id:I.SICKLE, rate:0.01 }, { id:I.SILVER_BROADSWORD, rate:0.01 }, { id:I.STYLISH_SCISSORS, rate:0.01 }, { id:I.TRAGIC_UMBRELLA, rate:0.01 }, { id:I.TUNGSTEN_BROADSWORD, rate:0.01 }, { id:I.WAFFLES_IRON, rate:0.01 }, { id:I.WHITE_PHASEBLADE, rate:0.01 }, { id:I.YELLOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASESABER, rate:0.01 }, { id:I.WHITE_PHASESABER, rate:0.01 }, { id:I.YELLOW_PHASESABER, rate:0.01 }, { id:I.ORANGE_PHASESABER, rate:0.01 }, { id:I.PINK_PHASESABER, rate:0.01 }, { id:I.RAINBOW_PHASESABER, rate:0.01 }, { id:I.BONE_PICKAXE, rate:0.01 }, { id:I.CACTUS_PICKAXE, rate:0.01 }, { id:I.CANDY_CANE_PICKAXE, rate:0.01 }, { id:I.FOSSIL_PICKAXE, rate:0.01 }, { id:I.ORICHALCUM_PICKAXE, rate:0.01 }, { id:I.REAVER_SHARK, rate:0.01 }, { id:I.ASH_WOOD_HAMMER, rate:0.01 }, { id:I.BOREAL_WOOD_HAMMER, rate:0.01 }, { id:I.EBONWOOD_HAMMER, rate:0.01 }, { id:I.FLESH_GRINDER, rate:0.01 }, { id:I.GOLD_HAMMER, rate:0.01 }, { id:I.LEAD_HAMMER, rate:0.01 }, { id:I.PALM_WOOD_HAMMER, rate:0.01 }, { id:I.PEARLWOOD_HAMMER, rate:0.01 }, { id:I.PLATINUM_HAMMER, rate:0.01 }, { id:I.RICH_MAHOGANY_HAMMER, rate:0.01 }, { id:I.SHADEWOOD_HAMMER, rate:0.01 }, { id:I.SILVER_HAMMER, rate:0.01 }, { id:I.TUNGSTEN_HAMMER, rate:0.01 }, { id:I.WOODEN_HAMMER, rate:0.01 }, { id:I.ADAMANTITE_WARAXE, rate:0.01 }, { id:I.AXE_OF_REGROWTH, rate:0.01 }, { id:I.BLOOD_LUST_CLUSTER, rate:0.01 }, { id:I.COBALT_WARAXE, rate:0.01 }, { id:I.GOLD_AXE, rate:0.01 }, { id:I.LEAD_AXE, rate:0.01 }, { id:I.METEOR_HAMAXE, rate:0.01 }, { id:I.MOLTEN_HAMAXE, rate:0.01 }, { id:I.MYTHRIL_WARAXE, rate:0.01 }, { id:I.ORICHALCUM_WARAXE, rate:0.01 }, { id:I.PLATINUM_AXE, rate:0.01 }, { id:I.SILVER_AXE, rate:0.01 }, { id:I.TITANIUM_WARAXE, rate:0.01 }, { id:I.TUNGSTEN_AXE, rate:0.01 }, { id:I.WAR_AXE_OF_THE_NIGHT, rate:0.01 }, { id:I.ADAMANTITE_REPEATER, rate:0.01 }, { id:I.ASH_WOOD_BOW, rate:0.01 }, { id:I.BLOOD_RAIN_BOW, rate:0.01 }, { id:I.BLOWGUN, rate:0.01 }, { id:I.BLOWPIPE, rate:0.01 }, { id:I.BOREAL_WOOD_BOW, rate:0.01 }, { id:I.COBALT_REPEATER, rate:0.01 }, { id:I.DEMON_BOW, rate:0.01 }, { id:I.EBONWOOD_BOW, rate:0.01 }, { id:I.LEAD_BOW, rate:0.01 }, { id:I.MYTHRIL_REPEATER, rate:0.01 }, { id:I.ORICHALCUM_REPEATER, rate:0.01 }, { id:I.PALM_WOOD_BOW, rate:0.01 }, { id:I.PEARLWOOD_BOW, rate:0.01 }, { id:I.PLATINUM_BOW, rate:0.01 }, { id:I.RICH_MAHOGANY_BOW, rate:0.01 }, { id:I.SHADEWOOD_BOW, rate:0.01 }, { id:I.SKULL_BOW, rate:0.01 }, { id:I.TENDON_BOW, rate:0.01 }, { id:I.TITANIUM_REPEATER, rate:0.01 }, { id:I.TUNGSTEN_BOW, rate:0.01 }, { id:I.WOODEN_BOW, rate:0.01 }, { id:I.ALE_TOSSER, rate:0.01 }, { id:I.BEENADE, rate:0.01 }, { id:I.BLUE_FLARE, rate:0.01 }, { id:I.BOUNCY_GRENADE, rate:0.01 }, { id:I.CANDY_CORN, rate:0.01 }, { id:I.CHLOROPHYTE_ARROW, rate:0.01 }, { id:I.CLUSTER_ROCKET_I, rate:0.01 }, { id:I.CLUSTER_ROCKET_I_I, rate:0.01 }, { id:I.CURSED_ARROW, rate:0.01 }, { id:I.CURSED_FLARE, rate:0.01 }, { id:I.DRY_ROCKET, rate:0.01 }, { id:I.EXPLOSIVE_JACK_O_LANTERN, rate:0.01 }, { id:I.FLAMING_ARROW, rate:0.01 }, { id:I.FLARE, rate:0.01 }, { id:I.HAPPY_GRENADE, rate:0.01 }, { id:I.HONEY_ROCKET, rate:0.01 }, { id:I.ICHOR_ARROW, rate:0.01 }, { id:I.LAVA_ROCKET, rate:0.01 }, { id:I.LUMINITE_ARROW, rate:0.01 }, { id:I.MOLOTOV_COCKTAIL, rate:0.01 }, { id:I.NAIL, rate:0.01 }, { id:I.POISON_DART, rate:0.01 }, { id:I.RAINBOW_FLARE, rate:0.01 }, { id:I.ROTTEN_EGG, rate:0.01 }, { id:I.SEED, rate:0.01 }, { id:I.SHIMMER_ARROW, rate:0.01 }, { id:I.SHIMMER_FLARE, rate:0.01 }, { id:I.SNOWBALL, rate:0.01 }, { id:I.SNOWBALL_CANNON, rate:0.01 }, { id:I.SPELUNKER_FLARE, rate:0.01 }, { id:I.STAKE, rate:0.01 }, { id:I.STAR_ANISE, rate:0.01 }, { id:I.STICKY_GRENADE, rate:0.01 }, { id:I.VENOM_ARROW, rate:0.01 }, { id:I.WET_ROCKET, rate:0.01 }, { id:I.AMETHYST_STAFF, rate:0.01 }, { id:I.ARC_SURGE, rate:0.01 }, { id:I.BEJEWELED_STAFF, rate:0.01 }, { id:I.BOOK_OF_SKULLS, rate:0.01 }, { id:I.DAYBLOOM_STAFF, rate:0.01 }, { id:I.DIAMOND_STAFF, rate:0.01 }, { id:I.EMERALD_STAFF, rate:0.01 }, { id:I.GLACIER_FANG, rate:0.01 }, { id:I.GRAY_ZAPINATOR, rate:0.01 }, { id:I.LIGHTNING_STRIKE, rate:0.01 }, { id:I.MAGIC_MISSILE, rate:0.01 }, { id:I.METEOR_STAFF, rate:0.01 }, { id:I.MYSTIC_BLOOM, rate:0.01 }, { id:I.RUBY_STAFF, rate:0.01 }, { id:I.SAPPHIRE_STAFF, rate:0.01 }, { id:I.THUNDER_ZAPPER, rate:0.01 }, { id:I.TOME_OF_INFINITE_WISDOM, rate:0.01 }, { id:I.TOPAZ_STAFF, rate:0.01 }, { id:I.WAND_OF_SPARKING, rate:0.01 }, { id:I.BALLISTA_ROD, rate:0.01 }, { id:I.CATTIVA, rate:0.01 }, { id:I.CLAY_BUD_STAFF, rate:0.01 }, { id:I.COBWHIP, rate:0.01 }, { id:I.EXPLOSIVE_TRAP_ROD, rate:0.01 }, { id:I.FINCH_STAFF, rate:0.01 }, { id:I.FLAMEBURST_ROD, rate:0.01 }, { id:I.FOXPARKS, rate:0.01 }, { id:I.HOUNDIUS_SHOOTIUS, rate:0.01 }, { id:I.LIGHTNING_AURA_ROD, rate:0.01 }, { id:I.MUSHROOM_STAFF, rate:0.01 }, { id:I.RUINOUS_STAFF, rate:0.01 }, { id:I.SLIME_STAFF, rate:0.01 }, { id:I.SLIME_WHIP, rate:0.01 }, { id:I.SOULSCOURGE, rate:0.01 }, { id:I.SPINAL_TAP, rate:0.01 }, { id:I.STARCRASH, rate:0.01 }, { id:I.TRUSTY_CATTIVA, rate:0.01 }, { id:I.TRUSTY_FOXPARKS, rate:0.01 }, { id:I.VAMPIRE_FROG_STAFF, rate:0.01 }, { id:I.VASCULASH, rate:0.01 }, { id:I.TENTACLE_SPIKE, rate:0.01 }];
B83_ENEMY_DROPS['Cave Bat'] = [{ id:I.ASH_WOOD_SWORD, rate:0.01 }, { id:I.BAT_BAT, rate:0.01 }, { id:I.BLADED_GLOVE, rate:0.01 }, { id:I.BOREAL_WOOD_SWORD, rate:0.01 }, { id:I.BRAND_OF_THE_INFERNO, rate:0.01 }, { id:I.BREATHING_REED, rate:0.01 }, { id:I.CACTUS_SWORD, rate:0.01 }, { id:I.CLASSY_CANE, rate:0.01 }, { id:I.EBONWOOD_SWORD, rate:0.01 }, { id:I.EXOTIC_SCIMITAR, rate:0.01 }, { id:I.FLYMEAL, rate:0.01 }, { id:I.GOLD_BROADSWORD, rate:0.01 }, { id:I.HAM_BAT, rate:0.01 }, { id:I.ICE_BLADE, rate:0.01 }, { id:I.LEAD_BROADSWORD, rate:0.01 }, { id:I.MANDIBLE_BLADE, rate:0.01 }, { id:I.ORANGE_PHASEBLADE, rate:0.01 }, { id:I.PALM_WOOD_SWORD, rate:0.01 }, { id:I.PEARLWOOD_SWORD, rate:0.01 }, { id:I.PINK_PHASEBLADE, rate:0.01 }, { id:I.PLATINUM_BROADSWORD, rate:0.01 }, { id:I.PURPLE_CLUBBERFISH, rate:0.01 }, { id:I.RAINBOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASEBLADE, rate:0.01 }, { id:I.RICH_MAHOGANY_SWORD, rate:0.01 }, { id:I.SHADEWOOD_SWORD, rate:0.01 }, { id:I.SHIELD_OF_CTHULHU, rate:0.01 }, { id:I.SICKLE, rate:0.01 }, { id:I.SILVER_BROADSWORD, rate:0.01 }, { id:I.STYLISH_SCISSORS, rate:0.01 }, { id:I.TRAGIC_UMBRELLA, rate:0.01 }, { id:I.TUNGSTEN_BROADSWORD, rate:0.01 }, { id:I.WAFFLES_IRON, rate:0.01 }, { id:I.WHITE_PHASEBLADE, rate:0.01 }, { id:I.YELLOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASESABER, rate:0.01 }, { id:I.WHITE_PHASESABER, rate:0.01 }, { id:I.YELLOW_PHASESABER, rate:0.01 }, { id:I.ORANGE_PHASESABER, rate:0.01 }, { id:I.PINK_PHASESABER, rate:0.01 }, { id:I.RAINBOW_PHASESABER, rate:0.01 }, { id:I.BONE_PICKAXE, rate:0.01 }, { id:I.CACTUS_PICKAXE, rate:0.01 }, { id:I.CANDY_CANE_PICKAXE, rate:0.01 }, { id:I.FOSSIL_PICKAXE, rate:0.01 }, { id:I.ORICHALCUM_PICKAXE, rate:0.01 }, { id:I.REAVER_SHARK, rate:0.01 }, { id:I.ASH_WOOD_HAMMER, rate:0.01 }, { id:I.BOREAL_WOOD_HAMMER, rate:0.01 }, { id:I.EBONWOOD_HAMMER, rate:0.01 }, { id:I.FLESH_GRINDER, rate:0.01 }, { id:I.GOLD_HAMMER, rate:0.01 }, { id:I.LEAD_HAMMER, rate:0.01 }, { id:I.PALM_WOOD_HAMMER, rate:0.01 }, { id:I.PEARLWOOD_HAMMER, rate:0.01 }, { id:I.PLATINUM_HAMMER, rate:0.01 }, { id:I.RICH_MAHOGANY_HAMMER, rate:0.01 }, { id:I.SHADEWOOD_HAMMER, rate:0.01 }, { id:I.SILVER_HAMMER, rate:0.01 }, { id:I.TUNGSTEN_HAMMER, rate:0.01 }, { id:I.WOODEN_HAMMER, rate:0.01 }, { id:I.ADAMANTITE_WARAXE, rate:0.01 }, { id:I.AXE_OF_REGROWTH, rate:0.01 }, { id:I.BLOOD_LUST_CLUSTER, rate:0.01 }, { id:I.COBALT_WARAXE, rate:0.01 }, { id:I.GOLD_AXE, rate:0.01 }, { id:I.LEAD_AXE, rate:0.01 }, { id:I.METEOR_HAMAXE, rate:0.01 }, { id:I.MOLTEN_HAMAXE, rate:0.01 }, { id:I.MYTHRIL_WARAXE, rate:0.01 }, { id:I.ORICHALCUM_WARAXE, rate:0.01 }, { id:I.PLATINUM_AXE, rate:0.01 }, { id:I.SILVER_AXE, rate:0.01 }, { id:I.TITANIUM_WARAXE, rate:0.01 }, { id:I.TUNGSTEN_AXE, rate:0.01 }, { id:I.WAR_AXE_OF_THE_NIGHT, rate:0.01 }, { id:I.ADAMANTITE_REPEATER, rate:0.01 }, { id:I.ASH_WOOD_BOW, rate:0.01 }, { id:I.BLOOD_RAIN_BOW, rate:0.01 }, { id:I.BLOWGUN, rate:0.01 }, { id:I.BLOWPIPE, rate:0.01 }, { id:I.BOREAL_WOOD_BOW, rate:0.01 }, { id:I.COBALT_REPEATER, rate:0.01 }, { id:I.DEMON_BOW, rate:0.01 }, { id:I.EBONWOOD_BOW, rate:0.01 }, { id:I.LEAD_BOW, rate:0.01 }, { id:I.MYTHRIL_REPEATER, rate:0.01 }, { id:I.ORICHALCUM_REPEATER, rate:0.01 }, { id:I.PALM_WOOD_BOW, rate:0.01 }, { id:I.PEARLWOOD_BOW, rate:0.01 }, { id:I.PLATINUM_BOW, rate:0.01 }, { id:I.RICH_MAHOGANY_BOW, rate:0.01 }, { id:I.SHADEWOOD_BOW, rate:0.01 }, { id:I.SKULL_BOW, rate:0.01 }, { id:I.TENDON_BOW, rate:0.01 }, { id:I.TITANIUM_REPEATER, rate:0.01 }, { id:I.TUNGSTEN_BOW, rate:0.01 }, { id:I.WOODEN_BOW, rate:0.01 }, { id:I.ALE_TOSSER, rate:0.01 }, { id:I.BEENADE, rate:0.01 }, { id:I.BLUE_FLARE, rate:0.01 }, { id:I.BOUNCY_GRENADE, rate:0.01 }, { id:I.CANDY_CORN, rate:0.01 }, { id:I.CHLOROPHYTE_ARROW, rate:0.01 }, { id:I.CLUSTER_ROCKET_I, rate:0.01 }, { id:I.CLUSTER_ROCKET_I_I, rate:0.01 }, { id:I.CURSED_ARROW, rate:0.01 }, { id:I.CURSED_FLARE, rate:0.01 }, { id:I.DRY_ROCKET, rate:0.01 }, { id:I.EXPLOSIVE_JACK_O_LANTERN, rate:0.01 }, { id:I.FLAMING_ARROW, rate:0.01 }, { id:I.FLARE, rate:0.01 }, { id:I.HAPPY_GRENADE, rate:0.01 }, { id:I.HONEY_ROCKET, rate:0.01 }, { id:I.ICHOR_ARROW, rate:0.01 }, { id:I.LAVA_ROCKET, rate:0.01 }, { id:I.LUMINITE_ARROW, rate:0.01 }, { id:I.MOLOTOV_COCKTAIL, rate:0.01 }, { id:I.NAIL, rate:0.01 }, { id:I.POISON_DART, rate:0.01 }, { id:I.RAINBOW_FLARE, rate:0.01 }, { id:I.ROTTEN_EGG, rate:0.01 }, { id:I.SEED, rate:0.01 }, { id:I.SHIMMER_ARROW, rate:0.01 }, { id:I.SHIMMER_FLARE, rate:0.01 }, { id:I.SNOWBALL, rate:0.01 }, { id:I.SNOWBALL_CANNON, rate:0.01 }, { id:I.SPELUNKER_FLARE, rate:0.01 }, { id:I.STAKE, rate:0.01 }, { id:I.STAR_ANISE, rate:0.01 }, { id:I.STICKY_GRENADE, rate:0.01 }, { id:I.VENOM_ARROW, rate:0.01 }, { id:I.WET_ROCKET, rate:0.01 }, { id:I.AMETHYST_STAFF, rate:0.01 }, { id:I.ARC_SURGE, rate:0.01 }, { id:I.BEJEWELED_STAFF, rate:0.01 }, { id:I.BOOK_OF_SKULLS, rate:0.01 }, { id:I.DAYBLOOM_STAFF, rate:0.01 }, { id:I.DIAMOND_STAFF, rate:0.01 }, { id:I.EMERALD_STAFF, rate:0.01 }, { id:I.GLACIER_FANG, rate:0.01 }, { id:I.GRAY_ZAPINATOR, rate:0.01 }, { id:I.LIGHTNING_STRIKE, rate:0.01 }, { id:I.MAGIC_MISSILE, rate:0.01 }, { id:I.METEOR_STAFF, rate:0.01 }, { id:I.MYSTIC_BLOOM, rate:0.01 }, { id:I.RUBY_STAFF, rate:0.01 }, { id:I.SAPPHIRE_STAFF, rate:0.01 }, { id:I.THUNDER_ZAPPER, rate:0.01 }, { id:I.TOME_OF_INFINITE_WISDOM, rate:0.01 }, { id:I.TOPAZ_STAFF, rate:0.01 }, { id:I.WAND_OF_SPARKING, rate:0.01 }, { id:I.BALLISTA_ROD, rate:0.01 }, { id:I.CATTIVA, rate:0.01 }, { id:I.CLAY_BUD_STAFF, rate:0.01 }, { id:I.COBWHIP, rate:0.01 }, { id:I.EXPLOSIVE_TRAP_ROD, rate:0.01 }, { id:I.FINCH_STAFF, rate:0.01 }, { id:I.FLAMEBURST_ROD, rate:0.01 }, { id:I.FOXPARKS, rate:0.01 }, { id:I.HOUNDIUS_SHOOTIUS, rate:0.01 }, { id:I.LIGHTNING_AURA_ROD, rate:0.01 }, { id:I.MUSHROOM_STAFF, rate:0.01 }, { id:I.RUINOUS_STAFF, rate:0.01 }, { id:I.SLIME_STAFF, rate:0.01 }, { id:I.SLIME_WHIP, rate:0.01 }, { id:I.SOULSCOURGE, rate:0.01 }, { id:I.SPINAL_TAP, rate:0.01 }, { id:I.STARCRASH, rate:0.01 }, { id:I.TRUSTY_CATTIVA, rate:0.01 }, { id:I.TRUSTY_FOXPARKS, rate:0.01 }, { id:I.VAMPIRE_FROG_STAFF, rate:0.01 }, { id:I.VASCULASH, rate:0.01 }, { id:I.TENTACLE_SPIKE, rate:0.01 }];
B83_ENEMY_DROPS['Giant Worm'] = [{ id:I.ASH_WOOD_SWORD, rate:0.01 }, { id:I.BAT_BAT, rate:0.01 }, { id:I.BLADED_GLOVE, rate:0.01 }, { id:I.BOREAL_WOOD_SWORD, rate:0.01 }, { id:I.BRAND_OF_THE_INFERNO, rate:0.01 }, { id:I.BREATHING_REED, rate:0.01 }, { id:I.CACTUS_SWORD, rate:0.01 }, { id:I.CLASSY_CANE, rate:0.01 }, { id:I.EBONWOOD_SWORD, rate:0.01 }, { id:I.EXOTIC_SCIMITAR, rate:0.01 }, { id:I.FLYMEAL, rate:0.01 }, { id:I.GOLD_BROADSWORD, rate:0.01 }, { id:I.HAM_BAT, rate:0.01 }, { id:I.ICE_BLADE, rate:0.01 }, { id:I.LEAD_BROADSWORD, rate:0.01 }, { id:I.MANDIBLE_BLADE, rate:0.01 }, { id:I.ORANGE_PHASEBLADE, rate:0.01 }, { id:I.PALM_WOOD_SWORD, rate:0.01 }, { id:I.PEARLWOOD_SWORD, rate:0.01 }, { id:I.PINK_PHASEBLADE, rate:0.01 }, { id:I.PLATINUM_BROADSWORD, rate:0.01 }, { id:I.PURPLE_CLUBBERFISH, rate:0.01 }, { id:I.RAINBOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASEBLADE, rate:0.01 }, { id:I.RICH_MAHOGANY_SWORD, rate:0.01 }, { id:I.SHADEWOOD_SWORD, rate:0.01 }, { id:I.SHIELD_OF_CTHULHU, rate:0.01 }, { id:I.SICKLE, rate:0.01 }, { id:I.SILVER_BROADSWORD, rate:0.01 }, { id:I.STYLISH_SCISSORS, rate:0.01 }, { id:I.TRAGIC_UMBRELLA, rate:0.01 }, { id:I.TUNGSTEN_BROADSWORD, rate:0.01 }, { id:I.WAFFLES_IRON, rate:0.01 }, { id:I.WHITE_PHASEBLADE, rate:0.01 }, { id:I.YELLOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASESABER, rate:0.01 }, { id:I.WHITE_PHASESABER, rate:0.01 }, { id:I.YELLOW_PHASESABER, rate:0.01 }, { id:I.ORANGE_PHASESABER, rate:0.01 }, { id:I.PINK_PHASESABER, rate:0.01 }, { id:I.RAINBOW_PHASESABER, rate:0.01 }, { id:I.BONE_PICKAXE, rate:0.01 }, { id:I.CACTUS_PICKAXE, rate:0.01 }, { id:I.CANDY_CANE_PICKAXE, rate:0.01 }, { id:I.FOSSIL_PICKAXE, rate:0.01 }, { id:I.ORICHALCUM_PICKAXE, rate:0.01 }, { id:I.REAVER_SHARK, rate:0.01 }, { id:I.ASH_WOOD_HAMMER, rate:0.01 }, { id:I.BOREAL_WOOD_HAMMER, rate:0.01 }, { id:I.EBONWOOD_HAMMER, rate:0.01 }, { id:I.FLESH_GRINDER, rate:0.01 }, { id:I.GOLD_HAMMER, rate:0.01 }, { id:I.LEAD_HAMMER, rate:0.01 }, { id:I.PALM_WOOD_HAMMER, rate:0.01 }, { id:I.PEARLWOOD_HAMMER, rate:0.01 }, { id:I.PLATINUM_HAMMER, rate:0.01 }, { id:I.RICH_MAHOGANY_HAMMER, rate:0.01 }, { id:I.SHADEWOOD_HAMMER, rate:0.01 }, { id:I.SILVER_HAMMER, rate:0.01 }, { id:I.TUNGSTEN_HAMMER, rate:0.01 }, { id:I.WOODEN_HAMMER, rate:0.01 }, { id:I.ADAMANTITE_WARAXE, rate:0.01 }, { id:I.AXE_OF_REGROWTH, rate:0.01 }, { id:I.BLOOD_LUST_CLUSTER, rate:0.01 }, { id:I.COBALT_WARAXE, rate:0.01 }, { id:I.GOLD_AXE, rate:0.01 }, { id:I.LEAD_AXE, rate:0.01 }, { id:I.METEOR_HAMAXE, rate:0.01 }, { id:I.MOLTEN_HAMAXE, rate:0.01 }, { id:I.MYTHRIL_WARAXE, rate:0.01 }, { id:I.ORICHALCUM_WARAXE, rate:0.01 }, { id:I.PLATINUM_AXE, rate:0.01 }, { id:I.SILVER_AXE, rate:0.01 }, { id:I.TITANIUM_WARAXE, rate:0.01 }, { id:I.TUNGSTEN_AXE, rate:0.01 }, { id:I.WAR_AXE_OF_THE_NIGHT, rate:0.01 }, { id:I.ADAMANTITE_REPEATER, rate:0.01 }, { id:I.ASH_WOOD_BOW, rate:0.01 }, { id:I.BLOOD_RAIN_BOW, rate:0.01 }, { id:I.BLOWGUN, rate:0.01 }, { id:I.BLOWPIPE, rate:0.01 }, { id:I.BOREAL_WOOD_BOW, rate:0.01 }, { id:I.COBALT_REPEATER, rate:0.01 }, { id:I.DEMON_BOW, rate:0.01 }, { id:I.EBONWOOD_BOW, rate:0.01 }, { id:I.LEAD_BOW, rate:0.01 }, { id:I.MYTHRIL_REPEATER, rate:0.01 }, { id:I.ORICHALCUM_REPEATER, rate:0.01 }, { id:I.PALM_WOOD_BOW, rate:0.01 }, { id:I.PEARLWOOD_BOW, rate:0.01 }, { id:I.PLATINUM_BOW, rate:0.01 }, { id:I.RICH_MAHOGANY_BOW, rate:0.01 }, { id:I.SHADEWOOD_BOW, rate:0.01 }, { id:I.SKULL_BOW, rate:0.01 }, { id:I.TENDON_BOW, rate:0.01 }, { id:I.TITANIUM_REPEATER, rate:0.01 }, { id:I.TUNGSTEN_BOW, rate:0.01 }, { id:I.WOODEN_BOW, rate:0.01 }, { id:I.ALE_TOSSER, rate:0.01 }, { id:I.BEENADE, rate:0.01 }, { id:I.BLUE_FLARE, rate:0.01 }, { id:I.BOUNCY_GRENADE, rate:0.01 }, { id:I.CANDY_CORN, rate:0.01 }, { id:I.CHLOROPHYTE_ARROW, rate:0.01 }, { id:I.CLUSTER_ROCKET_I, rate:0.01 }, { id:I.CLUSTER_ROCKET_I_I, rate:0.01 }, { id:I.CURSED_ARROW, rate:0.01 }, { id:I.CURSED_FLARE, rate:0.01 }, { id:I.DRY_ROCKET, rate:0.01 }, { id:I.EXPLOSIVE_JACK_O_LANTERN, rate:0.01 }, { id:I.FLAMING_ARROW, rate:0.01 }, { id:I.FLARE, rate:0.01 }, { id:I.HAPPY_GRENADE, rate:0.01 }, { id:I.HONEY_ROCKET, rate:0.01 }, { id:I.ICHOR_ARROW, rate:0.01 }, { id:I.LAVA_ROCKET, rate:0.01 }, { id:I.LUMINITE_ARROW, rate:0.01 }, { id:I.MOLOTOV_COCKTAIL, rate:0.01 }, { id:I.NAIL, rate:0.01 }, { id:I.POISON_DART, rate:0.01 }, { id:I.RAINBOW_FLARE, rate:0.01 }, { id:I.ROTTEN_EGG, rate:0.01 }, { id:I.SEED, rate:0.01 }, { id:I.SHIMMER_ARROW, rate:0.01 }, { id:I.SHIMMER_FLARE, rate:0.01 }, { id:I.SNOWBALL, rate:0.01 }, { id:I.SNOWBALL_CANNON, rate:0.01 }, { id:I.SPELUNKER_FLARE, rate:0.01 }, { id:I.STAKE, rate:0.01 }, { id:I.STAR_ANISE, rate:0.01 }, { id:I.STICKY_GRENADE, rate:0.01 }, { id:I.VENOM_ARROW, rate:0.01 }, { id:I.WET_ROCKET, rate:0.01 }, { id:I.AMETHYST_STAFF, rate:0.01 }, { id:I.ARC_SURGE, rate:0.01 }, { id:I.BEJEWELED_STAFF, rate:0.01 }, { id:I.BOOK_OF_SKULLS, rate:0.01 }, { id:I.DAYBLOOM_STAFF, rate:0.01 }, { id:I.DIAMOND_STAFF, rate:0.01 }, { id:I.EMERALD_STAFF, rate:0.01 }, { id:I.GLACIER_FANG, rate:0.01 }, { id:I.GRAY_ZAPINATOR, rate:0.01 }, { id:I.LIGHTNING_STRIKE, rate:0.01 }, { id:I.MAGIC_MISSILE, rate:0.01 }, { id:I.METEOR_STAFF, rate:0.01 }, { id:I.MYSTIC_BLOOM, rate:0.01 }, { id:I.RUBY_STAFF, rate:0.01 }, { id:I.SAPPHIRE_STAFF, rate:0.01 }, { id:I.THUNDER_ZAPPER, rate:0.01 }, { id:I.TOME_OF_INFINITE_WISDOM, rate:0.01 }, { id:I.TOPAZ_STAFF, rate:0.01 }, { id:I.WAND_OF_SPARKING, rate:0.01 }, { id:I.BALLISTA_ROD, rate:0.01 }, { id:I.CATTIVA, rate:0.01 }, { id:I.CLAY_BUD_STAFF, rate:0.01 }, { id:I.COBWHIP, rate:0.01 }, { id:I.EXPLOSIVE_TRAP_ROD, rate:0.01 }, { id:I.FINCH_STAFF, rate:0.01 }, { id:I.FLAMEBURST_ROD, rate:0.01 }, { id:I.FOXPARKS, rate:0.01 }, { id:I.HOUNDIUS_SHOOTIUS, rate:0.01 }, { id:I.LIGHTNING_AURA_ROD, rate:0.01 }, { id:I.MUSHROOM_STAFF, rate:0.01 }, { id:I.RUINOUS_STAFF, rate:0.01 }, { id:I.SLIME_STAFF, rate:0.01 }, { id:I.SLIME_WHIP, rate:0.01 }, { id:I.SOULSCOURGE, rate:0.01 }, { id:I.SPINAL_TAP, rate:0.01 }, { id:I.STARCRASH, rate:0.01 }, { id:I.TRUSTY_CATTIVA, rate:0.01 }, { id:I.TRUSTY_FOXPARKS, rate:0.01 }, { id:I.VAMPIRE_FROG_STAFF, rate:0.01 }, { id:I.VASCULASH, rate:0.01 }, { id:I.TENTACLE_SPIKE, rate:0.01 }];
B83_ENEMY_DROPS['Mother Slime'] = [{ id:I.ASH_WOOD_SWORD, rate:0.01 }, { id:I.BAT_BAT, rate:0.01 }, { id:I.BLADED_GLOVE, rate:0.01 }, { id:I.BOREAL_WOOD_SWORD, rate:0.01 }, { id:I.BRAND_OF_THE_INFERNO, rate:0.01 }, { id:I.BREATHING_REED, rate:0.01 }, { id:I.CACTUS_SWORD, rate:0.01 }, { id:I.CLASSY_CANE, rate:0.01 }, { id:I.EBONWOOD_SWORD, rate:0.01 }, { id:I.EXOTIC_SCIMITAR, rate:0.01 }, { id:I.FLYMEAL, rate:0.01 }, { id:I.GOLD_BROADSWORD, rate:0.01 }, { id:I.HAM_BAT, rate:0.01 }, { id:I.ICE_BLADE, rate:0.01 }, { id:I.LEAD_BROADSWORD, rate:0.01 }, { id:I.MANDIBLE_BLADE, rate:0.01 }, { id:I.ORANGE_PHASEBLADE, rate:0.01 }, { id:I.PALM_WOOD_SWORD, rate:0.01 }, { id:I.PEARLWOOD_SWORD, rate:0.01 }, { id:I.PINK_PHASEBLADE, rate:0.01 }, { id:I.PLATINUM_BROADSWORD, rate:0.01 }, { id:I.PURPLE_CLUBBERFISH, rate:0.01 }, { id:I.RAINBOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASEBLADE, rate:0.01 }, { id:I.RICH_MAHOGANY_SWORD, rate:0.01 }, { id:I.SHADEWOOD_SWORD, rate:0.01 }, { id:I.SHIELD_OF_CTHULHU, rate:0.01 }, { id:I.SICKLE, rate:0.01 }, { id:I.SILVER_BROADSWORD, rate:0.01 }, { id:I.STYLISH_SCISSORS, rate:0.01 }, { id:I.TRAGIC_UMBRELLA, rate:0.01 }, { id:I.TUNGSTEN_BROADSWORD, rate:0.01 }, { id:I.WAFFLES_IRON, rate:0.01 }, { id:I.WHITE_PHASEBLADE, rate:0.01 }, { id:I.YELLOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASESABER, rate:0.01 }, { id:I.WHITE_PHASESABER, rate:0.01 }, { id:I.YELLOW_PHASESABER, rate:0.01 }, { id:I.ORANGE_PHASESABER, rate:0.01 }, { id:I.PINK_PHASESABER, rate:0.01 }, { id:I.RAINBOW_PHASESABER, rate:0.01 }, { id:I.BONE_PICKAXE, rate:0.01 }, { id:I.CACTUS_PICKAXE, rate:0.01 }, { id:I.CANDY_CANE_PICKAXE, rate:0.01 }, { id:I.FOSSIL_PICKAXE, rate:0.01 }, { id:I.ORICHALCUM_PICKAXE, rate:0.01 }, { id:I.REAVER_SHARK, rate:0.01 }, { id:I.ASH_WOOD_HAMMER, rate:0.01 }, { id:I.BOREAL_WOOD_HAMMER, rate:0.01 }, { id:I.EBONWOOD_HAMMER, rate:0.01 }, { id:I.FLESH_GRINDER, rate:0.01 }, { id:I.GOLD_HAMMER, rate:0.01 }, { id:I.LEAD_HAMMER, rate:0.01 }, { id:I.PALM_WOOD_HAMMER, rate:0.01 }, { id:I.PEARLWOOD_HAMMER, rate:0.01 }, { id:I.PLATINUM_HAMMER, rate:0.01 }, { id:I.RICH_MAHOGANY_HAMMER, rate:0.01 }, { id:I.SHADEWOOD_HAMMER, rate:0.01 }, { id:I.SILVER_HAMMER, rate:0.01 }, { id:I.TUNGSTEN_HAMMER, rate:0.01 }, { id:I.WOODEN_HAMMER, rate:0.01 }, { id:I.ADAMANTITE_WARAXE, rate:0.01 }, { id:I.AXE_OF_REGROWTH, rate:0.01 }, { id:I.BLOOD_LUST_CLUSTER, rate:0.01 }, { id:I.COBALT_WARAXE, rate:0.01 }, { id:I.GOLD_AXE, rate:0.01 }, { id:I.LEAD_AXE, rate:0.01 }, { id:I.METEOR_HAMAXE, rate:0.01 }, { id:I.MOLTEN_HAMAXE, rate:0.01 }, { id:I.MYTHRIL_WARAXE, rate:0.01 }, { id:I.ORICHALCUM_WARAXE, rate:0.01 }, { id:I.PLATINUM_AXE, rate:0.01 }, { id:I.SILVER_AXE, rate:0.01 }, { id:I.TITANIUM_WARAXE, rate:0.01 }, { id:I.TUNGSTEN_AXE, rate:0.01 }, { id:I.WAR_AXE_OF_THE_NIGHT, rate:0.01 }, { id:I.ADAMANTITE_REPEATER, rate:0.01 }, { id:I.ASH_WOOD_BOW, rate:0.01 }, { id:I.BLOOD_RAIN_BOW, rate:0.01 }, { id:I.BLOWGUN, rate:0.01 }, { id:I.BLOWPIPE, rate:0.01 }, { id:I.BOREAL_WOOD_BOW, rate:0.01 }, { id:I.COBALT_REPEATER, rate:0.01 }, { id:I.DEMON_BOW, rate:0.01 }, { id:I.EBONWOOD_BOW, rate:0.01 }, { id:I.LEAD_BOW, rate:0.01 }, { id:I.MYTHRIL_REPEATER, rate:0.01 }, { id:I.ORICHALCUM_REPEATER, rate:0.01 }, { id:I.PALM_WOOD_BOW, rate:0.01 }, { id:I.PEARLWOOD_BOW, rate:0.01 }, { id:I.PLATINUM_BOW, rate:0.01 }, { id:I.RICH_MAHOGANY_BOW, rate:0.01 }, { id:I.SHADEWOOD_BOW, rate:0.01 }, { id:I.SKULL_BOW, rate:0.01 }, { id:I.TENDON_BOW, rate:0.01 }, { id:I.TITANIUM_REPEATER, rate:0.01 }, { id:I.TUNGSTEN_BOW, rate:0.01 }, { id:I.WOODEN_BOW, rate:0.01 }, { id:I.ALE_TOSSER, rate:0.01 }, { id:I.BEENADE, rate:0.01 }, { id:I.BLUE_FLARE, rate:0.01 }, { id:I.BOUNCY_GRENADE, rate:0.01 }, { id:I.CANDY_CORN, rate:0.01 }, { id:I.CHLOROPHYTE_ARROW, rate:0.01 }, { id:I.CLUSTER_ROCKET_I, rate:0.01 }, { id:I.CLUSTER_ROCKET_I_I, rate:0.01 }, { id:I.CURSED_ARROW, rate:0.01 }, { id:I.CURSED_FLARE, rate:0.01 }, { id:I.DRY_ROCKET, rate:0.01 }, { id:I.EXPLOSIVE_JACK_O_LANTERN, rate:0.01 }, { id:I.FLAMING_ARROW, rate:0.01 }, { id:I.FLARE, rate:0.01 }, { id:I.HAPPY_GRENADE, rate:0.01 }, { id:I.HONEY_ROCKET, rate:0.01 }, { id:I.ICHOR_ARROW, rate:0.01 }, { id:I.LAVA_ROCKET, rate:0.01 }, { id:I.LUMINITE_ARROW, rate:0.01 }, { id:I.MOLOTOV_COCKTAIL, rate:0.01 }, { id:I.NAIL, rate:0.01 }, { id:I.POISON_DART, rate:0.01 }, { id:I.RAINBOW_FLARE, rate:0.01 }, { id:I.ROTTEN_EGG, rate:0.01 }, { id:I.SEED, rate:0.01 }, { id:I.SHIMMER_ARROW, rate:0.01 }, { id:I.SHIMMER_FLARE, rate:0.01 }, { id:I.SNOWBALL, rate:0.01 }, { id:I.SNOWBALL_CANNON, rate:0.01 }, { id:I.SPELUNKER_FLARE, rate:0.01 }, { id:I.STAKE, rate:0.01 }, { id:I.STAR_ANISE, rate:0.01 }, { id:I.STICKY_GRENADE, rate:0.01 }, { id:I.VENOM_ARROW, rate:0.01 }, { id:I.WET_ROCKET, rate:0.01 }, { id:I.AMETHYST_STAFF, rate:0.01 }, { id:I.ARC_SURGE, rate:0.01 }, { id:I.BEJEWELED_STAFF, rate:0.01 }, { id:I.BOOK_OF_SKULLS, rate:0.01 }, { id:I.DAYBLOOM_STAFF, rate:0.01 }, { id:I.DIAMOND_STAFF, rate:0.01 }, { id:I.EMERALD_STAFF, rate:0.01 }, { id:I.GLACIER_FANG, rate:0.01 }, { id:I.GRAY_ZAPINATOR, rate:0.01 }, { id:I.LIGHTNING_STRIKE, rate:0.01 }, { id:I.MAGIC_MISSILE, rate:0.01 }, { id:I.METEOR_STAFF, rate:0.01 }, { id:I.MYSTIC_BLOOM, rate:0.01 }, { id:I.RUBY_STAFF, rate:0.01 }, { id:I.SAPPHIRE_STAFF, rate:0.01 }, { id:I.THUNDER_ZAPPER, rate:0.01 }, { id:I.TOME_OF_INFINITE_WISDOM, rate:0.01 }, { id:I.TOPAZ_STAFF, rate:0.01 }, { id:I.WAND_OF_SPARKING, rate:0.01 }, { id:I.BALLISTA_ROD, rate:0.01 }, { id:I.CATTIVA, rate:0.01 }, { id:I.CLAY_BUD_STAFF, rate:0.01 }, { id:I.COBWHIP, rate:0.01 }, { id:I.EXPLOSIVE_TRAP_ROD, rate:0.01 }, { id:I.FINCH_STAFF, rate:0.01 }, { id:I.FLAMEBURST_ROD, rate:0.01 }, { id:I.FOXPARKS, rate:0.01 }, { id:I.HOUNDIUS_SHOOTIUS, rate:0.01 }, { id:I.LIGHTNING_AURA_ROD, rate:0.01 }, { id:I.MUSHROOM_STAFF, rate:0.01 }, { id:I.RUINOUS_STAFF, rate:0.01 }, { id:I.SLIME_STAFF, rate:0.01 }, { id:I.SLIME_WHIP, rate:0.01 }, { id:I.SOULSCOURGE, rate:0.01 }, { id:I.SPINAL_TAP, rate:0.01 }, { id:I.STARCRASH, rate:0.01 }, { id:I.TRUSTY_CATTIVA, rate:0.01 }, { id:I.TRUSTY_FOXPARKS, rate:0.01 }, { id:I.VAMPIRE_FROG_STAFF, rate:0.01 }, { id:I.VASCULASH, rate:0.01 }, { id:I.TENTACLE_SPIKE, rate:0.01 }];
B83_ENEMY_DROPS['Blue Slime'] = [{ id:I.ASH_WOOD_SWORD, rate:0.01 }, { id:I.BAT_BAT, rate:0.01 }, { id:I.BLADED_GLOVE, rate:0.01 }, { id:I.BOREAL_WOOD_SWORD, rate:0.01 }, { id:I.BRAND_OF_THE_INFERNO, rate:0.01 }, { id:I.BREATHING_REED, rate:0.01 }, { id:I.CACTUS_SWORD, rate:0.01 }, { id:I.CLASSY_CANE, rate:0.01 }, { id:I.EBONWOOD_SWORD, rate:0.01 }, { id:I.EXOTIC_SCIMITAR, rate:0.01 }, { id:I.FLYMEAL, rate:0.01 }, { id:I.GOLD_BROADSWORD, rate:0.01 }, { id:I.HAM_BAT, rate:0.01 }, { id:I.ICE_BLADE, rate:0.01 }, { id:I.LEAD_BROADSWORD, rate:0.01 }, { id:I.MANDIBLE_BLADE, rate:0.01 }, { id:I.ORANGE_PHASEBLADE, rate:0.01 }, { id:I.PALM_WOOD_SWORD, rate:0.01 }, { id:I.PEARLWOOD_SWORD, rate:0.01 }, { id:I.PINK_PHASEBLADE, rate:0.01 }, { id:I.PLATINUM_BROADSWORD, rate:0.01 }, { id:I.PURPLE_CLUBBERFISH, rate:0.01 }, { id:I.RAINBOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASEBLADE, rate:0.01 }, { id:I.RICH_MAHOGANY_SWORD, rate:0.01 }, { id:I.SHADEWOOD_SWORD, rate:0.01 }, { id:I.SHIELD_OF_CTHULHU, rate:0.01 }, { id:I.SICKLE, rate:0.01 }, { id:I.SILVER_BROADSWORD, rate:0.01 }, { id:I.STYLISH_SCISSORS, rate:0.01 }, { id:I.TRAGIC_UMBRELLA, rate:0.01 }, { id:I.TUNGSTEN_BROADSWORD, rate:0.01 }, { id:I.WAFFLES_IRON, rate:0.01 }, { id:I.WHITE_PHASEBLADE, rate:0.01 }, { id:I.YELLOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASESABER, rate:0.01 }, { id:I.WHITE_PHASESABER, rate:0.01 }, { id:I.YELLOW_PHASESABER, rate:0.01 }, { id:I.ORANGE_PHASESABER, rate:0.01 }, { id:I.PINK_PHASESABER, rate:0.01 }, { id:I.RAINBOW_PHASESABER, rate:0.01 }, { id:I.BONE_PICKAXE, rate:0.01 }, { id:I.CACTUS_PICKAXE, rate:0.01 }, { id:I.CANDY_CANE_PICKAXE, rate:0.01 }, { id:I.FOSSIL_PICKAXE, rate:0.01 }, { id:I.ORICHALCUM_PICKAXE, rate:0.01 }, { id:I.REAVER_SHARK, rate:0.01 }, { id:I.ASH_WOOD_HAMMER, rate:0.01 }, { id:I.BOREAL_WOOD_HAMMER, rate:0.01 }, { id:I.EBONWOOD_HAMMER, rate:0.01 }, { id:I.FLESH_GRINDER, rate:0.01 }, { id:I.GOLD_HAMMER, rate:0.01 }, { id:I.LEAD_HAMMER, rate:0.01 }, { id:I.PALM_WOOD_HAMMER, rate:0.01 }, { id:I.PEARLWOOD_HAMMER, rate:0.01 }, { id:I.PLATINUM_HAMMER, rate:0.01 }, { id:I.RICH_MAHOGANY_HAMMER, rate:0.01 }, { id:I.SHADEWOOD_HAMMER, rate:0.01 }, { id:I.SILVER_HAMMER, rate:0.01 }, { id:I.TUNGSTEN_HAMMER, rate:0.01 }, { id:I.WOODEN_HAMMER, rate:0.01 }, { id:I.ADAMANTITE_WARAXE, rate:0.01 }, { id:I.AXE_OF_REGROWTH, rate:0.01 }, { id:I.BLOOD_LUST_CLUSTER, rate:0.01 }, { id:I.COBALT_WARAXE, rate:0.01 }, { id:I.GOLD_AXE, rate:0.01 }, { id:I.LEAD_AXE, rate:0.01 }, { id:I.METEOR_HAMAXE, rate:0.01 }, { id:I.MOLTEN_HAMAXE, rate:0.01 }, { id:I.MYTHRIL_WARAXE, rate:0.01 }, { id:I.ORICHALCUM_WARAXE, rate:0.01 }, { id:I.PLATINUM_AXE, rate:0.01 }, { id:I.SILVER_AXE, rate:0.01 }, { id:I.TITANIUM_WARAXE, rate:0.01 }, { id:I.TUNGSTEN_AXE, rate:0.01 }, { id:I.WAR_AXE_OF_THE_NIGHT, rate:0.01 }, { id:I.ADAMANTITE_REPEATER, rate:0.01 }, { id:I.ASH_WOOD_BOW, rate:0.01 }, { id:I.BLOOD_RAIN_BOW, rate:0.01 }, { id:I.BLOWGUN, rate:0.01 }, { id:I.BLOWPIPE, rate:0.01 }, { id:I.BOREAL_WOOD_BOW, rate:0.01 }, { id:I.COBALT_REPEATER, rate:0.01 }, { id:I.DEMON_BOW, rate:0.01 }, { id:I.EBONWOOD_BOW, rate:0.01 }, { id:I.LEAD_BOW, rate:0.01 }, { id:I.MYTHRIL_REPEATER, rate:0.01 }, { id:I.ORICHALCUM_REPEATER, rate:0.01 }, { id:I.PALM_WOOD_BOW, rate:0.01 }, { id:I.PEARLWOOD_BOW, rate:0.01 }, { id:I.PLATINUM_BOW, rate:0.01 }, { id:I.RICH_MAHOGANY_BOW, rate:0.01 }, { id:I.SHADEWOOD_BOW, rate:0.01 }, { id:I.SKULL_BOW, rate:0.01 }, { id:I.TENDON_BOW, rate:0.01 }, { id:I.TITANIUM_REPEATER, rate:0.01 }, { id:I.TUNGSTEN_BOW, rate:0.01 }, { id:I.WOODEN_BOW, rate:0.01 }, { id:I.ALE_TOSSER, rate:0.01 }, { id:I.BEENADE, rate:0.01 }, { id:I.BLUE_FLARE, rate:0.01 }, { id:I.BOUNCY_GRENADE, rate:0.01 }, { id:I.CANDY_CORN, rate:0.01 }, { id:I.CHLOROPHYTE_ARROW, rate:0.01 }, { id:I.CLUSTER_ROCKET_I, rate:0.01 }, { id:I.CLUSTER_ROCKET_I_I, rate:0.01 }, { id:I.CURSED_ARROW, rate:0.01 }, { id:I.CURSED_FLARE, rate:0.01 }, { id:I.DRY_ROCKET, rate:0.01 }, { id:I.EXPLOSIVE_JACK_O_LANTERN, rate:0.01 }, { id:I.FLAMING_ARROW, rate:0.01 }, { id:I.FLARE, rate:0.01 }, { id:I.HAPPY_GRENADE, rate:0.01 }, { id:I.HONEY_ROCKET, rate:0.01 }, { id:I.ICHOR_ARROW, rate:0.01 }, { id:I.LAVA_ROCKET, rate:0.01 }, { id:I.LUMINITE_ARROW, rate:0.01 }, { id:I.MOLOTOV_COCKTAIL, rate:0.01 }, { id:I.NAIL, rate:0.01 }, { id:I.POISON_DART, rate:0.01 }, { id:I.RAINBOW_FLARE, rate:0.01 }, { id:I.ROTTEN_EGG, rate:0.01 }, { id:I.SEED, rate:0.01 }, { id:I.SHIMMER_ARROW, rate:0.01 }, { id:I.SHIMMER_FLARE, rate:0.01 }, { id:I.SNOWBALL, rate:0.01 }, { id:I.SNOWBALL_CANNON, rate:0.01 }, { id:I.SPELUNKER_FLARE, rate:0.01 }, { id:I.STAKE, rate:0.01 }, { id:I.STAR_ANISE, rate:0.01 }, { id:I.STICKY_GRENADE, rate:0.01 }, { id:I.VENOM_ARROW, rate:0.01 }, { id:I.WET_ROCKET, rate:0.01 }, { id:I.AMETHYST_STAFF, rate:0.01 }, { id:I.ARC_SURGE, rate:0.01 }, { id:I.BEJEWELED_STAFF, rate:0.01 }, { id:I.BOOK_OF_SKULLS, rate:0.01 }, { id:I.DAYBLOOM_STAFF, rate:0.01 }, { id:I.DIAMOND_STAFF, rate:0.01 }, { id:I.EMERALD_STAFF, rate:0.01 }, { id:I.GLACIER_FANG, rate:0.01 }, { id:I.GRAY_ZAPINATOR, rate:0.01 }, { id:I.LIGHTNING_STRIKE, rate:0.01 }, { id:I.MAGIC_MISSILE, rate:0.01 }, { id:I.METEOR_STAFF, rate:0.01 }, { id:I.MYSTIC_BLOOM, rate:0.01 }, { id:I.RUBY_STAFF, rate:0.01 }, { id:I.SAPPHIRE_STAFF, rate:0.01 }, { id:I.THUNDER_ZAPPER, rate:0.01 }, { id:I.TOME_OF_INFINITE_WISDOM, rate:0.01 }, { id:I.TOPAZ_STAFF, rate:0.01 }, { id:I.WAND_OF_SPARKING, rate:0.01 }, { id:I.BALLISTA_ROD, rate:0.01 }, { id:I.CATTIVA, rate:0.01 }, { id:I.CLAY_BUD_STAFF, rate:0.01 }, { id:I.COBWHIP, rate:0.01 }, { id:I.EXPLOSIVE_TRAP_ROD, rate:0.01 }, { id:I.FINCH_STAFF, rate:0.01 }, { id:I.FLAMEBURST_ROD, rate:0.01 }, { id:I.FOXPARKS, rate:0.01 }, { id:I.HOUNDIUS_SHOOTIUS, rate:0.01 }, { id:I.LIGHTNING_AURA_ROD, rate:0.01 }, { id:I.MUSHROOM_STAFF, rate:0.01 }, { id:I.RUINOUS_STAFF, rate:0.01 }, { id:I.SLIME_STAFF, rate:0.01 }, { id:I.SLIME_WHIP, rate:0.01 }, { id:I.SOULSCOURGE, rate:0.01 }, { id:I.SPINAL_TAP, rate:0.01 }, { id:I.STARCRASH, rate:0.01 }, { id:I.TRUSTY_CATTIVA, rate:0.01 }, { id:I.TRUSTY_FOXPARKS, rate:0.01 }, { id:I.VAMPIRE_FROG_STAFF, rate:0.01 }, { id:I.VASCULASH, rate:0.01 }, { id:I.TENTACLE_SPIKE, rate:0.01 }];
B83_ENEMY_DROPS['Undead Miner'] = [{ id:I.ASH_WOOD_SWORD, rate:0.01 }, { id:I.BAT_BAT, rate:0.01 }, { id:I.BLADED_GLOVE, rate:0.01 }, { id:I.BOREAL_WOOD_SWORD, rate:0.01 }, { id:I.BRAND_OF_THE_INFERNO, rate:0.01 }, { id:I.BREATHING_REED, rate:0.01 }, { id:I.CACTUS_SWORD, rate:0.01 }, { id:I.CLASSY_CANE, rate:0.01 }, { id:I.EBONWOOD_SWORD, rate:0.01 }, { id:I.EXOTIC_SCIMITAR, rate:0.01 }, { id:I.FLYMEAL, rate:0.01 }, { id:I.GOLD_BROADSWORD, rate:0.01 }, { id:I.HAM_BAT, rate:0.01 }, { id:I.ICE_BLADE, rate:0.01 }, { id:I.LEAD_BROADSWORD, rate:0.01 }, { id:I.MANDIBLE_BLADE, rate:0.01 }, { id:I.ORANGE_PHASEBLADE, rate:0.01 }, { id:I.PALM_WOOD_SWORD, rate:0.01 }, { id:I.PEARLWOOD_SWORD, rate:0.01 }, { id:I.PINK_PHASEBLADE, rate:0.01 }, { id:I.PLATINUM_BROADSWORD, rate:0.01 }, { id:I.PURPLE_CLUBBERFISH, rate:0.01 }, { id:I.RAINBOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASEBLADE, rate:0.01 }, { id:I.RICH_MAHOGANY_SWORD, rate:0.01 }, { id:I.SHADEWOOD_SWORD, rate:0.01 }, { id:I.SHIELD_OF_CTHULHU, rate:0.01 }, { id:I.SICKLE, rate:0.01 }, { id:I.SILVER_BROADSWORD, rate:0.01 }, { id:I.STYLISH_SCISSORS, rate:0.01 }, { id:I.TRAGIC_UMBRELLA, rate:0.01 }, { id:I.TUNGSTEN_BROADSWORD, rate:0.01 }, { id:I.WAFFLES_IRON, rate:0.01 }, { id:I.WHITE_PHASEBLADE, rate:0.01 }, { id:I.YELLOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASESABER, rate:0.01 }, { id:I.WHITE_PHASESABER, rate:0.01 }, { id:I.YELLOW_PHASESABER, rate:0.01 }, { id:I.ORANGE_PHASESABER, rate:0.01 }, { id:I.PINK_PHASESABER, rate:0.01 }, { id:I.RAINBOW_PHASESABER, rate:0.01 }, { id:I.BONE_PICKAXE, rate:0.01 }, { id:I.CACTUS_PICKAXE, rate:0.01 }, { id:I.CANDY_CANE_PICKAXE, rate:0.01 }, { id:I.FOSSIL_PICKAXE, rate:0.01 }, { id:I.ORICHALCUM_PICKAXE, rate:0.01 }, { id:I.REAVER_SHARK, rate:0.01 }, { id:I.ASH_WOOD_HAMMER, rate:0.01 }, { id:I.BOREAL_WOOD_HAMMER, rate:0.01 }, { id:I.EBONWOOD_HAMMER, rate:0.01 }, { id:I.FLESH_GRINDER, rate:0.01 }, { id:I.GOLD_HAMMER, rate:0.01 }, { id:I.LEAD_HAMMER, rate:0.01 }, { id:I.PALM_WOOD_HAMMER, rate:0.01 }, { id:I.PEARLWOOD_HAMMER, rate:0.01 }, { id:I.PLATINUM_HAMMER, rate:0.01 }, { id:I.RICH_MAHOGANY_HAMMER, rate:0.01 }, { id:I.SHADEWOOD_HAMMER, rate:0.01 }, { id:I.SILVER_HAMMER, rate:0.01 }, { id:I.TUNGSTEN_HAMMER, rate:0.01 }, { id:I.WOODEN_HAMMER, rate:0.01 }, { id:I.ADAMANTITE_WARAXE, rate:0.01 }, { id:I.AXE_OF_REGROWTH, rate:0.01 }, { id:I.BLOOD_LUST_CLUSTER, rate:0.01 }, { id:I.COBALT_WARAXE, rate:0.01 }, { id:I.GOLD_AXE, rate:0.01 }, { id:I.LEAD_AXE, rate:0.01 }, { id:I.METEOR_HAMAXE, rate:0.01 }, { id:I.MOLTEN_HAMAXE, rate:0.01 }, { id:I.MYTHRIL_WARAXE, rate:0.01 }, { id:I.ORICHALCUM_WARAXE, rate:0.01 }, { id:I.PLATINUM_AXE, rate:0.01 }, { id:I.SILVER_AXE, rate:0.01 }, { id:I.TITANIUM_WARAXE, rate:0.01 }, { id:I.TUNGSTEN_AXE, rate:0.01 }, { id:I.WAR_AXE_OF_THE_NIGHT, rate:0.01 }, { id:I.ADAMANTITE_REPEATER, rate:0.01 }, { id:I.ASH_WOOD_BOW, rate:0.01 }, { id:I.BLOOD_RAIN_BOW, rate:0.01 }, { id:I.BLOWGUN, rate:0.01 }, { id:I.BLOWPIPE, rate:0.01 }, { id:I.BOREAL_WOOD_BOW, rate:0.01 }, { id:I.COBALT_REPEATER, rate:0.01 }, { id:I.DEMON_BOW, rate:0.01 }, { id:I.EBONWOOD_BOW, rate:0.01 }, { id:I.LEAD_BOW, rate:0.01 }, { id:I.MYTHRIL_REPEATER, rate:0.01 }, { id:I.ORICHALCUM_REPEATER, rate:0.01 }, { id:I.PALM_WOOD_BOW, rate:0.01 }, { id:I.PEARLWOOD_BOW, rate:0.01 }, { id:I.PLATINUM_BOW, rate:0.01 }, { id:I.RICH_MAHOGANY_BOW, rate:0.01 }, { id:I.SHADEWOOD_BOW, rate:0.01 }, { id:I.SKULL_BOW, rate:0.01 }, { id:I.TENDON_BOW, rate:0.01 }, { id:I.TITANIUM_REPEATER, rate:0.01 }, { id:I.TUNGSTEN_BOW, rate:0.01 }, { id:I.WOODEN_BOW, rate:0.01 }, { id:I.ALE_TOSSER, rate:0.01 }, { id:I.BEENADE, rate:0.01 }, { id:I.BLUE_FLARE, rate:0.01 }, { id:I.BOUNCY_GRENADE, rate:0.01 }, { id:I.CANDY_CORN, rate:0.01 }, { id:I.CHLOROPHYTE_ARROW, rate:0.01 }, { id:I.CLUSTER_ROCKET_I, rate:0.01 }, { id:I.CLUSTER_ROCKET_I_I, rate:0.01 }, { id:I.CURSED_ARROW, rate:0.01 }, { id:I.CURSED_FLARE, rate:0.01 }, { id:I.DRY_ROCKET, rate:0.01 }, { id:I.EXPLOSIVE_JACK_O_LANTERN, rate:0.01 }, { id:I.FLAMING_ARROW, rate:0.01 }, { id:I.FLARE, rate:0.01 }, { id:I.HAPPY_GRENADE, rate:0.01 }, { id:I.HONEY_ROCKET, rate:0.01 }, { id:I.ICHOR_ARROW, rate:0.01 }, { id:I.LAVA_ROCKET, rate:0.01 }, { id:I.LUMINITE_ARROW, rate:0.01 }, { id:I.MOLOTOV_COCKTAIL, rate:0.01 }, { id:I.NAIL, rate:0.01 }, { id:I.POISON_DART, rate:0.01 }, { id:I.RAINBOW_FLARE, rate:0.01 }, { id:I.ROTTEN_EGG, rate:0.01 }, { id:I.SEED, rate:0.01 }, { id:I.SHIMMER_ARROW, rate:0.01 }, { id:I.SHIMMER_FLARE, rate:0.01 }, { id:I.SNOWBALL, rate:0.01 }, { id:I.SNOWBALL_CANNON, rate:0.01 }, { id:I.SPELUNKER_FLARE, rate:0.01 }, { id:I.STAKE, rate:0.01 }, { id:I.STAR_ANISE, rate:0.01 }, { id:I.STICKY_GRENADE, rate:0.01 }, { id:I.VENOM_ARROW, rate:0.01 }, { id:I.WET_ROCKET, rate:0.01 }, { id:I.AMETHYST_STAFF, rate:0.01 }, { id:I.ARC_SURGE, rate:0.01 }, { id:I.BEJEWELED_STAFF, rate:0.01 }, { id:I.BOOK_OF_SKULLS, rate:0.01 }, { id:I.DAYBLOOM_STAFF, rate:0.01 }, { id:I.DIAMOND_STAFF, rate:0.01 }, { id:I.EMERALD_STAFF, rate:0.01 }, { id:I.GLACIER_FANG, rate:0.01 }, { id:I.GRAY_ZAPINATOR, rate:0.01 }, { id:I.LIGHTNING_STRIKE, rate:0.01 }, { id:I.MAGIC_MISSILE, rate:0.01 }, { id:I.METEOR_STAFF, rate:0.01 }, { id:I.MYSTIC_BLOOM, rate:0.01 }, { id:I.RUBY_STAFF, rate:0.01 }, { id:I.SAPPHIRE_STAFF, rate:0.01 }, { id:I.THUNDER_ZAPPER, rate:0.01 }, { id:I.TOME_OF_INFINITE_WISDOM, rate:0.01 }, { id:I.TOPAZ_STAFF, rate:0.01 }, { id:I.WAND_OF_SPARKING, rate:0.01 }, { id:I.BALLISTA_ROD, rate:0.01 }, { id:I.CATTIVA, rate:0.01 }, { id:I.CLAY_BUD_STAFF, rate:0.01 }, { id:I.COBWHIP, rate:0.01 }, { id:I.EXPLOSIVE_TRAP_ROD, rate:0.01 }, { id:I.FINCH_STAFF, rate:0.01 }, { id:I.FLAMEBURST_ROD, rate:0.01 }, { id:I.FOXPARKS, rate:0.01 }, { id:I.HOUNDIUS_SHOOTIUS, rate:0.01 }, { id:I.LIGHTNING_AURA_ROD, rate:0.01 }, { id:I.MUSHROOM_STAFF, rate:0.01 }, { id:I.RUINOUS_STAFF, rate:0.01 }, { id:I.SLIME_STAFF, rate:0.01 }, { id:I.SLIME_WHIP, rate:0.01 }, { id:I.SOULSCOURGE, rate:0.01 }, { id:I.SPINAL_TAP, rate:0.01 }, { id:I.STARCRASH, rate:0.01 }, { id:I.TRUSTY_CATTIVA, rate:0.01 }, { id:I.TRUSTY_FOXPARKS, rate:0.01 }, { id:I.VAMPIRE_FROG_STAFF, rate:0.01 }, { id:I.VASCULASH, rate:0.01 }, { id:I.TENTACLE_SPIKE, rate:0.01 }];
B83_ENEMY_DROPS['Salamander'] = [{ id:I.ASH_WOOD_SWORD, rate:0.01 }, { id:I.BAT_BAT, rate:0.01 }, { id:I.BLADED_GLOVE, rate:0.01 }, { id:I.BOREAL_WOOD_SWORD, rate:0.01 }, { id:I.BRAND_OF_THE_INFERNO, rate:0.01 }, { id:I.BREATHING_REED, rate:0.01 }, { id:I.CACTUS_SWORD, rate:0.01 }, { id:I.CLASSY_CANE, rate:0.01 }, { id:I.EBONWOOD_SWORD, rate:0.01 }, { id:I.EXOTIC_SCIMITAR, rate:0.01 }, { id:I.FLYMEAL, rate:0.01 }, { id:I.GOLD_BROADSWORD, rate:0.01 }, { id:I.HAM_BAT, rate:0.01 }, { id:I.ICE_BLADE, rate:0.01 }, { id:I.LEAD_BROADSWORD, rate:0.01 }, { id:I.MANDIBLE_BLADE, rate:0.01 }, { id:I.ORANGE_PHASEBLADE, rate:0.01 }, { id:I.PALM_WOOD_SWORD, rate:0.01 }, { id:I.PEARLWOOD_SWORD, rate:0.01 }, { id:I.PINK_PHASEBLADE, rate:0.01 }, { id:I.PLATINUM_BROADSWORD, rate:0.01 }, { id:I.PURPLE_CLUBBERFISH, rate:0.01 }, { id:I.RAINBOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASEBLADE, rate:0.01 }, { id:I.RICH_MAHOGANY_SWORD, rate:0.01 }, { id:I.SHADEWOOD_SWORD, rate:0.01 }, { id:I.SHIELD_OF_CTHULHU, rate:0.01 }, { id:I.SICKLE, rate:0.01 }, { id:I.SILVER_BROADSWORD, rate:0.01 }, { id:I.STYLISH_SCISSORS, rate:0.01 }, { id:I.TRAGIC_UMBRELLA, rate:0.01 }, { id:I.TUNGSTEN_BROADSWORD, rate:0.01 }, { id:I.WAFFLES_IRON, rate:0.01 }, { id:I.WHITE_PHASEBLADE, rate:0.01 }, { id:I.YELLOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASESABER, rate:0.01 }, { id:I.WHITE_PHASESABER, rate:0.01 }, { id:I.YELLOW_PHASESABER, rate:0.01 }, { id:I.ORANGE_PHASESABER, rate:0.01 }, { id:I.PINK_PHASESABER, rate:0.01 }, { id:I.RAINBOW_PHASESABER, rate:0.01 }, { id:I.BONE_PICKAXE, rate:0.01 }, { id:I.CACTUS_PICKAXE, rate:0.01 }, { id:I.CANDY_CANE_PICKAXE, rate:0.01 }, { id:I.FOSSIL_PICKAXE, rate:0.01 }, { id:I.ORICHALCUM_PICKAXE, rate:0.01 }, { id:I.REAVER_SHARK, rate:0.01 }, { id:I.ASH_WOOD_HAMMER, rate:0.01 }, { id:I.BOREAL_WOOD_HAMMER, rate:0.01 }, { id:I.EBONWOOD_HAMMER, rate:0.01 }, { id:I.FLESH_GRINDER, rate:0.01 }, { id:I.GOLD_HAMMER, rate:0.01 }, { id:I.LEAD_HAMMER, rate:0.01 }, { id:I.PALM_WOOD_HAMMER, rate:0.01 }, { id:I.PEARLWOOD_HAMMER, rate:0.01 }, { id:I.PLATINUM_HAMMER, rate:0.01 }, { id:I.RICH_MAHOGANY_HAMMER, rate:0.01 }, { id:I.SHADEWOOD_HAMMER, rate:0.01 }, { id:I.SILVER_HAMMER, rate:0.01 }, { id:I.TUNGSTEN_HAMMER, rate:0.01 }, { id:I.WOODEN_HAMMER, rate:0.01 }, { id:I.ADAMANTITE_WARAXE, rate:0.01 }, { id:I.AXE_OF_REGROWTH, rate:0.01 }, { id:I.BLOOD_LUST_CLUSTER, rate:0.01 }, { id:I.COBALT_WARAXE, rate:0.01 }, { id:I.GOLD_AXE, rate:0.01 }, { id:I.LEAD_AXE, rate:0.01 }, { id:I.METEOR_HAMAXE, rate:0.01 }, { id:I.MOLTEN_HAMAXE, rate:0.01 }, { id:I.MYTHRIL_WARAXE, rate:0.01 }, { id:I.ORICHALCUM_WARAXE, rate:0.01 }, { id:I.PLATINUM_AXE, rate:0.01 }, { id:I.SILVER_AXE, rate:0.01 }, { id:I.TITANIUM_WARAXE, rate:0.01 }, { id:I.TUNGSTEN_AXE, rate:0.01 }, { id:I.WAR_AXE_OF_THE_NIGHT, rate:0.01 }, { id:I.ADAMANTITE_REPEATER, rate:0.01 }, { id:I.ASH_WOOD_BOW, rate:0.01 }, { id:I.BLOOD_RAIN_BOW, rate:0.01 }, { id:I.BLOWGUN, rate:0.01 }, { id:I.BLOWPIPE, rate:0.01 }, { id:I.BOREAL_WOOD_BOW, rate:0.01 }, { id:I.COBALT_REPEATER, rate:0.01 }, { id:I.DEMON_BOW, rate:0.01 }, { id:I.EBONWOOD_BOW, rate:0.01 }, { id:I.LEAD_BOW, rate:0.01 }, { id:I.MYTHRIL_REPEATER, rate:0.01 }, { id:I.ORICHALCUM_REPEATER, rate:0.01 }, { id:I.PALM_WOOD_BOW, rate:0.01 }, { id:I.PEARLWOOD_BOW, rate:0.01 }, { id:I.PLATINUM_BOW, rate:0.01 }, { id:I.RICH_MAHOGANY_BOW, rate:0.01 }, { id:I.SHADEWOOD_BOW, rate:0.01 }, { id:I.SKULL_BOW, rate:0.01 }, { id:I.TENDON_BOW, rate:0.01 }, { id:I.TITANIUM_REPEATER, rate:0.01 }, { id:I.TUNGSTEN_BOW, rate:0.01 }, { id:I.WOODEN_BOW, rate:0.01 }, { id:I.ALE_TOSSER, rate:0.01 }, { id:I.BEENADE, rate:0.01 }, { id:I.BLUE_FLARE, rate:0.01 }, { id:I.BOUNCY_GRENADE, rate:0.01 }, { id:I.CANDY_CORN, rate:0.01 }, { id:I.CHLOROPHYTE_ARROW, rate:0.01 }, { id:I.CLUSTER_ROCKET_I, rate:0.01 }, { id:I.CLUSTER_ROCKET_I_I, rate:0.01 }, { id:I.CURSED_ARROW, rate:0.01 }, { id:I.CURSED_FLARE, rate:0.01 }, { id:I.DRY_ROCKET, rate:0.01 }, { id:I.EXPLOSIVE_JACK_O_LANTERN, rate:0.01 }, { id:I.FLAMING_ARROW, rate:0.01 }, { id:I.FLARE, rate:0.01 }, { id:I.HAPPY_GRENADE, rate:0.01 }, { id:I.HONEY_ROCKET, rate:0.01 }, { id:I.ICHOR_ARROW, rate:0.01 }, { id:I.LAVA_ROCKET, rate:0.01 }, { id:I.LUMINITE_ARROW, rate:0.01 }, { id:I.MOLOTOV_COCKTAIL, rate:0.01 }, { id:I.NAIL, rate:0.01 }, { id:I.POISON_DART, rate:0.01 }, { id:I.RAINBOW_FLARE, rate:0.01 }, { id:I.ROTTEN_EGG, rate:0.01 }, { id:I.SEED, rate:0.01 }, { id:I.SHIMMER_ARROW, rate:0.01 }, { id:I.SHIMMER_FLARE, rate:0.01 }, { id:I.SNOWBALL, rate:0.01 }, { id:I.SNOWBALL_CANNON, rate:0.01 }, { id:I.SPELUNKER_FLARE, rate:0.01 }, { id:I.STAKE, rate:0.01 }, { id:I.STAR_ANISE, rate:0.01 }, { id:I.STICKY_GRENADE, rate:0.01 }, { id:I.VENOM_ARROW, rate:0.01 }, { id:I.WET_ROCKET, rate:0.01 }, { id:I.AMETHYST_STAFF, rate:0.01 }, { id:I.ARC_SURGE, rate:0.01 }, { id:I.BEJEWELED_STAFF, rate:0.01 }, { id:I.BOOK_OF_SKULLS, rate:0.01 }, { id:I.DAYBLOOM_STAFF, rate:0.01 }, { id:I.DIAMOND_STAFF, rate:0.01 }, { id:I.EMERALD_STAFF, rate:0.01 }, { id:I.GLACIER_FANG, rate:0.01 }, { id:I.GRAY_ZAPINATOR, rate:0.01 }, { id:I.LIGHTNING_STRIKE, rate:0.01 }, { id:I.MAGIC_MISSILE, rate:0.01 }, { id:I.METEOR_STAFF, rate:0.01 }, { id:I.MYSTIC_BLOOM, rate:0.01 }, { id:I.RUBY_STAFF, rate:0.01 }, { id:I.SAPPHIRE_STAFF, rate:0.01 }, { id:I.THUNDER_ZAPPER, rate:0.01 }, { id:I.TOME_OF_INFINITE_WISDOM, rate:0.01 }, { id:I.TOPAZ_STAFF, rate:0.01 }, { id:I.WAND_OF_SPARKING, rate:0.01 }, { id:I.BALLISTA_ROD, rate:0.01 }, { id:I.CATTIVA, rate:0.01 }, { id:I.CLAY_BUD_STAFF, rate:0.01 }, { id:I.COBWHIP, rate:0.01 }, { id:I.EXPLOSIVE_TRAP_ROD, rate:0.01 }, { id:I.FINCH_STAFF, rate:0.01 }, { id:I.FLAMEBURST_ROD, rate:0.01 }, { id:I.FOXPARKS, rate:0.01 }, { id:I.HOUNDIUS_SHOOTIUS, rate:0.01 }, { id:I.LIGHTNING_AURA_ROD, rate:0.01 }, { id:I.MUSHROOM_STAFF, rate:0.01 }, { id:I.RUINOUS_STAFF, rate:0.01 }, { id:I.SLIME_STAFF, rate:0.01 }, { id:I.SLIME_WHIP, rate:0.01 }, { id:I.SOULSCOURGE, rate:0.01 }, { id:I.SPINAL_TAP, rate:0.01 }, { id:I.STARCRASH, rate:0.01 }, { id:I.TRUSTY_CATTIVA, rate:0.01 }, { id:I.TRUSTY_FOXPARKS, rate:0.01 }, { id:I.VAMPIRE_FROG_STAFF, rate:0.01 }, { id:I.VASCULASH, rate:0.01 }, { id:I.TENTACLE_SPIKE, rate:0.01 }];
B83_ENEMY_DROPS['Angry Bones'] = [{ id:I.ASH_WOOD_SWORD, rate:0.01 }, { id:I.BAT_BAT, rate:0.01 }, { id:I.BLADED_GLOVE, rate:0.01 }, { id:I.BOREAL_WOOD_SWORD, rate:0.01 }, { id:I.BRAND_OF_THE_INFERNO, rate:0.01 }, { id:I.BREATHING_REED, rate:0.01 }, { id:I.CACTUS_SWORD, rate:0.01 }, { id:I.CLASSY_CANE, rate:0.01 }, { id:I.EBONWOOD_SWORD, rate:0.01 }, { id:I.EXOTIC_SCIMITAR, rate:0.01 }, { id:I.FLYMEAL, rate:0.01 }, { id:I.GOLD_BROADSWORD, rate:0.01 }, { id:I.HAM_BAT, rate:0.01 }, { id:I.ICE_BLADE, rate:0.01 }, { id:I.LEAD_BROADSWORD, rate:0.01 }, { id:I.MANDIBLE_BLADE, rate:0.01 }, { id:I.ORANGE_PHASEBLADE, rate:0.01 }, { id:I.PALM_WOOD_SWORD, rate:0.01 }, { id:I.PEARLWOOD_SWORD, rate:0.01 }, { id:I.PINK_PHASEBLADE, rate:0.01 }, { id:I.PLATINUM_BROADSWORD, rate:0.01 }, { id:I.PURPLE_CLUBBERFISH, rate:0.01 }, { id:I.RAINBOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASEBLADE, rate:0.01 }, { id:I.RICH_MAHOGANY_SWORD, rate:0.01 }, { id:I.SHADEWOOD_SWORD, rate:0.01 }, { id:I.SHIELD_OF_CTHULHU, rate:0.01 }, { id:I.SICKLE, rate:0.01 }, { id:I.SILVER_BROADSWORD, rate:0.01 }, { id:I.STYLISH_SCISSORS, rate:0.01 }, { id:I.TRAGIC_UMBRELLA, rate:0.01 }, { id:I.TUNGSTEN_BROADSWORD, rate:0.01 }, { id:I.WAFFLES_IRON, rate:0.01 }, { id:I.WHITE_PHASEBLADE, rate:0.01 }, { id:I.YELLOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASESABER, rate:0.01 }, { id:I.WHITE_PHASESABER, rate:0.01 }, { id:I.YELLOW_PHASESABER, rate:0.01 }, { id:I.ORANGE_PHASESABER, rate:0.01 }, { id:I.PINK_PHASESABER, rate:0.01 }, { id:I.RAINBOW_PHASESABER, rate:0.01 }, { id:I.BONE_PICKAXE, rate:0.01 }, { id:I.CACTUS_PICKAXE, rate:0.01 }, { id:I.CANDY_CANE_PICKAXE, rate:0.01 }, { id:I.FOSSIL_PICKAXE, rate:0.01 }, { id:I.ORICHALCUM_PICKAXE, rate:0.01 }, { id:I.REAVER_SHARK, rate:0.01 }, { id:I.ASH_WOOD_HAMMER, rate:0.01 }, { id:I.BOREAL_WOOD_HAMMER, rate:0.01 }, { id:I.EBONWOOD_HAMMER, rate:0.01 }, { id:I.FLESH_GRINDER, rate:0.01 }, { id:I.GOLD_HAMMER, rate:0.01 }, { id:I.LEAD_HAMMER, rate:0.01 }, { id:I.PALM_WOOD_HAMMER, rate:0.01 }, { id:I.PEARLWOOD_HAMMER, rate:0.01 }, { id:I.PLATINUM_HAMMER, rate:0.01 }, { id:I.RICH_MAHOGANY_HAMMER, rate:0.01 }, { id:I.SHADEWOOD_HAMMER, rate:0.01 }, { id:I.SILVER_HAMMER, rate:0.01 }, { id:I.TUNGSTEN_HAMMER, rate:0.01 }, { id:I.WOODEN_HAMMER, rate:0.01 }, { id:I.ADAMANTITE_WARAXE, rate:0.01 }, { id:I.AXE_OF_REGROWTH, rate:0.01 }, { id:I.BLOOD_LUST_CLUSTER, rate:0.01 }, { id:I.COBALT_WARAXE, rate:0.01 }, { id:I.GOLD_AXE, rate:0.01 }, { id:I.LEAD_AXE, rate:0.01 }, { id:I.METEOR_HAMAXE, rate:0.01 }, { id:I.MOLTEN_HAMAXE, rate:0.01 }, { id:I.MYTHRIL_WARAXE, rate:0.01 }, { id:I.ORICHALCUM_WARAXE, rate:0.01 }, { id:I.PLATINUM_AXE, rate:0.01 }, { id:I.SILVER_AXE, rate:0.01 }, { id:I.TITANIUM_WARAXE, rate:0.01 }, { id:I.TUNGSTEN_AXE, rate:0.01 }, { id:I.WAR_AXE_OF_THE_NIGHT, rate:0.01 }, { id:I.ADAMANTITE_REPEATER, rate:0.01 }, { id:I.ASH_WOOD_BOW, rate:0.01 }, { id:I.BLOOD_RAIN_BOW, rate:0.01 }, { id:I.BLOWGUN, rate:0.01 }, { id:I.BLOWPIPE, rate:0.01 }, { id:I.BOREAL_WOOD_BOW, rate:0.01 }, { id:I.COBALT_REPEATER, rate:0.01 }, { id:I.DEMON_BOW, rate:0.01 }, { id:I.EBONWOOD_BOW, rate:0.01 }, { id:I.LEAD_BOW, rate:0.01 }, { id:I.MYTHRIL_REPEATER, rate:0.01 }, { id:I.ORICHALCUM_REPEATER, rate:0.01 }, { id:I.PALM_WOOD_BOW, rate:0.01 }, { id:I.PEARLWOOD_BOW, rate:0.01 }, { id:I.PLATINUM_BOW, rate:0.01 }, { id:I.RICH_MAHOGANY_BOW, rate:0.01 }, { id:I.SHADEWOOD_BOW, rate:0.01 }, { id:I.SKULL_BOW, rate:0.01 }, { id:I.TENDON_BOW, rate:0.01 }, { id:I.TITANIUM_REPEATER, rate:0.01 }, { id:I.TUNGSTEN_BOW, rate:0.01 }, { id:I.WOODEN_BOW, rate:0.01 }, { id:I.ALE_TOSSER, rate:0.01 }, { id:I.BEENADE, rate:0.01 }, { id:I.BLUE_FLARE, rate:0.01 }, { id:I.BOUNCY_GRENADE, rate:0.01 }, { id:I.CANDY_CORN, rate:0.01 }, { id:I.CHLOROPHYTE_ARROW, rate:0.01 }, { id:I.CLUSTER_ROCKET_I, rate:0.01 }, { id:I.CLUSTER_ROCKET_I_I, rate:0.01 }, { id:I.CURSED_ARROW, rate:0.01 }, { id:I.CURSED_FLARE, rate:0.01 }, { id:I.DRY_ROCKET, rate:0.01 }, { id:I.EXPLOSIVE_JACK_O_LANTERN, rate:0.01 }, { id:I.FLAMING_ARROW, rate:0.01 }, { id:I.FLARE, rate:0.01 }, { id:I.HAPPY_GRENADE, rate:0.01 }, { id:I.HONEY_ROCKET, rate:0.01 }, { id:I.ICHOR_ARROW, rate:0.01 }, { id:I.LAVA_ROCKET, rate:0.01 }, { id:I.LUMINITE_ARROW, rate:0.01 }, { id:I.MOLOTOV_COCKTAIL, rate:0.01 }, { id:I.NAIL, rate:0.01 }, { id:I.POISON_DART, rate:0.01 }, { id:I.RAINBOW_FLARE, rate:0.01 }, { id:I.ROTTEN_EGG, rate:0.01 }, { id:I.SEED, rate:0.01 }, { id:I.SHIMMER_ARROW, rate:0.01 }, { id:I.SHIMMER_FLARE, rate:0.01 }, { id:I.SNOWBALL, rate:0.01 }, { id:I.SNOWBALL_CANNON, rate:0.01 }, { id:I.SPELUNKER_FLARE, rate:0.01 }, { id:I.STAKE, rate:0.01 }, { id:I.STAR_ANISE, rate:0.01 }, { id:I.STICKY_GRENADE, rate:0.01 }, { id:I.VENOM_ARROW, rate:0.01 }, { id:I.WET_ROCKET, rate:0.01 }, { id:I.AMETHYST_STAFF, rate:0.01 }, { id:I.ARC_SURGE, rate:0.01 }, { id:I.BEJEWELED_STAFF, rate:0.01 }, { id:I.BOOK_OF_SKULLS, rate:0.01 }, { id:I.DAYBLOOM_STAFF, rate:0.01 }, { id:I.DIAMOND_STAFF, rate:0.01 }, { id:I.EMERALD_STAFF, rate:0.01 }, { id:I.GLACIER_FANG, rate:0.01 }, { id:I.GRAY_ZAPINATOR, rate:0.01 }, { id:I.LIGHTNING_STRIKE, rate:0.01 }, { id:I.MAGIC_MISSILE, rate:0.01 }, { id:I.METEOR_STAFF, rate:0.01 }, { id:I.MYSTIC_BLOOM, rate:0.01 }, { id:I.RUBY_STAFF, rate:0.01 }, { id:I.SAPPHIRE_STAFF, rate:0.01 }, { id:I.THUNDER_ZAPPER, rate:0.01 }, { id:I.TOME_OF_INFINITE_WISDOM, rate:0.01 }, { id:I.TOPAZ_STAFF, rate:0.01 }, { id:I.WAND_OF_SPARKING, rate:0.01 }, { id:I.BALLISTA_ROD, rate:0.01 }, { id:I.CATTIVA, rate:0.01 }, { id:I.CLAY_BUD_STAFF, rate:0.01 }, { id:I.COBWHIP, rate:0.01 }, { id:I.EXPLOSIVE_TRAP_ROD, rate:0.01 }, { id:I.FINCH_STAFF, rate:0.01 }, { id:I.FLAMEBURST_ROD, rate:0.01 }, { id:I.FOXPARKS, rate:0.01 }, { id:I.HOUNDIUS_SHOOTIUS, rate:0.01 }, { id:I.LIGHTNING_AURA_ROD, rate:0.01 }, { id:I.MUSHROOM_STAFF, rate:0.01 }, { id:I.RUINOUS_STAFF, rate:0.01 }, { id:I.SLIME_STAFF, rate:0.01 }, { id:I.SLIME_WHIP, rate:0.01 }, { id:I.SOULSCOURGE, rate:0.01 }, { id:I.SPINAL_TAP, rate:0.01 }, { id:I.STARCRASH, rate:0.01 }, { id:I.TRUSTY_CATTIVA, rate:0.01 }, { id:I.TRUSTY_FOXPARKS, rate:0.01 }, { id:I.VAMPIRE_FROG_STAFF, rate:0.01 }, { id:I.VASCULASH, rate:0.01 }, { id:I.TENTACLE_SPIKE, rate:0.01 }];
B83_ENEMY_DROPS['Cursed Skull'] = [{ id:I.ASH_WOOD_SWORD, rate:0.01 }, { id:I.BAT_BAT, rate:0.01 }, { id:I.BLADED_GLOVE, rate:0.01 }, { id:I.BOREAL_WOOD_SWORD, rate:0.01 }, { id:I.BRAND_OF_THE_INFERNO, rate:0.01 }, { id:I.BREATHING_REED, rate:0.01 }, { id:I.CACTUS_SWORD, rate:0.01 }, { id:I.CLASSY_CANE, rate:0.01 }, { id:I.EBONWOOD_SWORD, rate:0.01 }, { id:I.EXOTIC_SCIMITAR, rate:0.01 }, { id:I.FLYMEAL, rate:0.01 }, { id:I.GOLD_BROADSWORD, rate:0.01 }, { id:I.HAM_BAT, rate:0.01 }, { id:I.ICE_BLADE, rate:0.01 }, { id:I.LEAD_BROADSWORD, rate:0.01 }, { id:I.MANDIBLE_BLADE, rate:0.01 }, { id:I.ORANGE_PHASEBLADE, rate:0.01 }, { id:I.PALM_WOOD_SWORD, rate:0.01 }, { id:I.PEARLWOOD_SWORD, rate:0.01 }, { id:I.PINK_PHASEBLADE, rate:0.01 }, { id:I.PLATINUM_BROADSWORD, rate:0.01 }, { id:I.PURPLE_CLUBBERFISH, rate:0.01 }, { id:I.RAINBOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASEBLADE, rate:0.01 }, { id:I.RICH_MAHOGANY_SWORD, rate:0.01 }, { id:I.SHADEWOOD_SWORD, rate:0.01 }, { id:I.SHIELD_OF_CTHULHU, rate:0.01 }, { id:I.SICKLE, rate:0.01 }, { id:I.SILVER_BROADSWORD, rate:0.01 }, { id:I.STYLISH_SCISSORS, rate:0.01 }, { id:I.TRAGIC_UMBRELLA, rate:0.01 }, { id:I.TUNGSTEN_BROADSWORD, rate:0.01 }, { id:I.WAFFLES_IRON, rate:0.01 }, { id:I.WHITE_PHASEBLADE, rate:0.01 }, { id:I.YELLOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASESABER, rate:0.01 }, { id:I.WHITE_PHASESABER, rate:0.01 }, { id:I.YELLOW_PHASESABER, rate:0.01 }, { id:I.ORANGE_PHASESABER, rate:0.01 }, { id:I.PINK_PHASESABER, rate:0.01 }, { id:I.RAINBOW_PHASESABER, rate:0.01 }, { id:I.BONE_PICKAXE, rate:0.01 }, { id:I.CACTUS_PICKAXE, rate:0.01 }, { id:I.CANDY_CANE_PICKAXE, rate:0.01 }, { id:I.FOSSIL_PICKAXE, rate:0.01 }, { id:I.ORICHALCUM_PICKAXE, rate:0.01 }, { id:I.REAVER_SHARK, rate:0.01 }, { id:I.ASH_WOOD_HAMMER, rate:0.01 }, { id:I.BOREAL_WOOD_HAMMER, rate:0.01 }, { id:I.EBONWOOD_HAMMER, rate:0.01 }, { id:I.FLESH_GRINDER, rate:0.01 }, { id:I.GOLD_HAMMER, rate:0.01 }, { id:I.LEAD_HAMMER, rate:0.01 }, { id:I.PALM_WOOD_HAMMER, rate:0.01 }, { id:I.PEARLWOOD_HAMMER, rate:0.01 }, { id:I.PLATINUM_HAMMER, rate:0.01 }, { id:I.RICH_MAHOGANY_HAMMER, rate:0.01 }, { id:I.SHADEWOOD_HAMMER, rate:0.01 }, { id:I.SILVER_HAMMER, rate:0.01 }, { id:I.TUNGSTEN_HAMMER, rate:0.01 }, { id:I.WOODEN_HAMMER, rate:0.01 }, { id:I.ADAMANTITE_WARAXE, rate:0.01 }, { id:I.AXE_OF_REGROWTH, rate:0.01 }, { id:I.BLOOD_LUST_CLUSTER, rate:0.01 }, { id:I.COBALT_WARAXE, rate:0.01 }, { id:I.GOLD_AXE, rate:0.01 }, { id:I.LEAD_AXE, rate:0.01 }, { id:I.METEOR_HAMAXE, rate:0.01 }, { id:I.MOLTEN_HAMAXE, rate:0.01 }, { id:I.MYTHRIL_WARAXE, rate:0.01 }, { id:I.ORICHALCUM_WARAXE, rate:0.01 }, { id:I.PLATINUM_AXE, rate:0.01 }, { id:I.SILVER_AXE, rate:0.01 }, { id:I.TITANIUM_WARAXE, rate:0.01 }, { id:I.TUNGSTEN_AXE, rate:0.01 }, { id:I.WAR_AXE_OF_THE_NIGHT, rate:0.01 }, { id:I.ADAMANTITE_REPEATER, rate:0.01 }, { id:I.ASH_WOOD_BOW, rate:0.01 }, { id:I.BLOOD_RAIN_BOW, rate:0.01 }, { id:I.BLOWGUN, rate:0.01 }, { id:I.BLOWPIPE, rate:0.01 }, { id:I.BOREAL_WOOD_BOW, rate:0.01 }, { id:I.COBALT_REPEATER, rate:0.01 }, { id:I.DEMON_BOW, rate:0.01 }, { id:I.EBONWOOD_BOW, rate:0.01 }, { id:I.LEAD_BOW, rate:0.01 }, { id:I.MYTHRIL_REPEATER, rate:0.01 }, { id:I.ORICHALCUM_REPEATER, rate:0.01 }, { id:I.PALM_WOOD_BOW, rate:0.01 }, { id:I.PEARLWOOD_BOW, rate:0.01 }, { id:I.PLATINUM_BOW, rate:0.01 }, { id:I.RICH_MAHOGANY_BOW, rate:0.01 }, { id:I.SHADEWOOD_BOW, rate:0.01 }, { id:I.SKULL_BOW, rate:0.01 }, { id:I.TENDON_BOW, rate:0.01 }, { id:I.TITANIUM_REPEATER, rate:0.01 }, { id:I.TUNGSTEN_BOW, rate:0.01 }, { id:I.WOODEN_BOW, rate:0.01 }, { id:I.ALE_TOSSER, rate:0.01 }, { id:I.BEENADE, rate:0.01 }, { id:I.BLUE_FLARE, rate:0.01 }, { id:I.BOUNCY_GRENADE, rate:0.01 }, { id:I.CANDY_CORN, rate:0.01 }, { id:I.CHLOROPHYTE_ARROW, rate:0.01 }, { id:I.CLUSTER_ROCKET_I, rate:0.01 }, { id:I.CLUSTER_ROCKET_I_I, rate:0.01 }, { id:I.CURSED_ARROW, rate:0.01 }, { id:I.CURSED_FLARE, rate:0.01 }, { id:I.DRY_ROCKET, rate:0.01 }, { id:I.EXPLOSIVE_JACK_O_LANTERN, rate:0.01 }, { id:I.FLAMING_ARROW, rate:0.01 }, { id:I.FLARE, rate:0.01 }, { id:I.HAPPY_GRENADE, rate:0.01 }, { id:I.HONEY_ROCKET, rate:0.01 }, { id:I.ICHOR_ARROW, rate:0.01 }, { id:I.LAVA_ROCKET, rate:0.01 }, { id:I.LUMINITE_ARROW, rate:0.01 }, { id:I.MOLOTOV_COCKTAIL, rate:0.01 }, { id:I.NAIL, rate:0.01 }, { id:I.POISON_DART, rate:0.01 }, { id:I.RAINBOW_FLARE, rate:0.01 }, { id:I.ROTTEN_EGG, rate:0.01 }, { id:I.SEED, rate:0.01 }, { id:I.SHIMMER_ARROW, rate:0.01 }, { id:I.SHIMMER_FLARE, rate:0.01 }, { id:I.SNOWBALL, rate:0.01 }, { id:I.SNOWBALL_CANNON, rate:0.01 }, { id:I.SPELUNKER_FLARE, rate:0.01 }, { id:I.STAKE, rate:0.01 }, { id:I.STAR_ANISE, rate:0.01 }, { id:I.STICKY_GRENADE, rate:0.01 }, { id:I.VENOM_ARROW, rate:0.01 }, { id:I.WET_ROCKET, rate:0.01 }, { id:I.AMETHYST_STAFF, rate:0.01 }, { id:I.ARC_SURGE, rate:0.01 }, { id:I.BEJEWELED_STAFF, rate:0.01 }, { id:I.BOOK_OF_SKULLS, rate:0.01 }, { id:I.DAYBLOOM_STAFF, rate:0.01 }, { id:I.DIAMOND_STAFF, rate:0.01 }, { id:I.EMERALD_STAFF, rate:0.01 }, { id:I.GLACIER_FANG, rate:0.01 }, { id:I.GRAY_ZAPINATOR, rate:0.01 }, { id:I.LIGHTNING_STRIKE, rate:0.01 }, { id:I.MAGIC_MISSILE, rate:0.01 }, { id:I.METEOR_STAFF, rate:0.01 }, { id:I.MYSTIC_BLOOM, rate:0.01 }, { id:I.RUBY_STAFF, rate:0.01 }, { id:I.SAPPHIRE_STAFF, rate:0.01 }, { id:I.THUNDER_ZAPPER, rate:0.01 }, { id:I.TOME_OF_INFINITE_WISDOM, rate:0.01 }, { id:I.TOPAZ_STAFF, rate:0.01 }, { id:I.WAND_OF_SPARKING, rate:0.01 }, { id:I.BALLISTA_ROD, rate:0.01 }, { id:I.CATTIVA, rate:0.01 }, { id:I.CLAY_BUD_STAFF, rate:0.01 }, { id:I.COBWHIP, rate:0.01 }, { id:I.EXPLOSIVE_TRAP_ROD, rate:0.01 }, { id:I.FINCH_STAFF, rate:0.01 }, { id:I.FLAMEBURST_ROD, rate:0.01 }, { id:I.FOXPARKS, rate:0.01 }, { id:I.HOUNDIUS_SHOOTIUS, rate:0.01 }, { id:I.LIGHTNING_AURA_ROD, rate:0.01 }, { id:I.MUSHROOM_STAFF, rate:0.01 }, { id:I.RUINOUS_STAFF, rate:0.01 }, { id:I.SLIME_STAFF, rate:0.01 }, { id:I.SLIME_WHIP, rate:0.01 }, { id:I.SOULSCOURGE, rate:0.01 }, { id:I.SPINAL_TAP, rate:0.01 }, { id:I.STARCRASH, rate:0.01 }, { id:I.TRUSTY_CATTIVA, rate:0.01 }, { id:I.TRUSTY_FOXPARKS, rate:0.01 }, { id:I.VAMPIRE_FROG_STAFF, rate:0.01 }, { id:I.VASCULASH, rate:0.01 }, { id:I.TENTACLE_SPIKE, rate:0.01 }];
B83_ENEMY_DROPS['Slime'] = [{ id:I.ASH_WOOD_SWORD, rate:0.01 }, { id:I.BAT_BAT, rate:0.01 }, { id:I.BLADED_GLOVE, rate:0.01 }, { id:I.BOREAL_WOOD_SWORD, rate:0.01 }, { id:I.BRAND_OF_THE_INFERNO, rate:0.01 }, { id:I.BREATHING_REED, rate:0.01 }, { id:I.CACTUS_SWORD, rate:0.01 }, { id:I.CLASSY_CANE, rate:0.01 }, { id:I.EBONWOOD_SWORD, rate:0.01 }, { id:I.EXOTIC_SCIMITAR, rate:0.01 }, { id:I.FLYMEAL, rate:0.01 }, { id:I.GOLD_BROADSWORD, rate:0.01 }, { id:I.HAM_BAT, rate:0.01 }, { id:I.ICE_BLADE, rate:0.01 }, { id:I.LEAD_BROADSWORD, rate:0.01 }, { id:I.MANDIBLE_BLADE, rate:0.01 }, { id:I.ORANGE_PHASEBLADE, rate:0.01 }, { id:I.PALM_WOOD_SWORD, rate:0.01 }, { id:I.PEARLWOOD_SWORD, rate:0.01 }, { id:I.PINK_PHASEBLADE, rate:0.01 }, { id:I.PLATINUM_BROADSWORD, rate:0.01 }, { id:I.PURPLE_CLUBBERFISH, rate:0.01 }, { id:I.RAINBOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASEBLADE, rate:0.01 }, { id:I.RICH_MAHOGANY_SWORD, rate:0.01 }, { id:I.SHADEWOOD_SWORD, rate:0.01 }, { id:I.SHIELD_OF_CTHULHU, rate:0.01 }, { id:I.SICKLE, rate:0.01 }, { id:I.SILVER_BROADSWORD, rate:0.01 }, { id:I.STYLISH_SCISSORS, rate:0.01 }, { id:I.TRAGIC_UMBRELLA, rate:0.01 }, { id:I.TUNGSTEN_BROADSWORD, rate:0.01 }, { id:I.WAFFLES_IRON, rate:0.01 }, { id:I.WHITE_PHASEBLADE, rate:0.01 }, { id:I.YELLOW_PHASEBLADE, rate:0.01 }, { id:I.RED_PHASESABER, rate:0.01 }, { id:I.WHITE_PHASESABER, rate:0.01 }, { id:I.YELLOW_PHASESABER, rate:0.01 }, { id:I.ORANGE_PHASESABER, rate:0.01 }, { id:I.PINK_PHASESABER, rate:0.01 }, { id:I.RAINBOW_PHASESABER, rate:0.01 }, { id:I.BONE_PICKAXE, rate:0.01 }, { id:I.CACTUS_PICKAXE, rate:0.01 }, { id:I.CANDY_CANE_PICKAXE, rate:0.01 }, { id:I.FOSSIL_PICKAXE, rate:0.01 }, { id:I.ORICHALCUM_PICKAXE, rate:0.01 }, { id:I.REAVER_SHARK, rate:0.01 }, { id:I.ASH_WOOD_HAMMER, rate:0.01 }, { id:I.BOREAL_WOOD_HAMMER, rate:0.01 }, { id:I.EBONWOOD_HAMMER, rate:0.01 }, { id:I.FLESH_GRINDER, rate:0.01 }, { id:I.GOLD_HAMMER, rate:0.01 }, { id:I.LEAD_HAMMER, rate:0.01 }, { id:I.PALM_WOOD_HAMMER, rate:0.01 }, { id:I.PEARLWOOD_HAMMER, rate:0.01 }, { id:I.PLATINUM_HAMMER, rate:0.01 }, { id:I.RICH_MAHOGANY_HAMMER, rate:0.01 }, { id:I.SHADEWOOD_HAMMER, rate:0.01 }, { id:I.SILVER_HAMMER, rate:0.01 }, { id:I.TUNGSTEN_HAMMER, rate:0.01 }, { id:I.WOODEN_HAMMER, rate:0.01 }, { id:I.ADAMANTITE_WARAXE, rate:0.01 }, { id:I.AXE_OF_REGROWTH, rate:0.01 }, { id:I.BLOOD_LUST_CLUSTER, rate:0.01 }, { id:I.COBALT_WARAXE, rate:0.01 }, { id:I.GOLD_AXE, rate:0.01 }, { id:I.LEAD_AXE, rate:0.01 }, { id:I.METEOR_HAMAXE, rate:0.01 }, { id:I.MOLTEN_HAMAXE, rate:0.01 }, { id:I.MYTHRIL_WARAXE, rate:0.01 }, { id:I.ORICHALCUM_WARAXE, rate:0.01 }, { id:I.PLATINUM_AXE, rate:0.01 }, { id:I.SILVER_AXE, rate:0.01 }, { id:I.TITANIUM_WARAXE, rate:0.01 }, { id:I.TUNGSTEN_AXE, rate:0.01 }, { id:I.WAR_AXE_OF_THE_NIGHT, rate:0.01 }, { id:I.ADAMANTITE_REPEATER, rate:0.01 }, { id:I.ASH_WOOD_BOW, rate:0.01 }, { id:I.BLOOD_RAIN_BOW, rate:0.01 }, { id:I.BLOWGUN, rate:0.01 }, { id:I.BLOWPIPE, rate:0.01 }, { id:I.BOREAL_WOOD_BOW, rate:0.01 }, { id:I.COBALT_REPEATER, rate:0.01 }, { id:I.DEMON_BOW, rate:0.01 }, { id:I.EBONWOOD_BOW, rate:0.01 }, { id:I.LEAD_BOW, rate:0.01 }, { id:I.MYTHRIL_REPEATER, rate:0.01 }, { id:I.ORICHALCUM_REPEATER, rate:0.01 }, { id:I.PALM_WOOD_BOW, rate:0.01 }, { id:I.PEARLWOOD_BOW, rate:0.01 }, { id:I.PLATINUM_BOW, rate:0.01 }, { id:I.RICH_MAHOGANY_BOW, rate:0.01 }, { id:I.SHADEWOOD_BOW, rate:0.01 }, { id:I.SKULL_BOW, rate:0.01 }, { id:I.TENDON_BOW, rate:0.01 }, { id:I.TITANIUM_REPEATER, rate:0.01 }, { id:I.TUNGSTEN_BOW, rate:0.01 }, { id:I.WOODEN_BOW, rate:0.01 }, { id:I.ALE_TOSSER, rate:0.01 }, { id:I.BEENADE, rate:0.01 }, { id:I.BLUE_FLARE, rate:0.01 }, { id:I.BOUNCY_GRENADE, rate:0.01 }, { id:I.CANDY_CORN, rate:0.01 }, { id:I.CHLOROPHYTE_ARROW, rate:0.01 }, { id:I.CLUSTER_ROCKET_I, rate:0.01 }, { id:I.CLUSTER_ROCKET_I_I, rate:0.01 }, { id:I.CURSED_ARROW, rate:0.01 }, { id:I.CURSED_FLARE, rate:0.01 }, { id:I.DRY_ROCKET, rate:0.01 }, { id:I.EXPLOSIVE_JACK_O_LANTERN, rate:0.01 }, { id:I.FLAMING_ARROW, rate:0.01 }, { id:I.FLARE, rate:0.01 }, { id:I.HAPPY_GRENADE, rate:0.01 }, { id:I.HONEY_ROCKET, rate:0.01 }, { id:I.ICHOR_ARROW, rate:0.01 }, { id:I.LAVA_ROCKET, rate:0.01 }, { id:I.LUMINITE_ARROW, rate:0.01 }, { id:I.MOLOTOV_COCKTAIL, rate:0.01 }, { id:I.NAIL, rate:0.01 }, { id:I.POISON_DART, rate:0.01 }, { id:I.RAINBOW_FLARE, rate:0.01 }, { id:I.ROTTEN_EGG, rate:0.01 }, { id:I.SEED, rate:0.01 }, { id:I.SHIMMER_ARROW, rate:0.01 }, { id:I.SHIMMER_FLARE, rate:0.01 }, { id:I.SNOWBALL, rate:0.01 }, { id:I.SNOWBALL_CANNON, rate:0.01 }, { id:I.SPELUNKER_FLARE, rate:0.01 }, { id:I.STAKE, rate:0.01 }, { id:I.STAR_ANISE, rate:0.01 }, { id:I.STICKY_GRENADE, rate:0.01 }, { id:I.VENOM_ARROW, rate:0.01 }, { id:I.WET_ROCKET, rate:0.01 }, { id:I.AMETHYST_STAFF, rate:0.01 }, { id:I.ARC_SURGE, rate:0.01 }, { id:I.BEJEWELED_STAFF, rate:0.01 }, { id:I.BOOK_OF_SKULLS, rate:0.01 }, { id:I.DAYBLOOM_STAFF, rate:0.01 }, { id:I.DIAMOND_STAFF, rate:0.01 }, { id:I.EMERALD_STAFF, rate:0.01 }, { id:I.GLACIER_FANG, rate:0.01 }, { id:I.GRAY_ZAPINATOR, rate:0.01 }, { id:I.LIGHTNING_STRIKE, rate:0.01 }, { id:I.MAGIC_MISSILE, rate:0.01 }, { id:I.METEOR_STAFF, rate:0.01 }, { id:I.MYSTIC_BLOOM, rate:0.01 }, { id:I.RUBY_STAFF, rate:0.01 }, { id:I.SAPPHIRE_STAFF, rate:0.01 }, { id:I.THUNDER_ZAPPER, rate:0.01 }, { id:I.TOME_OF_INFINITE_WISDOM, rate:0.01 }, { id:I.TOPAZ_STAFF, rate:0.01 }, { id:I.WAND_OF_SPARKING, rate:0.01 }, { id:I.BALLISTA_ROD, rate:0.01 }, { id:I.CATTIVA, rate:0.01 }, { id:I.CLAY_BUD_STAFF, rate:0.01 }, { id:I.COBWHIP, rate:0.01 }, { id:I.EXPLOSIVE_TRAP_ROD, rate:0.01 }, { id:I.FINCH_STAFF, rate:0.01 }, { id:I.FLAMEBURST_ROD, rate:0.01 }, { id:I.FOXPARKS, rate:0.01 }, { id:I.HOUNDIUS_SHOOTIUS, rate:0.01 }, { id:I.LIGHTNING_AURA_ROD, rate:0.01 }, { id:I.MUSHROOM_STAFF, rate:0.01 }, { id:I.RUINOUS_STAFF, rate:0.01 }, { id:I.SLIME_STAFF, rate:0.01 }, { id:I.SLIME_WHIP, rate:0.01 }, { id:I.SOULSCOURGE, rate:0.01 }, { id:I.SPINAL_TAP, rate:0.01 }, { id:I.STARCRASH, rate:0.01 }, { id:I.TRUSTY_CATTIVA, rate:0.01 }, { id:I.TRUSTY_FOXPARKS, rate:0.01 }, { id:I.VAMPIRE_FROG_STAFF, rate:0.01 }, { id:I.VASCULASH, rate:0.01 }, { id:I.TENTACLE_SPIKE, rate:0.01 }];
B83_ENEMY_DROPS['Jungle Bat'] = [{ id:I.BLADE_OF_GRASS, rate:0.01 }];
B83_ENEMY_DROPS['Hornet'] = [{ id:I.BLADE_OF_GRASS, rate:0.01 }];
B83_ENEMY_DROPS['Man Eater'] = [{ id:I.BLADE_OF_GRASS, rate:0.01 }];
B83_ENEMY_DROPS['Snatcher'] = [{ id:I.BLADE_OF_GRASS, rate:0.01 }];
B83_ENEMY_DROPS['Jungle Slime'] = [{ id:I.BLADE_OF_GRASS, rate:0.01 }];
B83_ENEMY_DROPS['Face Monster'] = [{ id:I.BLADETONGUE, rate:0.02 }];
B83_ENEMY_DROPS['Skeleton'] = [{ id:I.BONE_SWORD, rate:0.01 }];
B83_ENEMY_DROPS['Ice Slime'] = [{ id:I.ICE_SICKLE, rate:0.01 }, { id:I.FLOWER_OF_FROST, rate:0.01 }, { id:I.FROST_STAFF, rate:0.01 }, { id:I.WAND_OF_FROSTING, rate:0.01 }, { id:I.STAFF_OF_THE_FROST_HYDRA, rate:0.01 }];
B83_ENEMY_DROPS['Spiked Ice Slime'] = [{ id:I.ICE_SICKLE, rate:0.01 }, { id:I.FLOWER_OF_FROST, rate:0.01 }, { id:I.FROST_STAFF, rate:0.01 }, { id:I.WAND_OF_FROSTING, rate:0.01 }, { id:I.STAFF_OF_THE_FROST_HYDRA, rate:0.01 }];
B83_ENEMY_DROPS['Snow Flinx'] = [{ id:I.ICE_SICKLE, rate:0.01 }, { id:I.FLOWER_OF_FROST, rate:0.01 }, { id:I.FROST_STAFF, rate:0.01 }, { id:I.WAND_OF_FROSTING, rate:0.01 }, { id:I.STAFF_OF_THE_FROST_HYDRA, rate:0.01 }];
B83_ENEMY_DROPS['Undead Viking'] = [{ id:I.ICE_SICKLE, rate:0.01 }, { id:I.FLOWER_OF_FROST, rate:0.01 }, { id:I.FROST_STAFF, rate:0.01 }, { id:I.WAND_OF_FROSTING, rate:0.01 }, { id:I.STAFF_OF_THE_FROST_HYDRA, rate:0.01 }];
B83_ENEMY_DROPS['Ice Bat'] = [{ id:I.ICE_SICKLE, rate:0.01 }, { id:I.FLOWER_OF_FROST, rate:0.01 }, { id:I.FROST_STAFF, rate:0.01 }, { id:I.WAND_OF_FROSTING, rate:0.01 }, { id:I.STAFF_OF_THE_FROST_HYDRA, rate:0.01 }];
B83_ENEMY_DROPS['Zombie'] = [{ id:I.ZOMBIE_ARM, rate:0.02 }];
var B83_BOSS_DROPS = {};
B83_BOSS_DROPS['queenbee'] = [I.BEE_KEEPER];
B83_BOSS_DROPS['eaterofworlds'] = [I.BLOOD_BUTCHERER, I.BREAKER_BLADE, I.LIGHTS_BANE, I.THE_BREAKER];
B83_BOSS_DROPS['moonlord'] = [I.MEOWMERE, I.STAR_WRATH];
