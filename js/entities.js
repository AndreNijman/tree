...
var ENT_DEF = {
  [E.SLIME]: { w:22, h:16, hp:70, dmg:12, def:0, color:'#5cbf6c', speed:1.6, name:'Green Slime', exp:1 },
  [E.PINKSLIME]: { w:40, h:30, hp:260, dmg:28, def:4, color:'#ff8fd0', speed:1.8, name:'Pink Slime', exp:4 },
  [E.HOPPINJACK]: { w:24, h:18, hp:95, dmg:16, def:2, color:'#d8e05e', speed:2.6, name:'Hopping Jack', exp:2 },
  [E.ZOMBIE]: { w:20, h:34, hp:130, dmg:22, def:2, color:'#6a9a5c', speed:1.1, name:'Zombie', exp:2 },
  [E.HARDZOMBIE]: { w:22, h:34, hp:430, dmg:42, def:10, color:'#8f7f6f', speed:1.5, name:'Armored Zombie', exp:8 },
  [E.WRATH]: { w:28, h:32, hp:320, dmg:45, def:8, color:'#b8c4ff', speed:2.4, fly:true, ghost:true, name:'Wraith', exp:10 },
  [E.EATEROFSOULS]: { w:20, h:18, hp:130, dmg:18, def:4, color:'#5a4d7a', speed:2.2, fly:true, name:'Eater of Souls', exp:4 },
  [E.CORRUPTOR]: { w:26, h:22, hp:260, dmg:32, def:6, color:'#7a3d5c', speed:1.8, fly:true, name:'Corruptor', exp:8 },
  [E.DEVOURER]: { w:28, h:18, hp:180, dmg:24, def:6, color:'#6a507f', speed:2.5, fly:true, name:'Devourer', exp:6 },
  [E.PIXIE]: { w:20, h:20, hp:160, dmg:26, def:6, color:'#ffe9a8', speed:2.6, fly:true, name:'Pixie', exp:8 },
  [E.UNICORN]: { w:36, h:30, hp:420, dmg:48, def:10, color:'#fff0d0', speed:5.0, name:'Unicorn', exp:12 },
  [E.CHAOSELEMENTAL]: { w:22, h:26, hp:220, dmg:42, def:8, color:'#e0d8ff', speed:3.0, fly:true, name:'Chaos Elemental', exp:12 },
  [E.GASTROPOD]: { w:30, h:24, hp:360, dmg:50, def:12, color:'#ffd0a8', speed:2.0, fly:true, name:'Gastropod', exp:16 },
  [E.GUIDE]: { w:18, h:32, hp:9999, dmg:0, def:99, color:'#c8b090', speed:0, name:'Guide', exp:0 },
  [E.WYVERN]: { w:34, h:24, hp:600, dmg:55, def:14, color:'#ffd0a0', speed:4.0, fly:true, name:'Wyvern', exp:30 },
  [E.JUNGLEBAT]: { w:22, h:16, hp:140, dmg:22, def:2, color:'#7a4d3d', speed:3.2, fly:true, name:'Jungle Bat', exp:5 },
  [E.JUNGLESLIME]: { w:22, h:16, hp:160, dmg:24, def:2, color:'#4d8a3d', speed:1.8, name:'Jungle Slime', exp:5 },
  [E.HORNET]: { w:26, h:22, hp:200, dmg:18, def:4, color:'#d8a030', speed:2.2, fly:true, name:'Hornet', exp:8 },
  [E.LIHZARD]: { w:24, h:34, hp:440, dmg:55, def:16, color:'#8a5a3a', speed:1.6, name:'Lihzahrd', exp:16 },
  [E.FLYINGSNAKE]: { w:28, h:20, hp:360, dmg:48, def:12, color:'#5a9a5c', speed:2.6, fly:true, name:'Flying Snake', exp:14 },
  [E.FRANKENSTEIN]: { w:24, h:36, hp:500, dmg:60, def:14, color:'#7a9a5c', speed:1.7, name:'Frankenstein', exp:20 },
  [E.REAPER]: { w:30, h:34, hp:600, dmg:70, def:16, color:'#3a3a4a', speed:2.8, fly:true, ghost:true, name:'Reaper', exp:25 },
  [E.VAMPIRE]: { w:22, h:24, hp:450, dmg:65, def:10, color:'#6a3a4a', speed:2.6, fly:true, name:'Vampire', exp:22 },
  [E.CORITE]: { w:26, h:20, hp:520, dmg:60, def:12, color:'#ff9a3d', speed:5.5, fly:true, name:'Corite', exp:26 },
  [E.LUNARFLAME]: { w:22, h:22, hp:480, dmg:58, def:10, color:'#c85cff', speed:3.4, fly:true, name:'Nebula Blaze', exp:26 },
  [E.MUMMY]: { w:22, h:34, hp:350, dmg:40, def:8, color:'#d8c8a0', speed:1.4, name:'Mummy', exp:8 },
  [E.LIGHTMUMMY]: { w:22, h:34, hp:350, dmg:42, def:8, color:'#ffe0a8', speed:2.0, name:'Light Mummy', exp:9 },
  [E.DARKMUMMY]: { w:22, h:34, hp:420, dmg:46, def:10, color:'#7a6a9a', speed:1.8, name:'Dark Mummy', exp:10 },
  [E.BLOODMUMMY]: { w:22, h:34, hp:420, dmg:46, def:10, color:'#b04a4a', speed:1.8, name:'Blood Mummy', exp:10 },
  [E.SKELETONARCHER]: { w:22, h:32, hp:260, dmg:40, def:6, color:'#c8c8d8', speed:1.6, name:'Skeleton Archer', exp:8 },
  [E.ARMOREDBONES]: { w:24, h:34, hp:460, dmg:52, def:14, color:'#a0a0b0', speed:1.2, name:'Armored Bones', exp:10 },
  [E.UNDEADMINER]: { w:22, h:32, hp:280, dmg:36, def:8, color:'#b0a090', speed:1.3, name:'Undead Miner', exp:8 },
  [E.GIANTBAT]: { w:24, h:16, hp:120, dmg:20, def:2, color:'#8a6a9a', speed:3.6, fly:true, name:'Giant Bat', exp:5 },
  [E.TOXICSLUDGE]: { w:22, h:16, hp:340, dmg:44, def:8, color:'#8ac84a', speed:1.9, name:'Toxic Sludge', exp:8 },
  [E.PIGRON]: { w:24, h:20, hp:200, dmg:28, def:4, color:'#ffb0c8', speed:2.2, fly:true, name:'Pigron', exp:7 },
  [E.ICEGOLEM]: { w:26, h:38, hp:700, dmg:64, def:18, color:'#a8d8f0', speed:1.4, name:'Ice Golem', exp:16 },
  [E.ICETORTOISE]: { w:30, h:20, hp:800, dmg:70, def:20, color:'#8ab0c8', speed:1.6, name:'Ice Tortoise', exp:18 },
  [E.SNOWFLINX]: { w:28, h:26, hp:320, dmg:40, def:8, color:'#f0f0f8', speed:3.0, name:'Snow Flinx', exp:8 },
  [E.ICEBAT]: { w:22, h:14, hp:150, dmg:24, def:2, color:'#b8d8f0', speed:3.6, fly:true, name:'Ice Bat', exp:5 },
  [E.ANGLERFISH]: { w:26, h:16, hp:220, dmg:32, def:4, color:'#c89068', speed:2.6, fly:true, name:'Angler Fish', exp:8 },
  [E.ARAPAIMA]: { w:34, h:20, hp:600, dmg:56, def:12, color:'#d88870', speed:2.4, fly:true, name:'Arapaima', exp:14 },
  [E.DERPLING]: { w:24, h:22, hp:400, dmg:48, def:10, color:'#b0a0d8', speed:2.0, fly:true, name:'Derpling', exp:12 },
  [E.MOSSHORNET]: { w:26, h:22, hp:260, dmg:28, def:6, color:'#8ad850', speed:2.4, fly:true, name:'Moss Hornet', exp:9 },
  [E.GIANTTORTOSE]: { w:32, h:20, hp:700, dmg:62, def:18, color:'#6a8a5a', speed:2.2, name:'Giant Tortoise', exp:16 },
  [E.CRIMSONAXE]: { w:26, h:22, hp:220, dmg:30, def:6, color:'#c04848', speed:2.8, fly:true, name:'Crimson Axe', exp:8 },
  [E.ICHORSTICKER]: { w:20, h:24, hp:260, dmg:38, def:6, color:'#d0d050', speed:1.6, name:'Ichor Sticker', exp:8 },
  [E.CLINGER]: { w:18, h:30, hp:340, dmg:44, def:8, color:'#d04040', speed:0, name:'Clinger', exp:9 },
  [E.CURSEDHAMMER]: { w:24, h:24, hp:420, dmg:50, def:10, color:'#a0a8b8', speed:2.6, fly:true, name:'Cursed Hammer', exp:10 },
  [E.MIMIC]: { w:28, h:28, hp:600, dmg:70, def:16, color:'#c89030', speed:1.8, name:'Mimic', exp:20 },
  [E.HALLOWEDMIMIC]: { w:34, h:32, hp:3500, dmg:90, def:30, color:'#ffd8a0', speed:2.6, name:'Hallowed Mimic', exp:50 },
  [E.CORRUPTMIMIC]: { w:34, h:32, hp:3500, dmg:90, def:30, color:'#5a4d7a', speed:2.6, name:'Corrupt Mimic', exp:50 },
  [E.CRIMSONMIMIC]: { w:34, h:32, hp:3500, dmg:90, def:30, color:'#b04a4a', speed:2.6, name:'Crimson Mimic', exp:50 },
  [E.WOLF]: { w:30, h:24, hp:260, dmg:36, def:6, color:'#8a8a90', speed:4.5, name:'Wolf', exp:8 },
  [E.VORTEXIAN]: { w:26, h:30, hp:520, dmg:60, def:12, color:'#60d8c8', speed:2.2, name:'Vortexian', exp:16 },
  [E.ALIENHORNET]: { w:26, h:22, hp:440, dmg:52, def:10, color:'#70c870', speed:3.0, fly:true, name:'Alien Hornet', exp:16 },
  [E.NEBULAFLOATER]: { w:26, h:22, hp:480, dmg:58, def:10, color:'#c870e0', speed:2.2, fly:true, name:'Nebula Floater', exp:16 },
  [E.STARDJUSTCELL]: { w:24, h:24, hp:500, dmg:56, def:10, color:'#c0c0ff', speed:2.0, fly:true, name:'Stardust Cell', exp:16 },
  ...
  [E.PUMPKINSCARECROW]: { w:24, h:34, hp:500, dmg:55, def:14, color:'#ff9a3d', speed:1.6, name:'Scarecrow', exp:14 },
  [E.SPLINTERLING]: { w:22, h:26, hp:350, dmg:45, def:10, color:'#d8a030', speed:2.0, name:'Splinterling', exp:10 },
  [E.FROSTZOMBIE]: { w:20, h:34, hp:420, dmg:50, def:12, color:'#b8d8f0', speed:1.4, name:'Frost Zombie', exp:12 },
  [E.GINGERBREAD]: { w:20, h:24, hp:360, dmg:48, def:10, color:'#c89068', speed:2.4, name:'Gingerbread Man', exp:12 },
  [E.MARTIANPROBE]: { w:26, h:20, hp:900, dmg:8, def:20, color:'#3dff9d', speed:3.4, fly:true, name:'Martian Probe', exp:50 },
  [E.MARTIANGRUNT]: { w:22, h:30, hp:700, dmg:65, def:18, color:'#5aa89a', speed:1.8, name:'Martian Grunt', exp:20 },
  [E.RAYGUNNER]: { w:22, h:30, hp:650, dmg:60, def:16, color:'#60d8c8', speed:1.6, name:'Ray Gunner', exp:20 },
  [E.MOURNINGWOOD]: { w:56, h:56, hp:24000, dmg:70, def:22, color:'#7a4d3d', speed:2.6, name:'Mourning Wood', exp:80 },
  [E.PUMPKING]: { w:60, h:60, hp:36000, dmg:80, def:24, color:'#ff8a3d', speed:3.0, name:'Pumpking', exp:120 },
  [E.EVERSCREAM]: { w:56, h:56, hp:24000, dmg:70, def:22, color:'#8ac84a', speed:2.6, name:'Everscream', exp:80 },
  [E.SANTANK]: { w:52, h:56, hp:32000, dmg:75, def:22, color:'#d04040', speed:2.8, name:'Santa-NK1', exp:100 },
  [E.ICEQUEEN]: { w:58, h:58, hp:34000, dmg:78, def:24, color:'#a8d8f0', speed:3.2, name:'Ice Queen', exp:120 },
  [E.MARTIANSAUCER]: { w:80, h:48, hp:40000, dmg:70, def:26, color:'#3dff9d', speed:2.2, name:'Martian Saucer', exp:150 },
  [E.HARPY]: { w:30, h:34, hp:300, dmg:40, def:8, color:'#e8e0d0', speed:2.8, fly:true, name:'Harpy', exp:14 },
  [E.LAVASLIME]: { w:24, h:18, hp:220, dmg:30, def:8, color:'#ff6a2a', speed:1.6, name:'Lava Slime', exp:8 },
  [E.HELLBAT]: { w:22, h:16, hp:160, dmg:26, def:4, color:'#c85028', speed:3.4, fly:true, name:'Hellbat', exp:6 },
  [E.DEMON]: { w:30, h:34, hp:500, dmg:60, def:12, color:'#8a4a3d', speed:2.4, fly:true, name:'Demon', exp:20 },
  [E.VOODOODEMON]: { w:30, h:34, hp:520, dmg:62, def:12, color:'#6a3a32', speed:2.4, fly:true, name:'Voodoo Demon', exp:22 },
  [E.FIREIMP]: { w:22, h:26, hp:220, dmg:35, def:4, color:'#e05828', speed:1.8, name:'Fire Imp', exp:8 },
  [E.BONESERPENT]: { w:30, h:22, hp:500, dmg:55, def:12, color:'#d8c8a8', speed:3.0, fly:true, name:'Bone Serpent', exp:25 },
  [E.CRIMERA]: { w:20, h:18, hp:200, dmg:26, def:4, color:'#e04848', speed:2.4, fly:true, name:'Crimera', exp:6 },
  [E.FACEMONSTER]: { w:20, h:30, hp:360, dmg:44, def:8, color:'#c85050', speed:1.6, name:'Face Monster', exp:10 },
  [E.HERPLING]: { w:22, h:26, hp:300, dmg:38, def:6, color:'#e07878', speed:2.0, name:'Herpling', exp:8 },
  [E.BLOODCRAWLER]: { w:26, h:18, hp:260, dmg:36, def:6, color:'#c03030', speed:3.0, name:'Blood Crawler', exp:9 },
  [E.BLACKRECLUSE]: { w:26, h:18, hp:400, dmg:50, def:10, color:'#3a2a3a', speed:3.0, name:'Black Recluse', exp:12 },
  [E.GRANITEGOLEM]: { w:30, h:40, hp:650, dmg:60, def:18, color:'#7a7a8a', speed:1.4, name:'Granite Golem', exp:18 },
  [E.MARBLEGOLEM]: { w:30, h:40, hp:600, dmg:58, def:16, color:'#e8e8f0', speed:1.4, name:'Marble Golem', exp:16 },
  [E.DEMONEYE]: { w:24, h:20, hp:150, dmg:24, def:2, color:'#c03030', speed:3.2, fly:true, name:'Demon Eye', exp:5 },
  [E.CAVEBAT]: { w:20, h:14, hp:80, dmg:16, def:1, color:'#6a5c3d', speed:3.4, fly:true, name:'Cave Bat', exp:3 },
  [E.GOBLIN]: { w:20, h:30, hp:120, dmg:20, def:2, color:'#7a8a3d', speed:2.2, name:'Goblin', exp:4 },
  [E.CORRUPTCRIMSONFLYER]: { w:22, h:16, hp:100, dmg:18, def:2, color:'#5a4d7a', speed:2.8, fly:true, name:'Vile Flyer', exp:4 },
  [E.CURSEDSKULL]: { w:22, h:22, hp:320, dmg:44, def:6, color:'#9a8ab0', speed:2.2, fly:true, name:'Cursed Skull', exp:10, shoot:true },
  [E.ANGRYBONES]: { w:22, h:34, hp:280, dmg:42, def:6, color:'#d8d0c0', speed:1.8, name:'Angry Bones', exp:8 },
  [E.DARKCASTER]: { w:22, h:32, hp:300, dmg:45, def:8, color:'#7a5a9a', speed:1.4, name:'Dark Caster', exp:10, shoot:true },
  [E.DUNGEONSLIME]: { w:24, h:18, hp:200, dmg:30, def:4, color:'#8a7ab0', speed:1.8, name:'Dungeon Slime', exp:6 },
  [E.ANTLION]: { w:28, h:20, hp:340, dmg:44, def:10, color:'#c8a058', speed:2.2, name:'Antlion', exp:9 },
  [E.ANTLIONCHARGER]: { w:30, h:22, hp:400, dmg:50, def:12, color:'#b08848', speed:4.6, name:'Antlion Charger', exp:11 },
  [E.ICESLIME]: { w:24, h:18, hp:220, dmg:32, def:4, color:'#b8d8f0', speed:1.8, name:'Ice Slime', exp:6 },
  ...
  [E.GOBLINTHIEF]: { w:20, h:30, hp:150, dmg:26, def:3, color:'#5a8a3d', speed:2.8, name:'Goblin Thief', exp:5 },
  [E.GOBLINARCHER]: { w:20, h:30, hp:120, dmg:24, def:2, color:'#6a7a3d', speed:2.0, name:'Goblin Archer', exp:5, shoot:true },
  [E.GOBLINWARRIOR]: { w:22, h:32, hp:260, dmg:38, def:8, color:'#4a6a3d', speed:1.8, name:'Goblin Warrior', exp:8 },
  [E.GOBLINWARLOCK]: { w:24, h:34, hp:700, dmg:55, def:14, color:'#7a3d8a', speed:1.6, name:'Goblin Warlock', exp:30, shoot:true },
  [E.PIRATEDECKHAND]: { w:22, h:32, hp:450, dmg:48, def:12, color:'#8a5c3d', speed:1.8, name:'Pirate Deckhand', exp:16 },
  [E.PIRATECORSAIR]: { w:24, h:34, hp:520, dmg:56, def:14, color:'#6a4a3d', speed:2.2, name:'Pirate Corsair', exp:20 },
  [E.PIRATESHARK]: { w:30, h:20, hp:420, dmg:50, def:10, color:'#5a5a6a', speed:3.6, fly:true, name:'Pirate Shark', exp:18 },
  [E.PIRATECAPTAIN]: { w:26, h:38, hp:4000, dmg:70, def:20, color:'#a83d3d', speed:2.0, name:'Pirate Captain', exp:60, shoot:true },
  [E.SWAMPTHING]: { w:28, h:38, hp:700, dmg:72, def:18, color:'#3d7a4d', speed:1.9, name:'Swamp Thing', exp:26 },
  [E.WEREWOLF]: { w:26, h:34, hp:650, dmg:70, def:16, color:'#7a5c4d', speed:3.4, name:'Werewolf', exp:24 },
  [E.EYEBALL]: { w:24, h:20, hp:500, dmg:58, def:10, color:'#e04848', speed:4.0, fly:true, name:'Eyezor', exp:22 },
  [E.MOTHRON]: { w:40, h:26, hp:8000, dmg:75, def:24, color:'#8a8ab8', speed:4.0, fly:true, name:'Mothron', exp:120 },
  // ---- Post-Plantera Dungeon + Cultist ritual ----
  [E.PALADIN]: { w:30, h:42, hp:5000, dmg:85, def:32, color:'#d8c878', speed:1.2, name:'Paladin', exp:55 },
  [E.TACTICALSKELETON]: { w:22, h:34, hp:900, dmg:70, def:18, color:'#788078', speed:1.5, name:'Tactical Skeleton', exp:26, shoot:true },
  [E.SKELETONSNIPER]: { w:22, h:34, hp:1000, dmg:95, def:20, color:'#657078', speed:1.2, name:'Skeleton Sniper', exp:30, shoot:true },
  [E.SKELETONCOMMANDO]: { w:24, h:36, hp:1100, dmg:80, def:22, color:'#69735f', speed:1.4, name:'Skeleton Commando', exp:32, shoot:true },
  [E.RAGGEDCASTER]: { w:22, h:34, hp:850, dmg:68, def:16, color:'#9a8aaa', speed:1.2, name:'Ragged Caster', exp:28, shoot:true },
  [E.NECROMANCER]: { w:22, h:34, hp:900, dmg:72, def:18, color:'#765a98', speed:1.2, name:'Necromancer', exp:30, shoot:true },
  [E.DIABOLIST]: { w:22, h:34, hp:950, dmg:78, def:18, color:'#b84a36', speed:1.1, name:'Diabolist', exp:32, shoot:true },
  [E.BONELEE]: { w:22, h:34, hp:1400, dmg:90, def:20, color:'#34343c', speed:4.8, name:'Bone Lee', exp:38 },
  [E.GIANTCURSEDSKULL]: { w:38, h:38, hp:1800, dmg:82, def:24, color:'#8c78a8', speed:2.8, fly:true, ghost:true, name:'Giant Cursed Skull', exp:42, shoot:true },
  [E.DUNGEONSPIRIT]: { w:22, h:24, hp:400, dmg:55, def:12, color:'#6bc8ff', speed:3.2, fly:true, ghost:true, name:'Dungeon Spirit', exp:20 },
  [E.CULTISTDEVOTEE]: { w:22, h:34, hp:600, dmg:45, def:12, color:'#445b8f', speed:0.8, name:'Lunatic Devotee', exp:15, shoot:true },
  [E.CULTISTARCHER]: { w:22, h:34, hp:500, dmg:48, def:10, color:'#687b9f', speed:1.2, name:'Cultist Archer', exp:15, shoot:true },
  [E.FLYINGDUTCHMAN]: { w:100, h:54, hp:18000, dmg:70, def:24, color:'#6a4a32', speed:2.0, fly:true, name:'Flying Dutchman', exp:120 },
  [E.CREATUREFROMDEEP]: { w:24, h:34, hp:700, dmg:70, def:18, color:'#397878', speed:2.4, name:'Creature from the Deep', exp:24 },
  [E.FRITZ]: { w:22, h:34, hp:650, dmg:68, def:16, color:'#77704f', speed:3.2, name:'Fritz', exp:22 },
  [E.POSSESSED]: { w:22, h:34, hp:750, dmg:74, def:18, color:'#72527c', speed:2.8, name:'The Possessed', exp:26 },
  [E.BUTCHER]: { w:26, h:38, hp:1000, dmg:82, def:22, color:'#a84a42', speed:2.5, name:'Butcher', exp:32 },
  [E.DEADLYSPHERE]: { w:26, h:26, hp:900, dmg:76, def:20, color:'#d84a4a', speed:3.6, fly:true, name:'Deadly Sphere', exp:30 },
  [E.DRMANFLY]: { w:24, h:36, hp:850, dmg:72, def:18, color:'#6aa84f', speed:2.0, name:'Dr. Man Fly', exp:28, shoot:true },
  [E.NAILHEAD]: { w:30, h:40, hp:1200, dmg:85, def:26, color:'#788088', speed:1.8, name:'Nailhead', exp:36, shoot:true },
  [E.PSYCHO]: { w:22, h:34, hp:900, dmg:88, def:18, color:'#505058', speed:4.2, name:'Psycho', exp:32 },
  [E.BABYMOTHRON]: { w:26, h:18, hp:600, dmg:65, def:14, color:'#9a9ac8', speed:4.2, fly:true, name:'Baby Mothron', exp:22 },
  [E.BLOODZOMBIE]: { w:22, h:34, hp:180, dmg:30, def:4, color:'#9a3038', speed:1.7, name:'Blood Zombie', exp:5 },
  [E.DRIPPLER]: { w:26, h:24, hp:220, dmg:34, def:4, color:'#c83a48', speed:3.0, fly:true, name:'Drippler', exp:7 },
  [E.WANDERINGEYEFISH]: { w:28, h:20, hp:300, dmg:38, def:6, color:'#b84858', speed:3.4, fly:true, name:'Wandering Eye Fish', exp:9 },
  [E.ZOMBIEMERMAN]: { w:24, h:36, hp:420, dmg:46, def:8, color:'#4f7f78', speed:2.4, name:'Zombie Merman', exp:12 },
  [E.DREADNAUTILUS]: { w:44, h:38, hp:2400, dmg:58, def:14, color:'#a82f48', speed:3.0, fly:true, ghost:true, name:'Dreadnautilus', exp:35, shoot:true },
  [E.SNOWMANGANGSTA]: { w:22, h:32, hp:420, dmg:48, def:10, color:'#d8e8f0', speed:1.8, name:'Snowman Gangsta', exp:12, shoot:true },
  [E.MISTERSTABBY]: { w:22, h:34, hp:500, dmg:56, def:12, color:'#e8f0f8', speed:3.0, name:'Mister Stabby', exp:14 },
  [E.SNOWBALLA]: { w:24, h:34, hp:460, dmg:52, def:10, color:'#c8dce8', speed:1.6, name:'Snow Balla', exp:13, shoot:true },
  [E.PIRATECROSSBOWER]: { w:22, h:34, hp:520, dmg:58, def:14, color:'#704a32', speed:1.7, name:'Pirate Crossbower', exp:20, shoot:true },
  [E.PARROT]: { w:24, h:20, hp:360, dmg:48, def:8, color:'#d84a3a', speed:4.0, fly:true, name:'Parrot', exp:16 },
  [E.MARTIANWALKER]: { w:34, h:42, hp:1100, dmg:72, def:24, color:'#568f83', speed:1.4, name:'Martian Walker', exp:32, shoot:true },
  [E.MARTIANDRONE]: { w:28, h:22, hp:700, dmg:62, def:16, color:'#68c8bc', speed:3.8, fly:true, name:'Martian Drone', exp:24, shoot:true },
  [E.TESLATURRET]: { w:26, h:32, hp:850, dmg:68, def:20, color:'#5aa8b8', speed:0, name:'Tesla Turret', exp:28, shoot:true },
  [E.HELLHOUND]: { w:34, h:24, hp:650, dmg:68, def:16, color:'#5b352c', speed:4.6, name:'Hellhound', exp:24 },
  [E.POLTERGEIST]: { w:28, h:30, hp:700, dmg:70, def:18, color:'#9a80b8', speed:3.0, fly:true, ghost:true, name:'Poltergeist', exp:26 },
  [E.HEADLESSHORSEMAN]: { w:34, h:42, hp:1300, dmg:82, def:24, color:'#412c24', speed:4.0, name:'Headless Horseman', exp:36 },
  [E.ZOMBIEELF]: { w:22, h:32, hp:520, dmg:56, def:12, color:'#4f8a58', speed:2.2, name:'Zombie Elf', exp:16 },
  [E.ELFARCHER]: { w:22, h:32, hp:480, dmg:54, def:10, color:'#609a68', speed:1.8, name:'Elf Archer', exp:17, shoot:true },
  [E.KRAMPUS]: { w:30, h:42, hp:1100, dmg:78, def:22, color:'#5b4038', speed:2.8, name:'Krampus', exp:32 },
  [E.ELFCOPTER]: { w:34, h:24, hp:800, dmg:66, def:18, color:'#b83f3f', speed:3.5, fly:true, name:'Elf Copter', exp:28, shoot:true },
  [E.SELENIAN]: { w:26, h:34, hp:800, dmg:76, def:22, color:'#e87938', speed:4.0, name:'Selenian', exp:28 },
  [E.STORMDIVER]: { w:26, h:34, hp:760, dmg:72, def:20, color:'#38b8a0', speed:2.4, name:'Storm Diver', exp:27, shoot:true },
  [E.PREDICTOR]: { w:24, h:32, hp:720, dmg:70, def:18, color:'#b05ac8', speed:2.0, name:'Predictor', exp:26, shoot:true },
  [E.STARGAZER]: { w:26, h:28, hp:740, dmg:72, def:18, color:'#6f8fe8', speed:2.5, fly:true, name:'Stargazer', exp:27, shoot:true },
  [E.FLYINGFISH]: { w:28, h:18, hp:160, dmg:24, def:2, color:'#5f9fc8', speed:3.4, fly:true, name:'Flying Fish', exp:5 },
  [E.ANGRYNIMBUS]: { w:36, h:22, hp:520, dmg:54, def:12, color:'#8290a0', speed:2.0, fly:true, ghost:true, name:'Angry Nimbus', exp:18, shoot:true },
  [E.ANGRYTUMBLER]: { w:28, h:28, hp:260, dmg:38, def:6, color:'#c8a85f', speed:3.6, name:'Angry Tumbler', exp:9 },
  [E.SANDELEMENTAL]: { w:30, h:38, hp:1200, dmg:68, def:20, color:'#d8bd78', speed:2.4, fly:true, ghost:true, name:'Sand Elemental', exp:32, shoot:true },
  [E.GOBLINSCOUT]: { w:20, h:30, hp:80, dmg:18, def:2, color:'#839449', speed:3.0, name:'Goblin Scout', exp:4 },
  [E.GOBLINPEON]: { w:20, h:30, hp:100, dmg:22, def:2, color:'#789144', speed:2.3, name:'Goblin Peon', exp:4 },
  [E.GOBLINSORCERER]: { w:20, h:32, hp:140, dmg:28, def:4, color:'#596f3c', speed:1.5, name:'Goblin Sorcerer', exp:6, shoot:true },
  ...
  [E.PIRATEDEADEYE]: { w:22, h:34, hp:600, dmg:62, def:16, color:'#594431', speed:1.5, name:'Pirate Deadeye', exp:22, shoot:true },
  [E.NUTCRACKER]: { w:24, h:38, hp:900, dmg:68, def:20, color:'#b83f3f', speed:2.4, name:'Nutcracker', exp:26 },
  [E.FLOCKO]: { w:26, h:26, hp:700, dmg:62, def:16, color:'#d8f0ff', speed:3.5, fly:true, ghost:true, name:'Flocko', exp:24 },
  [E.YETI]: { w:34, h:44, hp:1400, dmg:82, def:24, color:'#e0e8ec', speed:3.2, name:'Yeti', exp:38 },
  [E.PRESENTMIMIC]: { w:36, h:30, hp:1800, dmg:78, def:26, color:'#d83f4f', speed:4.0, name:'Present Mimic', exp:42 },
  [E.BRIDE]: { w:22, h:34, hp:220, dmg:34, def:5, color:'#e8d8d8', speed:1.8, name:'The Bride', exp:7 },
  [E.GROOM]: { w:22, h:34, hp:220, dmg:34, def:5, color:'#303038', speed:1.8, name:'The Groom', exp:7 },
  [E.CLOWN]: { w:26, h:38, hp:900, dmg:70, def:18, color:'#d84a68', speed:2.0, name:'Clown', exp:30, shoot:true },
  [E.BLOODEEL]: { w:28, h:22, hp:1800, dmg:76, def:20, color:'#a82038', speed:4.2, fly:true, name:'Blood Eel', exp:38 },
  [E.HEMOGOBLINSHARK]: { w:42, h:24, hp:2200, dmg:82, def:22, color:'#7f2638', speed:4.4, fly:true, name:'Hemogoblin Shark', exp:42 },
  [E.MARTIANOFFICER]: { w:24, h:34, hp:900, dmg:72, def:20, color:'#477f72', speed:2.3, name:'Martian Officer', exp:27 },
  [E.MARTIANENGINEER]: { w:22, h:32, hp:800, dmg:62, def:18, color:'#68b8a8', speed:1.5, name:'Martian Engineer', exp:28, shoot:true },
  [E.GIGAZAPPER]: { w:28, h:38, hp:1200, dmg:78, def:24, color:'#459e91', speed:1.4, name:'Gigazapper', exp:34, shoot:true },
  [E.BRAINSCRAMBLER]: { w:30, h:28, hp:1000, dmg:74, def:20, color:'#9a68b8', speed:3.0, fly:true, ghost:true, name:'Brain Scrambler', exp:32, shoot:true },
  [E.SCUTLIXGUNNER]: { w:44, h:38, hp:1600, dmg:82, def:26, color:'#4f8f82', speed:3.0, name:'Scutlix Gunner', exp:40, shoot:true },
  [E.CRAWLTIPEDE]: { w:30, h:24, hp:1800, dmg:86, def:28, color:'#f07838', speed:5.2, fly:true, name:'Crawltipede', exp:42 },
  [E.ALIENQUEEN]: { w:40, h:34, hp:1600, dmg:80, def:24, color:'#38bfa8', speed:3.2, fly:true, name:'Alien Queen', exp:40, shoot:true },
  [E.EVOLUTIONBEAST]: { w:34, h:42, hp:1900, dmg:84, def:28, color:'#a84fc0', speed:2.2, name:'Evolution Beast', exp:44, shoot:true },
  [E.FLOWINVADER]: { w:36, h:32, hp:1700, dmg:82, def:24, color:'#708fe8', speed:3.4, fly:true, ghost:true, name:'Flow Invader', exp:42, shoot:true },
  [E.ANGRYDANDELION]: { w:24, h:32, hp:50, dmg:15, def:0, color:'#e8df72', speed:0, name:'Angry Dandelion', exp:3 },
  [E.WINDYBALLOON]: { w:24, h:18, hp:70, dmg:12, def:0, color:'#5cbf6c', speed:1.6, fly:true, name:'Windy Balloon Slime', exp:3 },
  ...
  [E.SANDSLIME]: { w:20, h:14, hp:60, dmg:10, def:0, color:'#e8d878', speed:1.5, name:'Sand Slime', exp:2 },
  [E.GIANTWORM]: { w:26, h:18, hp:220, dmg:28, def:4, color:'#c8b090', speed:3.2, fly:true, name:'Giant Worm', exp:8 },
  [E.NYMPH]: { w:20, h:32, hp:120, dmg:45, def:0, color:'#e8d0b0', speed:2.6, name:'Nymph', exp:12 },
  [E.DIGGER]: { w:28, h:18, hp:300, dmg:34, def:6, color:'#e0c878', speed:3.4, fly:true, name:'Digger', exp:10 },
  [E.CRIMSLIME]: { w:30, h:22, hp:320, dmg:42, def:6, color:'#d84848', speed:2.0, name:'Crimslime', exp:10 },
  [E.SLIMELING]: { w:14, h:10, hp:60, dmg:14, def:0, color:'#e86060', speed:2.4, name:'Slimeling', exp:2 },
  [E.MOTH]: { w:26, h:18, hp:180, dmg:30, def:4, color:'#c8a860', speed:4.6, fly:true, name:'Moth', exp:8 },
  [E.CORRUPTSLIME]: { w:20, h:14, hp:55, dmg:10, def:0, color:'#8a5fb8', speed:1.5, name:'Corrupt Slime', exp:3 },
  [E.SPIKEDJUNGLESLIME]: { w:22, h:16, hp:70, dmg:16, def:0, color:'#5cc04c', speed:1.7, name:'Spiked Jungle Slime', exp:4 },
  [E.SPIKEDICESLIME]: { w:22, h:16, hp:65, dmg:16, def:0, color:'#9adff2', speed:1.6, name:'Spiked Ice Slime', exp:4 },
  ...
  [E.CRAB]: { w:22, h:16, hp:85, dmg:16, def:4, color:'#c86a4a', speed:3.0, name:'Crab', exp:2 },
  [E.SEASNAIL]: { w:20, h:15, hp:60, dmg:10, def:2, color:'#e0c070', speed:0.7, name:'Sea Snail', exp:1 },
  [E.PIRANHA]: { w:20, h:14, hp:120, dmg:20, def:2, color:'#78b0d8', speed:2.6, swim:true, name:'Piranha', exp:3, fly:true },
  [E.LAVABAT]: { w:18, h:14, hp:120, dmg:28, def:6, color:'#e05c3a', speed:2.8, name:'Lava Bat', exp:4, fly:true },
