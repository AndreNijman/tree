...
await page.evaluate(() => { buildGame('visual-final', 'corrupt'); document.getElementById('mainmenu').style.display = 'none'; });
await page.waitForTimeout(500);
await page.screenshot({ path: '/tmp/opencode/game-final.png' });
console.log('done');
await browser.close();
